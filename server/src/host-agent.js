    ...
    _dispatch(f) {
        ...
        case MsgType.ItemDropRequest: {
            ...
            try {
                ...
                console.log(`[host] player ${f.playerId} dropped item ${req.itemId}x${qty}  eid=${entityId}`);
            } catch (e) {
        ...
        case MsgType.ItemPickupRequest: {
            ...
            try {
                ...
                console.log(`[host] player ${f.playerId} picked up item ${itemId}x${quantity}  slot=${targetSlot}`);
            } catch (e) {

#ifndef UE4SS_SDK_BPAnim_Ambulance_HPP
#define UE4SS_SDK_BPAnim_Ambulance_HPP
...
class UBPAnim_Ambulance_C : public UVehicleAnimationInstance
{
    ...
    FAnimNode_ConvertComponentToLocalSpace AnimGraphNode_ComponentToLocalSpace;       // 0x0AD8 (size: 0x20)
    FAnimNode_WheelController AnimGraphNode_WheelController;                          // 0x0AF8 (size: 0xE0)

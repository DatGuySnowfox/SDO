...
class ABuildable_BunkerDoor_C : public ABuildable_MASTER_C
{
    ...
    float Timeline_OpenDoor_Alpha_C656392E466C41B6931DD2939FBD89AC;                   // 0x0448 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_OpenDoor__Direction_C656392E466C41B6931DD2939FBD89AC; // 0x044C (size: 0x1)

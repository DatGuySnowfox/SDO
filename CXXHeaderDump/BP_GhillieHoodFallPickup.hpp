#ifndef UE4SS_SDK_BP_GhillieHoodFallPickup_HPP
#define UE4SS_SDK_BP_GhillieHoodFallPickup_HPP

class ABP_GhillieHoodFallPickup_C : public ABP_StaticMeshPickup_C
{
    ...
    void ExecuteUbergraph_BP_GhillieHoodFallPickup(int32 EntryPoint);
}; // Size: 0x318

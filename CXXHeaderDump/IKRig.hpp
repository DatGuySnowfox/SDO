...
struct FTargetChainSettings
{
    ...
    FTargetChainIKSettings IK;                                                        // 0x0018 (size: 0x78)
    FTargetChainSpeedPlantSettings SpeedPlanting;                                     // 0x0090 (size: 0x18)
...
{
    TSoftObjectPtr<UIKRigDefinition> SourceIKRigAsset;                                // 0x0028 (size: 0x28)
    TSoftObjectPtr<UIKRigDefinition> TargetIKRigAsset;                                // 0x0050 (size: 0x28)
    TArray<FRetargetChainMap> ChainMapping;                                           // 0x0078 (size: 0x10)
    TArray<class URetargetChainSettings*> ChainSettings;                              // 0x0088 (size: 0x10)
    class URetargetRootSettings* RootSettings;                                        // 0x0098 (size: 0x8)
    class UIKRetargetGlobalSettings* GlobalSettings;                                  // 0x00A0 (size: 0x8)
    TMap<class FName, class FRetargetProfile> Profiles;                               // 0x00A8 (size: 0x50)
    FName CurrentProfile;                                                             // 0x00F8 (size: 0x8)
    TMap<class FName, class FIKRetargetPose> SourceRetargetPoses;                     // 0x0100 (size: 0x50)
    TMap<class FName, class FIKRetargetPose> TargetRetargetPoses;                     // 0x0150 (size: 0x50)
    FName CurrentSourceRetargetPose;                                                  // 0x01A0 (size: 0x8)
    FName CurrentTargetRetargetPose;                                                  // 0x01A8 (size: 0x8)
    TMap<class FName, class FIKRetargetPose> RetargetPoses;                           // 0x01B0 (size: 0x50)
    FName CurrentRetargetPose;                                                        // 0x0200 (size: 0x8)
...
class UIKRigFBIKSolver : public UIKRigSolver
{
    ...
    bool bAllowStretch;                                                               // 0x0040 (size: 0x1)
    EPBIKRootBehavior RootBehavior;                                                   // 0x0041 (size: 0x1)
    FRootPrePullSettings PrePullRootSettings;                                         // 0x0044 (size: 0x20)
    float PullChainAlpha;                                                             // 0x0064 (size: 0x4)
    float MaxAngle;                                                                   // 0x0068 (size: 0x4)
    float OverRelaxation;                                                             // 0x006C (size: 0x4)
    bool bStartSolveFromInputPose;                                                    // 0x0070 (size: 0x1)
...
class URetargetChainSettings : public UObject
{
    ...
    FTargetChainSettings Settings;                                                    // 0x0038 (size: 0xA8)

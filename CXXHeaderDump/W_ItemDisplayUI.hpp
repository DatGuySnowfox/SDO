#ifndef UE4SS_SDK_W_ItemDisplayUI_HPP
#define UE4SS_SDK_W_ItemDisplayUI_HPP

class UW_ItemDisplayUI_C : public UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x02C0 (size: 0x8)
    class UJSIContainer_C* MainContainer;                                             // 0x02C8 (size: 0x8)
    TArray<class UJSI_Slot_C*> Array Of Items;                                        // 0x02D0 (size: 0x10)

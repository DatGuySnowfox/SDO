...
{
    class UFieldSystem* FieldSystem;                                                  // 0x0570 (size: 0x8)
    bool bIsWorldField;                                                               // 0x0578 (size: 0x1)
    bool bIsChaosField;                                                               // 0x0579 (size: 0x1)
    TArray<TSoftObjectPtr<AChaosSolverActor>> SupportedSolvers;                       // 0x0580 (size: 0x10)
    FFieldObjectCommands ConstructionCommands;                                        // 0x0590 (size: 0x30)
    FFieldObjectCommands BufferCommands;                                              // 0x05C0 (size: 0x30)

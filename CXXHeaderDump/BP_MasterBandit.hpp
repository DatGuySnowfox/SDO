...
class ABP_MasterBandit_C : public ABP_MasterAICharacter_C
{
    ...
    TArray<class UStaticMesh*> HairMeshes;                                            // 0x0900 (size: 0x10)
    TArray<class UStaticMesh*> BeardMeshes;                                           // 0x0910 (size: 0x10)
    TMap<class UStaticMesh*, class FTransform> BackpackMeshes;                        // 0x0920 (size: 0x50)
    bool SkipRandomMaterial?;                                                         // 0x0970 (size: 0x1)
    FVector InteractingActorLoc;                                                      // 0x0978 (size: 0x18)
    class AActor* CurrentActor;                                                       // 0x0990 (size: 0x8)
    bool CanAddMarker?;                                                               // 0x0998 (size: 0x1)
    class UWidgetComponent* Marker;                                                   // 0x09A0 (size: 0x8)
    FTimerHandle MarkerTimer;                                                         // 0x09A8 (size: 0x8)
    bool Is Burning?;                                                                 // 0x09B0 (size: 0x1)
    class UParticleSystemComponent* BurningEffect;                                    // 0x09B8 (size: 0x8)
    FTimerHandle BurningTimer;                                                        // 0x09C0 (size: 0x8)
    bool Looted;                                                                      // 0x09C8 (size: 0x1)

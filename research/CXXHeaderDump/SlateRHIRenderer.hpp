...
{
    TMap<ESlatePostRT, USlateRHIPostBufferProcessor*> SlatePostBufferProcessors;      // 0x0030 (size: 0x50)
...
{
    TMap<ESlatePostRT, FSlatePostSettings> SlatePostSettings;                         // 0x0038 (size: 0x50)

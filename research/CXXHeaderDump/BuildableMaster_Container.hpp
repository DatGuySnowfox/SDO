...
class ABuildableMaster_Container_C : public ABuildable_MASTER_C
{
    ...
    class USceneComponent* DropItemLocation;                                          // 0x0448 (size: 0x8)
    TArray<FS_ReplicatedContainerInfo> MainJigContainers;                             // 0x0450 (size: 0x10)
    TArray<FGuid> MainUIDs;                                                           // 0x0460 (size: 0x10)
    TArray<FS_InvWeight> Weights;                                                     // 0x0470 (size: 0x10)
    FText ContainerName;                                                              // 0x0480 (size: 0x10)

...
class ABP_HarvestableObject_C : public ABP_MasterObject_C
{
    ...
    int32 MaxHits;                                                                    // 0x02C8 (size: 0x4)
    class USoundBase* Sound;                                                          // 0x02D0 (size: 0x8)
    class UStaticMesh* Mesh;                                                          // 0x02D8 (size: 0x8)
    class UMaterialInterface* Material;                                               // 0x02E0 (size: 0x8)

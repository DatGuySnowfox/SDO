...
class ABP_HarvestableObject_Tree_C : public ABP_HarvestableObject_C
{
    ...
    float FallOverTimeline_FallOverAlpha_8E6A479F46FC05F3F36446A1B2EB299C;            // 0x02F0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> FallOverTimeline__Direction_8E6A479F46FC05F3F36446A1B2EB299C; // 0x02F4 (size: 0x1)
    class UTimelineComponent* FallOverTimeline;                                       // 0x02F8 (size: 0x8)

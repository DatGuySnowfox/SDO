#ifndef UE4SS_SDK_Buildable_LogWire_HPP
#define UE4SS_SDK_Buildable_LogWire_HPP

class ABuildable_LogWire_C : public ABuildable_MASTER_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0440 (size: 0x8)
    class UBoxComponent* Box_0;                                                       // 0x0448 (size: 0x8)
    TArray<ACharacter*> AIArray;                                                      // 0x0450 (size: 0x10)

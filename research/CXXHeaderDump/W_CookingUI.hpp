#ifndef UE4SS_SDK_W_CookingUI_HPP
#define UE4SS_SDK_W_CookingUI_HPP

class UW_CookingUI_C : public UUserWidget
{
    ...
    void ExecuteUbergraph_W_CookingUI(int32 EntryPoint);
}; // Size: 0x425

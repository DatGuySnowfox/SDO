...
{
    uint8 bFractureEffectOverride;                                                    // 0x08F0 (size: 0x1)
    TArray<FFractureEffect> FractureEffects;                                          // 0x08F8 (size: 0x10)
    bool bEnableHardSleeping;                                                         // 0x0908 (size: 0x1)
    float LargeChunkThreshold;                                                        // 0x090C (size: 0x4)
    FDestructibleComponentOnComponentFracture OnComponentFracture;                    // 0x0910 (size: 0x10)

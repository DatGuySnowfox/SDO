...
class USaveMenu_C : public UUserWidget
{
    ...
    class UTextBlock* YesText_3;                                                      // 0x0348 (size: 0x8)
    class UTextBlock* YesText_2;                                                      // 0x0350 (size: 0x8)
    class UTextBlock* YesText_1;                                                      // 0x0358 (size: 0x8)
    class UTextBlock* YesText;                                                        // 0x0360 (size: 0x8)
    class URichTextBlock* TextBlockSave;                                              // 0x0368 (size: 0x8)
    class URichTextBlock* TextBlockLoad;                                              // 0x0370 (size: 0x8)
    class URichTextBlock* TextBlockDelete;                                            // 0x0378 (size: 0x8)
    class URichTextBlock* TextBlockCheckSave;                                         // 0x0380 (size: 0x8)
    class UTextBlock* SurvivedDaysText;                                               // 0x0388 (size: 0x8)
    class USettingRow_C* SettingRow_12;                                               // 0x0390 (size: 0x8)
    class USettingRow_C* SettingRow_1;                                                // 0x0398 (size: 0x8)
    class USettingRow_C* SettingRow;                                                  // 0x03A0 (size: 0x8)
    class UButton* SetCurrentButton;                                                  // 0x03A8 (size: 0x8)
    class UTextBlock* SaveText;                                                       // 0x03B0 (size: 0x8)
    class UCanvasPanel* SaveGamePanel;                                                // 0x03B8 (size: 0x8)
    class UScrollBox* SaveGameList;                                                   // 0x03C0 (size: 0x8)
    class UButton* SaveGameButton;                                                    // 0x03C8 (size: 0x8)
    class UButton* Save_YES;                                                          // 0x03D0 (size: 0x8)
    class UButton* Save_NO;                                                           // 0x03D8 (size: 0x8)
    class UTextBlock* NoText_3;                                                       // 0x03E0 (size: 0x8)
    class UTextBlock* NoText_2;                                                       // 0x03E8 (size: 0x8)
    class UTextBlock* NoText_1;                                                       // 0x03F0 (size: 0x8)
    class UTextBlock* NoText;                                                         // 0x03F8 (size: 0x8)
    class UVerticalBox* NewGameBox;                                                   // 0x0400 (size: 0x8)
    class UTextBlock* NameText;                                                       // 0x0408 (size: 0x8)
    class UCanvasPanel* MenuCanvasPanel;                                              // 0x0410 (size: 0x8)
    class UTextBlock* LoadText;                                                       // 0x0418 (size: 0x8)
    class UCanvasPanel* LoadGamePanel;                                                // 0x0420 (size: 0x8)
    class UButton* LoadGameButton;                                                    // 0x0428 (size: 0x8)
    class UButton* Load_YES;                                                          // 0x0430 (size: 0x8)
    class UButton* Load_NO;                                                           // 0x0438 (size: 0x8)
    class UEditableTextBox* EditableTextBox_135;                                      // 0x0440 (size: 0x8)
    class UEditableText* EditableText_All;                                            // 0x0448 (size: 0x8)
    class UComboBoxString* DropDownNames;                                             // 0x0450 (size: 0x8)
    class UTextBlock* DeleteText_1;                                                   // 0x0458 (size: 0x8)
    class UCanvasPanel* DeleteSavePanel;                                              // 0x0460 (size: 0x8)
    class UButton* Delete_YES;                                                        // 0x0468 (size: 0x8)
    class UButton* Delete_NO;                                                         // 0x0470 (size: 0x8)
    class UTextBlock* DateText;                                                       // 0x0478 (size: 0x8)
    class UCanvasPanel* CheckSaveFilePanel;                                           // 0x0480 (size: 0x8)
    class UButton* CheckSave_YES;                                                     // 0x0488 (size: 0x8)
    class UButton* CheckSave_NO;                                                      // 0x0490 (size: 0x8)
    class UButtonWidget_C* ButtonWidget_BackFromMenu;                                 // 0x0498 (size: 0x8)
    class USaveGameSlot_C* CurrentSelectedSlot;                                       // 0x04A0 (size: 0x8)
    bool PauseMenu?;                                                                  // 0x04A8 (size: 0x1)
    FSaveMenu_CReturnToMenu ReturnToMenu;                                             // 0x04B0 (size: 0x10)
    void ReturnToMenu();
    FSaveMenu_CRemoveUI RemoveUI;                                                     // 0x04C0 (size: 0x10)
    void RemoveUI();
    bool PlayerDeath?;                                                                // 0x04D0 (size: 0x1)
    FSaveMenu_CReturnToPauseScreen ReturnToPauseScreen;                               // 0x04D8 (size: 0x10)
    void ReturnToPauseScreen();
    TArray<FString> CharacterNames;                                                   // 0x04E8 (size: 0x10)
    class USaveGameSlot_C* SlotToDelete;                                              // 0x04F8 (size: 0x8)

    void SearchCharacterNames(FString Name);
    void FindCharacterNames(TArray<FString>& CharacterNames);
    ...
    void OnVersionMismatch_4EBFD5F145FA3C71E69D3BB7D87BBC9D();
    ...
    void BndEvt__SaveMenu_DropDownNames_K2Node_ComponentBoundEvent_7_OnSelectionChangedEvent__DelegateSignature(FString SelectedItem, TEnumAsByte<ESelectInfo::Type> SelectionType);
    void SelectDeleteSave(class USaveGameSlot_C* SaveSlot);

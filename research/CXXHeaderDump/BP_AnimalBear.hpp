...
class ABP_AnimalBear_C : public ABP_Animal_C
{
    ...
    class UAudioComponent* Bear_Noises;                                               // 0x0678 (size: 0x8)
    ...
    TArray<UAnimMontage*> AttackMontage;                                              // 0x06A8 (size: 0x10)
    FVector InteractingActorLoc;                                                      // 0x06B8 (size: 0x18)
    class AActor* CurrentActor;                                                       // 0x06D0 (size: 0x8)
    TArray<FName> Sockets;                                                            // 0x06D8 (size: 0x10)
    double Health;                                                                    // 0x06E8 (size: 0x8)
    class UAnimMontage* HitAnimation;                                                 // 0x06F0 (size: 0x8)
    class USoundBase* HitSound;                                                       // 0x06F8 (size: 0x8)
    bool IsDead?;                                                                     // 0x0700 (size: 0x1)
    bool CanAddMarker?;                                                               // 0x0701 (size: 0x1)
    class UWidgetComponent* Marker;                                                   // 0x0708 (size: 0x8)
    FTimerHandle MarkerTimer;                                                         // 0x0710 (size: 0x8)
    bool Is Burning?;                                                                 // 0x0718 (size: 0x1)
    class UParticleSystemComponent* BurningEffect;                                    // 0x0720 (size: 0x8)
    FTimerHandle BurningTimer;                                                        // 0x0728 (size: 0x8)
    bool Looted;                                                                      // 0x0730 (size: 0x1)

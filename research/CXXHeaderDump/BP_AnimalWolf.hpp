...
class ABP_AnimalWolf_C : public ABP_Animal_C
{
    ...
    class UAudioComponent* Wolf_Noises;                                               // 0x06A8 (size: 0x8)
    ...
    bool BloodSplatterEnabled;                                                        // 0x0708 (size: 0x1)
    class AActor* CurrentActor;                                                       // 0x0710 (size: 0x8)
    TArray<FName> Sockets;                                                            // 0x0718 (size: 0x10)
    bool XpPopUpEnabled?;                                                             // 0x0728 (size: 0x1)
    double Health;                                                                    // 0x0730 (size: 0x8)
    TArray<class UAnimMontage*> HitAnimation;                                         // 0x0738 (size: 0x10)
    class USoundBase* HitSound;                                                       // 0x0748 (size: 0x8)
    bool IsDead?;                                                                     // 0x0750 (size: 0x1)
    bool CanAddMarker?;                                                               // 0x0751 (size: 0x1)
    class UWidgetComponent* Marker;                                                   // 0x0758 (size: 0x8)
    FTimerHandle MarkerTimer;                                                         // 0x0760 (size: 0x8)
    bool Is Burning?;                                                                 // 0x0768 (size: 0x1)
    class UParticleSystemComponent* BurningEffect;                                    // 0x0770 (size: 0x8)
    FTimerHandle BurningTimer;                                                        // 0x0778 (size: 0x8)
    bool Looted;                                                                      // 0x0780 (size: 0x1)

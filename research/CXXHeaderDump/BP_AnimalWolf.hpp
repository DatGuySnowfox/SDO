#ifndef UE4SS_SDK_BP_AnimalWolf_HPP
#define UE4SS_SDK_BP_AnimalWolf_HPP

class ABP_AnimalWolf_C : public ABP_Animal_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x0670 (size: 0x8)
    class UAudioComponent* Wolf_Noises;                                               // 0x0678 (size: 0x8)
    ...
    double DamageToDo;                                                                // 0x0698 (size: 0x8)
    bool Start_Attacking;                                                             // 0x06A0 (size: 0x1)
    FVector InteractingActorLoc;                                                      // 0x06A8 (size: 0x18)
    class AActor* CurrentActor;                                                       // 0x06C0 (size: 0x8)
    double Health;                                                                    // 0x06C8 (size: 0x8)
    TArray<UAnimMontage*> HitAnimation;                                               // 0x06D0 (size: 0x10)
    class USoundBase* HitSound;                                                       // 0x06E0 (size: 0x8)
    bool IsDead?;                                                                     // 0x06E8 (size: 0x1)
    bool CanAddMarker?;                                                               // 0x06E9 (size: 0x1)
    class UWidgetComponent* Marker;                                                   // 0x06F0 (size: 0x8)
    FTimerHandle MarkerTimer;                                                         // 0x06F8 (size: 0x8)
    bool Is Burning?;                                                                 // 0x0700 (size: 0x1)
    class UParticleSystemComponent* BurningEffect;                                    // 0x0708 (size: 0x8)
    FTimerHandle BurningTimer;                                                        // 0x0710 (size: 0x8)
    bool Looted;                                                                      // 0x0718 (size: 0x1)
    ...
    void OnNotifyEnd_FBC83A294D2AF778C41402B9CCBB9BAD(FName NotifyName);
    void OnNotifyBegin_FBC83A294D2AF778C41402B9CCBB9BAD(FName NotifyName);
    void OnInterrupted_FBC83A294D2AF778C41402B9CCBB9BAD(FName NotifyName);
    void OnBlendOut_FBC83A294D2AF778C41402B9CCBB9BAD(FName NotifyName);
    void OnCompleted_FBC83A294D2AF778C41402B9CCBB9BAD(FName NotifyName);

...
class UJSI_Slot_C : public UUserWidget
{
    ...
    class UTextBlock* TextCout;                                                       // 0x0350 (size: 0x8)
    class UTextBlock* StockCount;                                                     // 0x0358 (size: 0x8)
    class UImage* SlotImage;                                                          // 0x0360 (size: 0x8)
    class UImage* SlotHighlight;                                                      // 0x0368 (size: 0x8)
    class UImage* SlotFrameImg;                                                       // 0x0370 (size: 0x8)
    class UBorder* SlotBorder;                                                        // 0x0378 (size: 0x8)
    class USizeBox* SizeBox;                                                          // 0x0380 (size: 0x8)
    class UScaleBox* ScaleBox_133;                                                    // 0x0388 (size: 0x8)
    class UTextBlock* PriceCount;                                                     // 0x0390 (size: 0x8)
    class UTextBlock* ObjItemName;                                                    // 0x0398 (size: 0x8)
    class UOverlay* MainSlotOverlay;                                                  // 0x03A0 (size: 0x8)
    class UTextBlock* Durability;                                                     // 0x03A8 (size: 0x8)
    class UWidgetAnimation* FadeInOut;                                                // 0x03B0 (size: 0x8)
    int32 SlotIndex;                                                                  // 0x03B8 (size: 0x4)
    FVector2D Size;                                                                   // 0x03C0 (size: 0x10)
    FSlateColor OnHoverTint;                                                          // 0x03D0 (size: 0x14)
    class UTexture* Image;                                                            // 0x03E8 (size: 0x8)
    bool Highlighted?;                                                                // 0x03F0 (size: 0x1)
    class UJSIContainer_C* ContainerMother;                                           // 0x03F8 (size: 0x8)
    FKey RotateKey;                                                                   // 0x0400 (size: 0x18)
    bool IsFixedSlot?;                                                                // 0x0418 (size: 0x1)
    int32 ParentID;                                                                   // 0x041C (size: 0x4)
    class UContainerWindowWidget_C* WindowContainer;                                  // 0x0420 (size: 0x8)
    bool IsLocked?;                                                                   // 0x0428 (size: 0x1)
    class UTexture2D* FrameImageRect;                                                 // 0x0430 (size: 0x8)
    double OpacityValue;                                                              // 0x0438 (size: 0x8)
    bool DragHighlighted?;                                                            // 0x0440 (size: 0x1)
    class UOnHoverTooltipWidget_C* OnHoverWidget;                                     // 0x0448 (size: 0x8)
    bool SortHighlighted?;                                                            // 0x0450 (size: 0x1)
    bool ShouldUpdateCapacity?;                                                       // 0x0451 (size: 0x1)
    bool HideOnDrag;                                                                  // 0x0452 (size: 0x1)
    bool IsPending;                                                                   // 0x0453 (size: 0x1)
    class UJSI_Slot_C* HostedItem;                                                    // 0x0458 (size: 0x8)
    TArray<UJSI_Slot_C*> ArrayOfHostingItem;                                          // 0x0460 (size: 0x10)
    class UJSIContainer_C* SlotContainer;                                             // 0x0470 (size: 0x8)
    FLinearColor LastRarityColor;                                                     // 0x0478 (size: 0x10)
    class UTextureRenderTarget2D* RenderTargetSnap;                                   // 0x0488 (size: 0x8)
    bool MouseEnter?;                                                                 // 0x0490 (size: 0x1)
    class UBP_InspectorCanvas_C* CanvasBP;                                            // 0x0498 (size: 0x8)
    bool ShouldRestoreImage;                                                          // 0x04A0 (size: 0x1)
    TArray<FName> PendingSnapAttachements;                                            // 0x04A8 (size: 0x10)
    class UBP_ItemSnapLoading_C* LoadingSnap;                                         // 0x04B8 (size: 0x8)
    class UUserWidget* InspectorWidget;                                               // 0x04C0 (size: 0x8)
    bool PendingSnap;                                                                 // 0x04C8 (size: 0x1)
    FVector2D OriginalSize;                                                           // 0x04D0 (size: 0x10)
    int32 InitCapacity;                                                               // 0x04E0 (size: 0x4)
    class UTexture2D* FrameImage;                                                     // 0x04E8 (size: 0x8)
    class UJigsawItem_DataAsset_C* JigDataAsset;                                      // 0x04F0 (size: 0x8)
    FGameplayTag Rarity;                                                              // 0x04F8 (size: 0x8)
    bool SlotRotated?;                                                                // 0x0500 (size: 0x1)
    EDragPivot DragBehaviour;                                                         // 0x0501 (size: 0x1)
    bool SnapIsOnStandby;                                                             // 0x0502 (size: 0x1)
    class UJSI_Slot_C* MirroredActionbar;                                             // 0x0508 (size: 0x8)
    double ItemWeight;                                                                // 0x0510 (size: 0x8)
    FVector2D SlotVector;                                                             // 0x0518 (size: 0x10)
    FVector2D DragOffset;                                                             // 0x0528 (size: 0x10)
    class UOverlaySlot* OverlayRef;                                                   // 0x0538 (size: 0x8)
    FVector2D LastClickLoc;                                                           // 0x0540 (size: 0x10)
    bool DragDisabled?;                                                               // 0x0550 (size: 0x1)
    bool IsEmpty;                                                                     // 0x0551 (size: 0x1)
    int32 Row;                                                                        // 0x0554 (size: 0x4)
    int32 Column;                                                                     // 0x0558 (size: 0x4)
    bool HighlightOnHover?;                                                           // 0x055C (size: 0x1)
    FGameplayTagContainer DropSupportedItems;                                         // 0x0560 (size: 0x20)
    bool AllowInteractionOnSort;                                                      // 0x0580 (size: 0x1)
    double SortHighlightOpacity;                                                      // 0x0588 (size: 0x8)
    FJSI_Slot_COnItemDestructEvent OnItemDestructEvent;                               // 0x0590 (size: 0x10)
    void OnItemDestructEvent();
    FGuid ItemUniqueID;                                                               // 0x05A0 (size: 0x10)
    int32 ItemCount;                                                                  // 0x05B0 (size: 0x4)
    FVector2D ItemDim;                                                                // 0x05B8 (size: 0x10)
    bool ItemRotated?;                                                                // 0x05C8 (size: 0x1)
    class UUserWidget* SpecialContainerRef;                                           // 0x05D0 (size: 0x8)
    double Price;                                                                     // 0x05D8 (size: 0x8)
    double Dur;                                                                       // 0x05E0 (size: 0x8)
    double MaxDur;                                                                    // 0x05E8 (size: 0x8)
    class UTexture* InvTexture;                                                       // 0x05F0 (size: 0x8)
    class UTexture* EquipTexture;                                                     // 0x05F8 (size: 0x8)
    TArray<FS_ItemStat> ItemStats;                                                    // 0x0600 (size: 0x10)
    class UBP_PendingTimer_C* PendingTimer;                                           // 0x0610 (size: 0x8)
    bool CTRL_Down;                                                                   // 0x0618 (size: 0x1)
    bool SHIFT_Down;                                                                  // 0x0619 (size: 0x1)
    bool ALT_Down;                                                                    // 0x061A (size: 0x1)
    TMap<FString, FString> CustomData;                                                // 0x0620 (size: 0x50)

    void HighlightNonConsumedItems(bool DoNotConsume?);
    ...
    void GetContainers(TArray<UJSIContainer_C*>& Container);
    ...
    void DeepSearch_GetAllItems(TArray<UJSI_Slot_C*>& ArrItemsByRef);
    ...
    void SetHostingArray(TArray<UJSI_Slot_C*>& ArrayOfHostingItem);

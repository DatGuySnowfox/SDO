...
struct FMovieSceneBoolChannel : public FMovieSceneChannel
{
    ...
    FMovieSceneKeyHandleMap KeyHandles;                                               // 0x0078 (size: 0x88)
...
struct FMovieSceneSectionParameters
{
    ...
    EMovieSceneSubSectionFlags Flags;                                                 // 0x0018 (size: 0x4)
...
struct FMovieSceneSequencePlaybackSettings
{
    ...
    uint8 bDynamicWeighting;                                                          // 0x001D (size: 0x1)
...
struct FMovieSceneSubSequenceData
{
    ...
    EMovieSceneSubSectionFlags AccumulatedFlags;                                      // 0x00E0 (size: 0x4)
    FMovieSceneSequenceInstanceDataPtr InstanceData;                                  // 0x00E8 (size: 0x18)
    FGuid SubSectionSignature;                                                        // 0x0108 (size: 0x10)
...
{
    TScriptInterface<class IMovieSceneSequencePlayerObserver> Observer;               // 0x0228 (size: 0x10)
    FMovieSceneSequencePlayerOnPlay OnPlay;                                           // 0x0238 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnPlayReverse OnPlayReverse;                             // 0x0248 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnStop OnStop;                                           // 0x0258 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnPause OnPause;                                         // 0x0268 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    FMovieSceneSequencePlayerOnFinished OnFinished;                                   // 0x0278 (size: 0x10)
    void OnMovieSceneSequencePlayerEvent();
    ...
    FMovieSceneSequencePlaybackSettings PlaybackSettings;                             // 0x02AC (size: 0x20)
    FMovieSceneRootEvaluationTemplateInstance RootTemplateInstance;                   // 0x02D0 (size: 0x88)
    FMovieSceneSequenceReplProperties NetSyncProps;                                   // 0x03E8 (size: 0x14)
    TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                 // 0x0400 (size: 0x10)
    class UMovieSceneSequenceTickManager* TickManager;                                // 0x0410 (size: 0x8)

...
{
    TSet<UMovieSceneSection*> Sections;                                               // 0x0000 (size: 0x50)
...
struct FMovieSceneBindingOverrideData
{
    ...
    TSoftObjectPtr<class UObject> Object;                                             // 0x0018 (size: 0x28)
...
struct FMovieSceneConditionContext
{
    class UObject* WorldContext;                                                      // 0x0000 (size: 0x8)
    FMovieSceneBindingProxy Binding;                                                  // 0x0008 (size: 0x18)
    TArray<UObject*> BoundObjects;                                                    // 0x0020 (size: 0x10)
...
{
    TArray<UObject*> Decorations;                                                     // 0x0000 (size: 0x10)
...
struct FMovieSceneEditorData
{
    ...
    FNavigationToolSaveState NavigationToolState;                                     // 0x00F0 (size: 0xF8)
    TArray<FString> SoloNodes;                                                        // 0x01E8 (size: 0x10)
    TArray<FString> MuteNodes;                                                        // 0x01F8 (size: 0x10)
...
{
    TSoftObjectPtr<class UMovieSceneCondition> Condition;                             // 0x0000 (size: 0x28)
...
{
    TSoftObjectPtr<class UObject> SoftPtr;                                            // 0x0000 (size: 0x28)
...
{
    FFrameNumber Position;                                                            // 0x0000 (size: 0x4)
    int32 Duration;                                                                   // 0x0004 (size: 0x4)
...
struct FMovieSceneSequenceHierarchy
{
    ...
    TMap<FMovieSceneSequenceID, FMovieSceneSubSequenceData> SubSequences;             // 0x0098 (size: 0x50)
    TMap<FMovieSceneSequenceID, FMovieSceneSequenceHierarchyNode> Hierarchy;          // 0x00E8 (size: 0x50)
...
struct FMovieSceneSubSequenceData
{
    ...
    TWeakObjectPtr<class UMovieSceneCondition> WeakCondition;                         // 0x00D0 (size: 0x8)
...
{
    FNavigationToolSerializedTree SerializedTree;                                     // 0x0000 (size: 0x88)
    TMap<FString, FColor> ItemColorMap;                                               // 0x0088 (size: 0x50)
    TArray<FNavigationToolViewSaveState> ToolViewSaveStates;                          // 0x00D8 (size: 0x10)
    FString ContextPath;                                                              // 0x00E8 (size: 0x10)
...
{
    FNavigationToolSerializedTreeNode RootNode;                                       // 0x0000 (size: 0x28)
    TArray<FNavigationToolSerializedItem> SceneItems;                                 // 0x0028 (size: 0x10)
    TMap<FNavigationToolSerializedItem, FNavigationToolSerializedTreeNode> ItemTreeMap; // 0x0038 (size: 0x50)

}; // Size: 0x88

struct FNavigationToolSerializedTreeNode
{
    int32 LocalIndex;                                                                 // 0x0000 (size: 0x4)
    int32 GlobalIndex;                                                                // 0x0004 (size: 0x4)
    int32 ParentIndex;                                                                // 0x0008 (size: 0x4)
    TArray<int32> ChildrenIndices;                                                    // 0x0010 (size: 0x10)
...
{
    TMap<FString, ENavigationToolItemFlags> ViewItemFlags;                            // 0x0000 (size: 0x50)
    TMap<FName, FNavigationToolViewColumnSaveState> ColumnsState;                     // 0x0050 (size: 0x50)
    TSet<FName> ActiveItemFilters;                                                    // 0x00A0 (size: 0x50)
...
{
    FVector TestVector;                                                               // 0x02A8 (size: 0x18)
    TArray<float> MultipleFloats;                                                     // 0x02C0 (size: 0x10)
    FTestMovieSceneStruct SingleStruct;                                               // 0x02D0 (size: 0x20)
    TArray<FTestMovieSceneStruct> MultipleStructs;                                    // 0x02F0 (size: 0x10)
...
class IMovieSceneChannelDecoration : public IInterface
{
}; // Size: 0x28
...
class IMovieSceneDecoration : public IInterface
{
}; // Size: 0x28
...
class IMovieSceneEntityDecorator : public IInterface
{
}; // Size: 0x28
...
class IMovieSceneLifetimeDecoration : public IInterface
{
}; // Size: 0x28
...
class IMovieSceneScalingDriver : public IInterface
{
}; // Size: 0x28

class IMovieSceneSectionDecoration : public IInterface
{
}; // Size: 0x28
...
class IMovieSceneTimeWarpSource : public IInterface
{
}; // Size: 0x28

class IMovieSceneTrackDecoration : public IInterface
{
}; // Size: 0x28
...
{
    TArray<FMovieSceneSpawnable> Spawnables;                                          // 0x0070 (size: 0x10)
    TArray<FMovieScenePossessable> Possessables;                                      // 0x0080 (size: 0x10)
    TArray<FMovieSceneBinding> ObjectBindings;                                        // 0x0090 (size: 0x10)
    TMap<FName, FMovieSceneObjectBindingIDs> BindingGroups;                           // 0x00A0 (size: 0x50)
    TArray<UMovieSceneTrack*> Tracks;                                                 // 0x00F0 (size: 0x10)
    class UMovieSceneTrack* CameraCutTrack;                                           // 0x0100 (size: 0x8)
    class UMovieSceneClock* CustomClock;                                              // 0x0108 (size: 0x8)
    FMovieSceneFrameRange SelectionRange;                                             // 0x0110 (size: 0x10)
    FMovieSceneFrameRange PlaybackRange;                                              // 0x0120 (size: 0x10)
    FFrameRate TickResolution;                                                        // 0x0130 (size: 0x8)
    FFrameRate DisplayRate;                                                           // 0x0138 (size: 0x8)
    EMovieSceneEvaluationType EvaluationType;                                         // 0x0140 (size: 0x1)
    EUpdateClockSource ClockSource;                                                   // 0x0141 (size: 0x1)
    TArray<FMovieSceneMarkedFrame> MarkedFrames;                                      // 0x0148 (size: 0x10)
    TArray<UMovieSceneGroupCondition*> GeneratedConditions;                           // 0x0158 (size: 0x10)
...
{
    bool DefaultValue;                                                                // 0x0108 (size: 0x1)
    FMovieSceneBoolChannel BoolCurve;                                                 // 0x0110 (size: 0x108)
...
{
    FMovieSceneDecorationContainer Decorations;                                       // 0x0058 (size: 0x10)
...
{
    FMovieSceneEntitySystemGraph SystemGraph;                                         // 0x02D0 (size: 0x190)
...
{
    FSoftObjectPath CustomClockSourcePath;                                            // 0x0058 (size: 0x20)
...
class UMovieSceneFolder : public UObject
{
    ...
    TArray<UMovieSceneTrack*> ChildTracks;                                            // 0x0048 (size: 0x10)
...
{
    uint8 bRequiresRangedHook;                                                        // 0x0118 (size: 0x1)
    uint8 bRequiresTriggerHooks;                                                      // 0x0118 (size: 0x1)
...
{
    FString PreviewLanguage;                                                          // 0x0028 (size: 0x10)
...
class UMovieScenePlayRateCurve : public UMovieSceneTimeWarpGetter
{
    ...
    FFrameNumber PlaybackStartFrame;                                                  // 0x0198 (size: 0x4)
    bool bManualPlaybackStart;                                                        // 0x019C (size: 0x1)
...
class UMovieSceneScalingAnchors : public UMovieScenePlayRateCurve
{
    TArray<TScriptInterface<class IMovieSceneScalingDriver>> ScalingDrivers;          // 0x01C8 (size: 0x10)
    TMap<FGuid, FMovieSceneScalingAnchor> InitialAnchors;                             // 0x01D8 (size: 0x50)
    TMap<FGuid, FMovieSceneAnchorsScalingGroup> ScalingGroups;                        // 0x0228 (size: 0x50)

}; // Size: 0x2D8

class UMovieSceneSection : public UMovieSceneDecorationContainerObject
{
    FMovieSceneSectionEvalOptions EvalOptions;                                        // 0x0068 (size: 0x2)
    FMovieSceneEasingSettings Easing;                                                 // 0x0070 (size: 0x38)
    FMovieSceneFrameRange SectionRange;                                               // 0x00A8 (size: 0x10)
    FMovieSceneConditionContainer ConditionContainer;                                 // 0x00B8 (size: 0x8)
    FFrameNumber PreRollFrames;                                                       // 0x00C0 (size: 0x4)
    FFrameNumber PostRollFrames;                                                      // 0x00C4 (size: 0x4)
    int32 RowIndex;                                                                   // 0x00C8 (size: 0x4)
    int32 OverlapPriority;                                                            // 0x00CC (size: 0x4)
    uint8 bIsActive;                                                                  // 0x00D0 (size: 0x1)
    uint8 bIsLocked;                                                                  // 0x00D0 (size: 0x1)
    float StartTime;                                                                  // 0x00D4 (size: 0x4)
    float EndTime;                                                                    // 0x00D8 (size: 0x4)
    float PrerollTime;                                                                // 0x00DC (size: 0x4)
    float PostrollTime;                                                               // 0x00E0 (size: 0x4)
    uint8 bIsInfinite;                                                                // 0x00E4 (size: 0x1)
    bool bSupportsInfiniteRange;                                                      // 0x00E8 (size: 0x1)
    FOptionalMovieSceneBlendType BlendType;                                           // 0x00E9 (size: 0x2)
...
class UMovieSceneSectionAnchorsDecoration : public UObject
{
    FGuid StartAnchor;                                                                // 0x0040 (size: 0x10)
...
class UMovieSceneSequencePlayer : public UObject
{
    ...
    void OnMovieSceneSequencePlayerEvent();
    TEnumAsByte<EMovieScenePlayerStatus::Type> Status;                                // 0x0290 (size: 0x1)
    uint8 bReversePlayback;                                                           // 0x0294 (size: 0x1)
    class UMovieSceneSequence* Sequence;                                              // 0x0298 (size: 0x8)
    FFrameNumber StartTime;                                                           // 0x02A0 (size: 0x4)
    int32 DurationFrames;                                                             // 0x02A4 (size: 0x4)
    float DurationSubFrames;                                                          // 0x02A8 (size: 0x4)
    int32 CurrentNumLoops;                                                            // 0x02AC (size: 0x4)
    int32 SerialNumber;                                                               // 0x02B0 (size: 0x4)
    FMovieSceneSequencePlaybackSettings PlaybackSettings;                             // 0x02B4 (size: 0x28)
    FMovieSceneRootEvaluationTemplateInstance RootTemplateInstance;                   // 0x02E0 (size: 0x20)
    FMovieSceneSequenceReplProperties NetSyncProps;                                   // 0x038C (size: 0x14)
    TScriptInterface<class IMovieScenePlaybackClient> PlaybackClient;                 // 0x03A0 (size: 0x10)
    class UMovieSceneSequenceTickManager* TickManager;                                // 0x03B0 (size: 0x8)
...
class UMovieSceneShotMetaData : public UObject
{
    TOptional<bool> bIsNoGood;                                                        // 0x0030 (size: 0x2)
    TOptional<bool> bIsFlagged;                                                       // 0x0032 (size: 0x2)
    TOptional<bool> bIsRecorded;                                                      // 0x0034 (size: 0x2)
    TOptional<bool> bIsSubSequence;                                                   // 0x0036 (size: 0x2)
    TOptional<int32> FavoriteRating;                                                  // 0x0038 (size: 0x8)
...
class UMovieSceneSpawnTrack : public UMovieSceneTrack
{
    ...
    FGuid ObjectGuid;                                                                 // 0x0120 (size: 0x10)
...
{
    FMovieSceneSectionParameters Parameters;                                          // 0x0110 (size: 0x30)
    float StartOffset;                                                                // 0x0140 (size: 0x4)
    float TimeScale;                                                                  // 0x0144 (size: 0x4)
    float PrerollTime;                                                                // 0x0148 (size: 0x4)
    uint8 NetworkMask;                                                                // 0x014C (size: 0x1)
    FMovieSceneSubSectionOriginOverrideMask OriginOverrideMask;                       // 0x0150 (size: 0x4)
    FMovieSceneDoubleChannel Translation;                                             // 0x0158 (size: 0x348)
    FMovieSceneDoubleChannel Rotation;                                                // 0x04A0 (size: 0x348)
    class UMovieSceneSequence* SubSequence;                                           // 0x07E8 (size: 0x8)
...
class UMovieSceneTimeWarpDecoration : public UObject
{
    TArray<TScriptInterface<class IMovieSceneTimeWarpSource>> Sources;                // 0x0030 (size: 0x10)
...
{
    FMovieSceneTimeWarpVariant TimeWarp;                                              // 0x0108 (size: 0x8)
...
{
    TArray<UMovieSceneSection*> Sections;                                             // 0x0118 (size: 0x10)
    bool bIsActiveTimeWarp;                                                           // 0x0128 (size: 0x1)

}; // Size: 0x130

class UMovieSceneTrack : public UMovieSceneDecorationContainerObject
{
    FMovieSceneTrackEvalOptions EvalOptions;                                          // 0x0070 (size: 0x4)
    FMovieSceneConditionContainer ConditionContainer;                                 // 0x0078 (size: 0x8)
    bool bIsEvalDisabled;                                                             // 0x0081 (size: 0x1)
    TArray<int32> RowsDisabled;                                                       // 0x0088 (size: 0x10)
    FGuid EvaluationFieldGuid;                                                        // 0x009C (size: 0x10)
    FMovieSceneTrackEvaluationField EvaluationField;                                  // 0x00B0 (size: 0x10)
    TMap<int32, FMovieSceneTrackRowMetadata> TrackRowMetadata;                        // 0x00C0 (size: 0x50)
...
{
    TArray<UMovieSceneSection*> SectionArray;                                         // 0x0110 (size: 0x10)
...
{
    TArray<UMovieSceneSection*> SectionArray;                                         // 0x0120 (size: 0x10)

}; // Size: 0x130

class UTestMovieSceneTrack : public UMovieSceneTrack
{
    bool bHighPassFilter;                                                             // 0x0118 (size: 0x1)
    TArray<UMovieSceneSection*> SectionArray;                                         // 0x0120 (size: 0x10)

#ifndef UE4SS_SDK_BP_GhillieHoodGreenPickup_HPP
#define UE4SS_SDK_BP_GhillieHoodGreenPickup_HPP

class ABP_GhillieHoodGreenPickup_C : public ABP_StaticMeshPickup_C
{
    ...
    void ExecuteUbergraph_BP_GhillieHoodGreenPickup(int32 EntryPoint);
}; // Size: 0x318

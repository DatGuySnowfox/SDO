...
class ABP_AISpawningVolume_C : public AActor
{
    ...
    class USphereComponent* Proximity Deactivation Sphere;                            // 0x02B0 (size: 0x8)
    class USphereComponent* Proximity Activation Sphere;                              // 0x02B8 (size: 0x8)
    class USceneComponent* Scene;                                                     // 0x02C0 (size: 0x8)
    class UBillboardComponent* Billboard;                                             // 0x02C8 (size: 0x8)
    class UBoxComponent* AI Spawn Volume;                                             // 0x02D0 (size: 0x8)
    FS_AISpawner AI Spawn Element;                                                    // 0x02D8 (size: 0x10)
    bool Enable Spawn AI;                                                             // 0x02E8 (size: 0x1)
    TArray<FS_AISpawner> Spawning AI;                                                 // 0x02F0 (size: 0x10)
    ...
    double Respawn Time;                                                              // 0x0350 (size: 0x8)
    double Respawn Time Variation;                                                    // 0x0358 (size: 0x8)
    TArray<FS_AIRespawn> AI Respawning Timers;                                        // 0x0360 (size: 0x10)
    bool Use Player Proximity Activation;                                             // 0x0370 (size: 0x1)
    double Player Activation Range;                                                   // 0x0378 (size: 0x8)
    bool Show Deactivation Proximity;                                                 // 0x0380 (size: 0x1)
    bool Show Activation Proximity;                                                   // 0x0381 (size: 0x1)
    bool Player In Area;                                                              // 0x0382 (size: 0x1)
    int32 AI Total;                                                                   // 0x0384 (size: 0x4)
    TArray<FS_AISpawner> Remaining Spawning AI;                                       // 0x0388 (size: 0x10)
    int32 Spawn Index;                                                                // 0x0398 (size: 0x4)
    bool Use Player Proximity Deactivation;                                           // 0x039C (size: 0x1)
    double Player Deactivation Range;                                                 // 0x03A0 (size: 0x8)
    bool Override Starting Behaviour;                                                 // 0x03A8 (size: 0x1)
    TEnumAsByte<E_StartingAIBehaviours::Type> Override Behaviour;                     // 0x03A9 (size: 0x1)
    TArray<ABP_MasterWayPoint_C*> Way Points;                                         // 0x03B0 (size: 0x10)
    TArray<FS_TriggerResponse> Trigger Activated Responses;                           // 0x03C0 (size: 0x10)
    TArray<FS_TriggerResponse> Trigger Deactivated Responses;                         // 0x03D0 (size: 0x10)
    FName StreamLevelPackageName;                                                     // 0x03E0 (size: 0x8)
    class AActor* AIBase;                                                             // 0x03E8 (size: 0x8)

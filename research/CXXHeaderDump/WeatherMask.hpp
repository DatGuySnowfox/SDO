...
class UWeatherMask_C : public UStaticMeshComponent
{
    ...
    class AUltra_Dynamic_Weather_C* UDW;                                              // 0x0618 (size: 0x8)
    double Mask Snow/Dust;                                                            // 0x0620 (size: 0x8)
    double Mask Wetness;                                                              // 0x0628 (size: 0x8)
    FVector2D Brush Location;                                                         // 0x0630 (size: 0x10)
    FVector2D Brush Scale;                                                            // 0x0640 (size: 0x10)
    double Brush Yaw;                                                                 // 0x0650 (size: 0x8)
    FVector2D Center Location;                                                        // 0x0658 (size: 0x10)
    double Max Distance;                                                              // 0x0668 (size: 0x8)
    bool Ready for Drawing;                                                           // 0x0670 (size: 0x1)
    bool Spawned At Runtime;                                                          // 0x0671 (size: 0x1)

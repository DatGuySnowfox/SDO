...
struct FOptimusCommentNodeAction_ResizeNode : public FOptimusAction
{
}; // Size: 0x38
...
{
    TMap<FName, FOptimusValueIdentifier> PinNameToValueIdMap;                         // 0x0000 (size: 0x50)
...
{
    FName TypeName;                                                                   // 0x0000 (size: 0x8)
    TSoftObjectPtr<class UObject> TypeObject;                                         // 0x0008 (size: 0x28)
...
{
    class UOptimusDeformer* Asset;                                                    // 0x0000 (size: 0x8)
...
{
    TSoftObjectPtr<class UOptimusFunctionNodeGraph> GraphPath;                        // 0x0000 (size: 0x28)
...
{
    FGuid FunctionGraphGuid;                                                          // 0x0000 (size: 0x10)
    FName FunctionName;                                                               // 0x0010 (size: 0x8)
    FName Category;                                                                   // 0x0018 (size: 0x8)

}; // Size: 0x20

struct FOptimusFunctionNodeGraphHeaderWithGuidArray
{
    TArray<FOptimusFunctionNodeGraphHeaderWithGuid> Headers;                          // 0x0000 (size: 0x10)

}; // Size: 0x10

struct FOptimusFunctionReferenceData
{
    TMap<FSoftObjectPath, FOptimusFunctionReferenceNodeSet> FunctionReferences;       // 0x0000 (size: 0x50)

}; // Size: 0x50

struct FOptimusFunctionReferenceNodeSet
{
    TSet<TSoftObjectPtr<class UOptimusNode_FunctionReference>> Nodes;                 // 0x0000 (size: 0x50)
...
struct FOptimusGraphVariableDescription
{
    ...
    TSoftObjectPtr<class UObject> SourceObject;                                       // 0x0060 (size: 0x28)
...
{
    FGuid DeformerInstanceGuid;                                                       // 0x0010 (size: 0x10)

}; // Size: 0x20

struct FRigVMTrait_OptimusDeformer : public FRigVMTrait
{
    TSoftObjectPtr<class UOptimusDeformer> DeformerGraph;                             // 0x0018 (size: 0x28)
...
class IOptimusDeformerAssetPathAccessor : public IInterface
{
}; // Size: 0x28

class IOptimusDeformerGeometryReadbackProvider : public IInterface
{
}; // Size: 0x28
...
class UDEPRECATED_OptimusSkinnedMeshExecDataInterface : public UOptimusComputeDataInterface
{
...
{
    TArray<UOptimusComponentSourceBinding*> Bindings;                                 // 0x0028 (size: 0x10)
...
{
    TArray<TSoftObjectPtr<class UOptimusNode>> KernelToNode;                          // 0x00E0 (size: 0x10)
...
{
    class USkeletalMesh* Mesh;                                                        // 0x0050 (size: 0x8)
    TArray<FOptimusComputeGraphInfo> ComputeGraphs;                                   // 0x0058 (size: 0x10)
    TMap<TWeakObjectPtr<class UComputeDataInterface>, FOptimusDataInterfacePropertyOverrideInfo> DataInterfacePropertyOverrideMap; // 0x0068 (size: 0x50)
    TMap<FOptimusValueIdentifier, FOptimusValueDescription> ValueMap;                 // 0x00B8 (size: 0x50)
    class UOptimusActionStack* ActionStack;                                           // 0x0108 (size: 0x8)
    EOptimusDeformerStatus Status;                                                    // 0x0110 (size: 0x4)
    TArray<UOptimusNodeGraph*> Graphs;                                                // 0x0118 (size: 0x10)
    class UOptimusComponentSourceBindingContainer* Bindings;                          // 0x0128 (size: 0x8)
    class UOptimusVariableContainer* Variables;                                       // 0x0130 (size: 0x8)
    class UOptimusResourceContainer* Resources;                                       // 0x0138 (size: 0x8)

    TArray<UOptimusVariableDescription*> GetVariables();
    TArray<UOptimusResourceDescription*> GetResources();
    class UOptimusComponentSourceBinding* GetPrimaryComponentBinding();
    TArray<UOptimusComponentSourceBinding*> GetComponentBindings();
}; // Size: 0x1D0
...
class UOptimusDeformerDynamicInstanceManager : public UMeshDeformerInstance
{
    ...
    TMap<FGuid, UOptimusDeformerInstance*> GuidToRigDeformerInstanceMap;              // 0x0030 (size: 0x50)
    TMap<FGuid, UOptimusDeformerInstance*> GuidToInstanceMap;                         // 0x0080 (size: 0x50)
...
class UOptimusNode : public UObject
{
    ...
    TArray<UOptimusNodePin*> Pins;                                                    // 0x0050 (size: 0x10)
...
class UOptimusNodeGraph : public UObject
{
    ...
    TArray<UOptimusNode*> Nodes;                                                      // 0x0038 (size: 0x10)
    TArray<UOptimusNodeLink*> Links;                                                  // 0x0048 (size: 0x10)
    TArray<UOptimusNodePair*> NodePairs;                                              // 0x0058 (size: 0x10)
    TArray<UOptimusNodeGraph*> Subgraphs;                                             // 0x0068 (size: 0x10)
    ...
    TArray<UOptimusNodeGraph*> GetGraphs();
    int32 GetGraphIndex();
    TArray<UOptimusNode*> ExpandCollapsedNodes(class UOptimusNode* InGraphReferenceNode);
    ...
    class UOptimusNode* CollapseNodesToSubGraph(const TArray<UOptimusNode*>& InNodes);
    class UOptimusNode* CollapseNodesToFunction(const TArray<UOptimusNode*>& InNodes);
    ...
    TArray<UOptimusNode*> AddLoopTerminalNodes(const FVector2D& InPosition);
    bool AddLink(class UOptimusNodePin* InNodeOutputPin, class UOptimusNodePin* InNodeInputPin);
    class UOptimusNode* AddFunctionReferenceNode(class UOptimusFunctionNodeGraph* InFunctionGraph, const FVector2D& InPosition);
    ...
    class UOptimusNode* AddCommentNode(const FVector2D& InPosition, const FVector2D& InSize, const FLinearColor& InColor);
}; // Size: 0x90
...
class UOptimusNodePin : public UObject
{
    ...
    TArray<UOptimusNodePin*> SubPins;                                                 // 0x00A0 (size: 0x10)
...
{
    FLinearColor CommentColor;                                                        // 0x0108 (size: 0x10)
    int32 FontSize;                                                                   // 0x0118 (size: 0x4)
    FString Comment;                                                                  // 0x0120 (size: 0x10)
    bool bBubbleVisible;                                                              // 0x0130 (size: 0x1)
    bool bColorBubble;                                                                // 0x0131 (size: 0x1)
    FDeprecateSlateVector2D Size;                                                     // 0x0134 (size: 0x8)
...
class UOptimusNode_CustomComputeKernel : public UOptimusNode_ComputeKernelBase
{
    ...
    TArray<UComputeSource*> AdditionalSources;                                        // 0x01D0 (size: 0x10)
...
{
    FOptimusFunctionGraphIdentifier FunctionGraphIdentifier;                          // 0x0120 (size: 0x18)
    TWeakObjectPtr<class UOptimusNodePin> DefaultComponentPin;                        // 0x0138 (size: 0x8)
    TWeakObjectPtr<class UOptimusFunctionNodeGraph> ResolvedFunctionGraph;            // 0x0140 (size: 0x8)
    TSoftObjectPtr<class UOptimusFunctionNodeGraph> FunctionGraph;                    // 0x0148 (size: 0x28)
...
{
    TArray<UOptimusResourceDescription*> Descriptions;                                // 0x0028 (size: 0x10)
...
class UOptimusSkinnedMeshVertexAttributeDataProvider : public UComputeDataProvider
{
    ...
    class UOptimusDeformerInstance* DeformerInstance;                                 // 0x0050 (size: 0x8)
...
{
    TArray<UOptimusVariableDescription*> Descriptions;                                // 0x0028 (size: 0x10)

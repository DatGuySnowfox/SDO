...
struct FAutoClusterDataflowNode : public FDataflowNode
{
    ...
    bool AutoCluster;                                                                 // 0x010C (size: 0x1)
    bool EnforceSiteParameters;                                                       // 0x010D (size: 0x1)
    bool AvoidIsolated;                                                               // 0x010E (size: 0x1)
    FManagedArrayCollection Collection;                                               // 0x0110 (size: 0xB0)
    FDataflowTransformSelection TransformSelection;                                   // 0x01C0 (size: 0x20)
...
struct FCreateLeafConvexHullsDataflowNode : public FDataflowNode
{
    ...
    float SimplificationDistanceThreshold;                                            // 0x01C4 (size: 0x4)
    FDataflowConvexDecompositionSettings ConvexDecompositionSettings;                 // 0x01C8 (size: 0x18)
...
struct FMergeConvexHullsDataflowNode : public FDataflowNode
{
    ...
    int32 TargetNumSamples;                                                           // 0x01EC (size: 0x4)
    double MinSampleSpacing;                                                          // 0x01F0 (size: 0x8)
    double NegativeSpaceTolerance;                                                    // 0x01F8 (size: 0x8)
    double MinRadius;                                                                 // 0x0200 (size: 0x8)

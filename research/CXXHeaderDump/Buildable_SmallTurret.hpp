...
class ABuildable_SmallTurret_C : public ABuildable_TurretMASTER_C
{
    ...
    float Timeline_Rotate_Alpha_83493A744B312F3EDFF37F8FD1C227F2;                     // 0x04A0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline__Direction_83493A744B312F3EDFF37F8FD1C227F2; // 0x04A4 (size: 0x1)

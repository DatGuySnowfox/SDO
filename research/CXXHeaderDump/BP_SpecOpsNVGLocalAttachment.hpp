...
class ABP_SpecOpsNVGLocalAttachment_C : public ABP_AMainLocalAttachment_C
{
    ...
    float NVGTL_TL_F30B97124F77A6BEA413A1B19A8FF24D;                                  // 0x02E8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> NVGTL__Direction_F30B97124F77A6BEA413A1B19A8FF24D; // 0x02EC (size: 0x1)

#ifndef UE4SS_SDK_BP_PoliceCap2Pickup_HPP
#define UE4SS_SDK_BP_PoliceCap2Pickup_HPP

class ABP_PoliceCap2Pickup_C : public ABP_StaticMeshPickup_C
{
    ...
    void ExecuteUbergraph_BP_PoliceCap2Pickup(int32 EntryPoint);
}; // Size: 0x328

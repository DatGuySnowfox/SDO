#ifndef UE4SS_SDK_BP_KeypadNote_HPP
#define UE4SS_SDK_BP_KeypadNote_HPP

class ABP_KeypadNote_C : public ABP_MasterObject_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x02A0 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x02A8 (size: 0x8)
    class UAIOSubjectComponent* AIOSubject;                                           // 0x02B0 (size: 0x8)
    class ULetterUI_C* LetterUI;                                                      // 0x02B8 (size: 0x8)
    int32 Code;                                                                       // 0x02C0 (size: 0x4)
    bool Outline?;                                                                    // 0x02C4 (size: 0x1)

...
{
    EBakeHeightRangeMode HeightRangeMode;                                             // 0x00A8 (size: 0x4)
    float InnerDistance;                                                              // 0x00AC (size: 0x4)
    float OuterDistance;                                                              // 0x00B0 (size: 0x4)
    float InnerBoundsDistance;                                                        // 0x00B4 (size: 0x4)
    float OuterBoundsDistance;                                                        // 0x00B8 (size: 0x4)
...
{
    class UBakeInputMeshProperties* InputMeshSettings;                                // 0x0348 (size: 0x8)
    class UBakeMeshAttributeMapsToolProperties* Settings;                             // 0x0350 (size: 0x8)
    class UBakeMeshAttributeMapsResultToolProperties* ResultSettings;                 // 0x0358 (size: 0x8)
    class UBakeUVShellMapToolProperties* UVShellSettings;                             // 0x0360 (size: 0x8)

}; // Size: 0x400

class UBakeMeshAttributeMapsToolBase : public UBakeMeshAttributeTool
{
    class UBakeVisualizationProperties* VisualizationProps;                           // 0x01D8 (size: 0x8)
    class UPreviewMesh* PreviewMesh;                                                  // 0x01E0 (size: 0x8)
    class UMaterialInstanceDynamic* PreviewMaterial;                                  // 0x01E8 (size: 0x8)
    class UMaterialInstanceDynamic* BentNormalPreviewMaterial;                        // 0x01F0 (size: 0x8)
    TMap<EBakeMapType, UTexture2D*> CachedMaps;                                       // 0x0248 (size: 0x50)
    class UTexture2D* EmptyNormalMap;                                                 // 0x0330 (size: 0x8)
    class UTexture2D* EmptyColorMapBlack;                                             // 0x0338 (size: 0x8)
    class UTexture2D* EmptyColorMapWhite;                                             // 0x0340 (size: 0x8)
...
class UBakeMeshAttributeTool : public UMultiSelectionMeshEditingTool
{
    ...
    class UBakeHeightMapToolProperties* HeightSettings;                               // 0x00E8 (size: 0x8)
    class UMaterialInstanceDynamic* WorkingPreviewMaterial;                           // 0x00F0 (size: 0x8)
    class UMaterialInstanceDynamic* ErrorPreviewMaterial;                             // 0x00F8 (size: 0x8)

}; // Size: 0x1D0

class UBakeMeshAttributeVertexTool : public UBakeMeshAttributeTool
{
    class UBakeInputMeshProperties* InputMeshSettings;                                // 0x01D8 (size: 0x8)
    class UBakeMeshAttributeVertexToolProperties* Settings;                           // 0x01E0 (size: 0x8)
    class UPreviewMesh* PreviewMesh;                                                  // 0x01E8 (size: 0x8)
    class UMaterialInstanceDynamic* PreviewMaterial;                                  // 0x01F0 (size: 0x8)
    class UMaterialInstanceDynamic* PreviewAlphaMaterial;                             // 0x01F8 (size: 0x8)
...
class UBakeMeshAttributeVertexToolProperties : public UInteractiveToolPropertySet
{
    ...
    EBakeVertexTopology TopologyMode;                                                 // 0x00C4 (size: 0x4)
    bool bSplitAtNormalSeams;                                                         // 0x00C8 (size: 0x1)
    bool bSplitAtUVSeams;                                                             // 0x00C9 (size: 0x1)

}; // Size: 0xD0

class UBakeMultiMeshAttributeMapsTool : public UBakeMeshAttributeMapsToolBase
{
    class UBakeMultiMeshAttributeMapsToolProperties* Settings;                        // 0x0348 (size: 0x8)
    class UBakeMultiMeshInputToolProperties* InputMeshSettings;                       // 0x0350 (size: 0x8)
    class UBakeMeshAttributeMapsResultToolProperties* ResultSettings;                 // 0x0358 (size: 0x8)
...
class UBaseMeshFromSplinesTool : public UInteractiveTool
{
    ...
    TArray<TWeakObjectPtr<class AActor>> ActorsWithSplines;                           // 0x00C8 (size: 0x10)
...
class UConvertMeshesTool : public UInteractiveTool
{
    ...
    class UCreateMeshObjectTypeProperties* OutputTypeProperties;                      // 0x00A8 (size: 0x8)
    TArray<TWeakObjectPtr<class UPrimitiveComponent>> Inputs;                         // 0x00B0 (size: 0x10)
...
class UDrawPolyPathTool : public UInteractiveTool
{
    ...
    class UDrawPolyPathProperties* TransformProps;                                    // 0x00C0 (size: 0x8)
    class UDrawPolyPathExtrudeProperties* ExtrudeProperties;                          // 0x00C8 (size: 0x8)
    class UNewMeshMaterialProperties* MaterialProperties;                             // 0x00D0 (size: 0x8)
...
{
    class UExtractSplineToolProperties* Settings;                                     // 0x00B0 (size: 0x8)
    class UConstructionPlaneMechanic* PlaneMechanic;                                  // 0x00B8 (size: 0x8)
    ...
    class UGenerateCrossSectionOpFactory* Factory;                                    // 0x00F8 (size: 0x8)
    class UPreviewGeometry* CutlineGeometry;                                          // 0x0138 (size: 0x8)
...
{
    EExtractSplineMode ExtractionMode;                                                // 0x00A8 (size: 0x1)
...
{
    class UPolygonSelectionMechanic* SelectionMechanic;                               // 0x0180 (size: 0x8)
...
{
    class UMeshSelectionToolProperties* SelectionProps;                               // 0x02F8 (size: 0x8)
    class UMeshSelectionEditActions* SelectionActions;                                // 0x0300 (size: 0x8)
    class UMeshSelectionToolActionPropertySet* EditActions;                           // 0x0308 (size: 0x8)
    class UMeshStatisticsProperties* MeshStatisticsProperties;                        // 0x0310 (size: 0x8)
    class UMeshElementsVisualizer* MeshElementsDisplay;                               // 0x0318 (size: 0x8)
    class UMeshUVChannelProperties* UVChannelProperties;                              // 0x0320 (size: 0x8)
    class UPolygroupLayersProperties* PolygroupLayerProperties;                       // 0x0328 (size: 0x8)
    class UMeshSelectionSet* Selection;                                               // 0x0388 (size: 0x8)
    TArray<AActor*> SpawnedActors;                                                    // 0x0390 (size: 0x10)
...
class UMirrorTool : public UMultiSelectionMeshEditingTool
{
    ...
    TArray<UDynamicMeshReplacementChangeTarget*> MeshesToMirror;                      // 0x00E0 (size: 0x10)
    TArray<UMeshOpPreviewWithBackgroundCompute*> Previews;                            // 0x00F0 (size: 0x10)
...
{
    class UCollisionGeometryVisualizationProperties* VizSettings;                     // 0x00C0 (size: 0x8)
    class UPhysicsInspectorToolProperties* Settings;                                  // 0x00C8 (size: 0x8)
    TArray<UPhysicsObjectToolPropertySet*> ObjectData;                                // 0x00D0 (size: 0x10)
    TArray<UPreviewGeometry*> PreviewElements;                                        // 0x00E0 (size: 0x10)
...
{
    bool bShowTargetMesh;                                                             // 0x00A8 (size: 0x1)
...
class UPlaneCutTool : public UMultiSelectionMeshEditingTool
{
    ...
    TArray<UMeshOpPreviewWithBackgroundCompute*> Previews;                            // 0x00C0 (size: 0x10)
    TArray<UDynamicMeshReplacementChangeTarget*> MeshesToCut;                         // 0x00D0 (size: 0x10)
...
{
    class UCreateMeshObjectTypeProperties* OutputTypeProperties;                      // 0x01A8 (size: 0x8)
    class URevolveBoundaryToolProperties* Settings;                                   // 0x01B0 (size: 0x8)
    class UNewMeshMaterialProperties* MaterialProperties;                             // 0x01B8 (size: 0x8)
    class UConstructionPlaneMechanic* PlaneMechanic;                                  // 0x01C0 (size: 0x8)
    class UMeshOpPreviewWithBackgroundCompute* Preview;                               // 0x01C8 (size: 0x8)
...
{
    class USeamSculptToolProperties* Settings;                                        // 0x02F8 (size: 0x8)
    class UPreviewGeometry* PreviewGeom;                                              // 0x0300 (size: 0x8)
...
class USplitMeshesTool : public UMultiTargetWithSelectionTool
{
    ...
    TArray<UPreviewGeometry*> PerTargetPreviews;                                      // 0x0120 (size: 0x10)

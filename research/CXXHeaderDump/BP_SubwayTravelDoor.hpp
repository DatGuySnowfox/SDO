...
class ABP_SubwayTravelDoor_C : public ABP_MasterObject_C
{
    ...
    float Timeline_OpenDoor_Alpha_7368E6E443BE773EDEF67A924E7C5245;                   // 0x02D0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_OpenDoor__Direction_7368E6E443BE773EDEF67A924E7C5245; // 0x02D4 (size: 0x1)
    class UTimelineComponent* Timeline_OpenDoor;                                      // 0x02D8 (size: 0x8)
    FText TravelToName;                                                               // 0x02E0 (size: 0x10)
    double TimeToTravel;                                                              // 0x02F0 (size: 0x8)
    FVector TravelToLoc;                                                              // 0x02F8 (size: 0x18)
    class UStaticMesh* DoorMesh;                                                      // 0x0310 (size: 0x8)
    ...
    void Event_Teleport(class AActor* Actor);

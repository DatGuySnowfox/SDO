...
struct FAnimNode_RigLogic : public FAnimNode_Base
{
    ...
    bool CacheAnimCurveNames;                                                         // 0x0020 (size: 0x1)
    int32 LODThreshold;                                                               // 0x0024 (size: 0x4)
...
struct FRigLogicConfiguration
{
    ...
    float TranslationPruningThreshold;                                                // 0x000C (size: 0x4)
    float RotationPruningThreshold;                                                   // 0x0010 (size: 0x4)
    float ScalePruningThreshold;                                                      // 0x0014 (size: 0x4)

}; // Size: 0x18

struct FRigUnit_RigLogic : public FRigUnitMutable
{
    FRigUnit_RigLogic_Data Data;                                                      // 0x0010 (size: 0xA8)
...
class UDNAAsset : public UAssetUserData
{
    ...
    TMap<FString, FString> MetaData;                                                  // 0x0040 (size: 0x50)
    FRigLogicConfiguration RigLogicConfiguration;                                     // 0x0090 (size: 0x18)

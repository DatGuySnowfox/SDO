#ifndef UE4SS_SDK_BP_AnimalWolf_AIController_HPP
#define UE4SS_SDK_BP_AnimalWolf_AIController_HPP

class ABP_AnimalWolf_AIController_C : public ABP_MainNeutralAIController_C
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x03C8 (size: 0x8)
    class UAIPerceptionComponent* AIPerception;                                       // 0x03D0 (size: 0x8)
    class USD_AIComponent_C* AIComp;                                                  // 0x03D8 (size: 0x8)
    bool PossessionComplete;                                                          // 0x03E0 (size: 0x1)
    bool CanSeeActor;                                                                 // 0x03E1 (size: 0x1)

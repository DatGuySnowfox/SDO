...
class ABP_Siren_C : public ABP_MasterObject_C
{
    ...
    bool Playing;                                                                     // 0x02D0 (size: 0x1)
    FTimerHandle SirenPlayingTimer;                                                   // 0x02D8 (size: 0x8)
    FText Name;                                                                       // 0x02E0 (size: 0x10)
    double RandomTimeMin;                                                             // 0x02F0 (size: 0x8)
    double RandomTimeMax;                                                             // 0x02F8 (size: 0x8)
    FTimerHandle RandomSirenTimer;                                                    // 0x0300 (size: 0x8)

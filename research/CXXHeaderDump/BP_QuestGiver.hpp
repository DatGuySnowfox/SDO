...
class ABP_QuestGiver_C : public ABP_MasterQuestObject_C
{
    ...
    class USkeletalMeshComponent* Gun;                                                // 0x02D8 (size: 0x8)
    class UStaticMeshComponent* Mouth;                                                // 0x02E0 (size: 0x8)
    class UStaticMeshComponent* Accessory1;                                           // 0x02E8 (size: 0x8)
    class UStaticMeshComponent* Accessory;                                            // 0x02F0 (size: 0x8)
    class UStaticMeshComponent* Hat;                                                  // 0x02F8 (size: 0x8)
    class UStaticMeshComponent* Beard;                                                // 0x0300 (size: 0x8)
    class USkeletalMeshComponent* SkeletalMesh;                                       // 0x0308 (size: 0x8)
    TSubclassOf<class UDialogue> Dialogue;                                            // 0x0310 (size: 0x8)
    FText Name;                                                                       // 0x0318 (size: 0x10)
    FString InteractionArgument;                                                      // 0x0328 (size: 0x10)

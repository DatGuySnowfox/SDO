...
class ABP_LootContainer_C : public ABP_MasterObject_C
{
    ...
    TEnumAsByte<Enum_ContainerLootTables::Type> LootTable;                            // 0x02C0 (size: 0x1)
    TArray<FName> UniqueLootSets;                                                     // 0x02C8 (size: 0x10)
    FText ContainerName;                                                              // 0x02D8 (size: 0x18)
    bool Skip Save?;                                                                  // 0x02F0 (size: 0x1)

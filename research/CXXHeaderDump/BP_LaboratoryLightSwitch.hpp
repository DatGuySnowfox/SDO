...
class ABP_LaboratoryLightSwitch_C : public ABP_LaboratoryMaster_C
{
    ...
    TArray<ABP_LaboratoryLight_C*> Lights;                                            // 0x02C8 (size: 0x10)
    TArray<ABP_LaboratoryLightSwitch_C*> Switches;                                    // 0x02D8 (size: 0x10)
    bool On?;                                                                         // 0x02E8 (size: 0x1)
    bool Off?;                                                                        // 0x02E9 (size: 0x1)
    bool Warning?;                                                                    // 0x02EA (size: 0x1)

...
{
    FWorldObjectComponent_CObjectDestroyed ObjectDestroyed;                           // 0x00B8 (size: 0x10)
    void ObjectDestroyed();
    FWorldObjectComponent_CObjectDamaged ObjectDamaged;                               // 0x00C8 (size: 0x10)
    void ObjectDamaged(double Dmg);
    FWorldObjectComponent_CObjectInteracted ObjectInteracted;                         // 0x00D8 (size: 0x10)

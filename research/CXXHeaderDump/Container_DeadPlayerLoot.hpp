...
class AContainer_DeadPlayerLoot_C : public ABP_MasterObject_C
{
    ...
    class UWidgetComponent* DeathWidget;                                              // 0x02C0 (size: 0x8)
    ...
    FText ContainerName;                                                              // 0x02E0 (size: 0x10)
    class AActor* CurrentActor;                                                       // 0x02F0 (size: 0x8)
    FVector InteractingActorLoc;                                                      // 0x02F8 (size: 0x18)
    FContainer_DeadPlayerLoot_CSetCustomDepth_True SetCustomDepth_True;               // 0x0310 (size: 0x10)
    void SetCustomDepth_True();
    FContainer_DeadPlayerLoot_CSetCustomDepth_False SetCustomDepth_False;             // 0x0320 (size: 0x10)
    void SetCustomDepth_False();
    FTimerHandle OutlineTimer;                                                        // 0x0330 (size: 0x8)
    bool PlayerClose?;                                                                // 0x0338 (size: 0x1)
    class ABP_Marker_C* DeathMarker;                                                  // 0x0340 (size: 0x8)
    bool Looted?;                                                                     // 0x0348 (size: 0x1)

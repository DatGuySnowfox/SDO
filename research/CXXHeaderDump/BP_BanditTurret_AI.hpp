...
class ABP_BanditTurret_AI_C : public ABP_MasterTurret_C
{
    ...
    class UAIOSubjectComponent* AIOSubject;                                           // 0x0330 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x0338 (size: 0x8)
    float TurretRotateAnimation_Rotate_Alpha_066B7CEC4A8B4D4EBE3614908C6B0696;        // 0x0340 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> TurretRotateAnimation__Direction_066B7CEC4A8B4D4EBE3614908C6B0696; // 0x0344 (size: 0x1)
    class UTimelineComponent* TurretRotateAnimation;                                  // 0x0348 (size: 0x8)
    double Duration;                                                                  // 0x0350 (size: 0x8)
    bool IsHeld;                                                                      // 0x0358 (size: 0x1)

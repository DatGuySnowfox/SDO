...
{
    FJigItemOverItemComp_COnOptionSelected OnOptionSelected;                          // 0x00B8 (size: 0x10)
    void OnOptionSelected(FGameplayTag Option, class UJSI_Slot_C* ItemRef, class UJSIContainer_C* ContainerMother);

    void GetEquippedOptionOnDrop(class UJSI_Slot_C* ReceiverItem, class UJSI_Slot_C* DroppedItem, class UJSIContainer_C* ReceiverContainer, class UJSIContainer_C* DroppedContainer);
    ...
    void GetOptionOnDrop(class UJSI_Slot_C* ReceiverItem, class UJSI_Slot_C* DroppedItem, class UJSIContainer_C* ReceiverContainer, class UJSIContainer_C* DroppedContainer, bool EquippedSlot?);

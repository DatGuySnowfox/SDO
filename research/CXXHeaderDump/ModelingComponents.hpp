...
{
    class AActor* HostActor;                                                          // 0x0000 (size: 0x8)
    UClass* ComponentClass;                                                           // 0x0008 (size: 0x8)
    FString BaseName;                                                                 // 0x0010 (size: 0x10)
    bool bSetAsRoot;                                                                  // 0x0020 (size: 0x1)
    bool bTransact;                                                                   // 0x0021 (size: 0x1)
...
{
    ECreateModelingObjectResult ResultCode;                                           // 0x0000 (size: 0x1)
    class UActorComponent* NewComponent;                                              // 0x0008 (size: 0x8)
...
struct FCreateMeshObjectParams
{
    ...
    FMeshNaniteSettings NaniteSettings;                                               // 0x0130 (size: 0x70)
...
class IMeshSculptLayersManager : public IInterface
{
}; // Size: 0x28

class IModelingToolExternalDynamicMeshUpdateAPI : public IInterface
{
}; // Size: 0x28
...
class UBaseCreateFromSelectedTool : public UMultiSelectionMeshEditingTool
{
    ...
    TArray<UTransformProxy*> TransformProxies;                                        // 0x00E8 (size: 0x10)
    TArray<UCombinedTransformGizmo*> TransformGizmos;                                 // 0x00F8 (size: 0x10)
...
class UCollisionPrimitivesMechanic : public UInteractionMechanic
{
    ...
    class UTransformProxy* TranslateTransformProxy;                                   // 0x0380 (size: 0x8)
    class UTransformProxy* SphereTransformProxy;                                      // 0x0388 (size: 0x8)
    class UTransformProxy* BoxTransformProxy;                                         // 0x0390 (size: 0x8)
    class UTransformProxy* CapsuleTransformProxy;                                     // 0x0398 (size: 0x8)
    class UTransformProxy* FullTransformProxy;                                        // 0x03A0 (size: 0x8)
    class UTransformProxy* CurrentActiveProxy;                                        // 0x03A8 (size: 0x8)
    class UCombinedTransformGizmo* TranslateTransformGizmo;                           // 0x03B0 (size: 0x8)
    class UCombinedTransformGizmo* SphereTransformGizmo;                              // 0x03B8 (size: 0x8)
    class UCombinedTransformGizmo* BoxTransformGizmo;                                 // 0x03C0 (size: 0x8)
    class UCombinedTransformGizmo* CapsuleTransformGizmo;                             // 0x03C8 (size: 0x8)
    class UCombinedTransformGizmo* FullTransformGizmo;                                // 0x03D0 (size: 0x8)
    class UIntervalGizmo* BoxIntervalGizmo;                                           // 0x03D8 (size: 0x8)
    class UGizmoLocalFloatParameterSource* BoxXIntervalSource;                        // 0x03E0 (size: 0x8)
    class UGizmoLocalFloatParameterSource* BoxYIntervalSource;                        // 0x03E8 (size: 0x8)
    class UGizmoLocalFloatParameterSource* BoxZIntervalSource;                        // 0x03F0 (size: 0x8)
    class UIntervalGizmo* CapsuleIntervalGizmo;                                       // 0x03F8 (size: 0x8)
    class UGizmoLocalFloatParameterSource* CapsuleRadiusIntervalSource;               // 0x0400 (size: 0x8)
    class UGizmoLocalFloatParameterSource* CapsuleLengthIntervalSource;               // 0x0408 (size: 0x8)
    class URectangleMarqueeMechanic* MarqueeMechanic;                                 // 0x0458 (size: 0x8)

}; // Size: 0x580

class UConstructionPlaneMechanic : public UInteractionMechanic
{
    class UCombinedTransformGizmo* PlaneTransformGizmo;                               // 0x00B8 (size: 0x8)
    class UTransformProxy* PlaneTransformProxy;                                       // 0x00C0 (size: 0x8)
    class USingleClickInputBehavior* ClickToSetPlaneBehavior;                         // 0x00D0 (size: 0x8)
    class ULocalSingleClickInputBehavior* MiddleClickToSetGizmoBehavior;              // 0x00D8 (size: 0x8)
...
class UCurveControlPointsMechanic : public UInteractionMechanic
{
    ...
    class APreviewGeometryActor* PreviewGeometryActor;                                // 0x04D8 (size: 0x8)
    class UPointSetComponent* DrawnControlPoints;                                     // 0x04E0 (size: 0x8)
    class ULineSetComponent* DrawnControlSegments;                                    // 0x04E8 (size: 0x8)
    class UPointSetComponent* PreviewPoint;                                           // 0x04F0 (size: 0x8)
    class ULineSetComponent* PreviewSegment;                                          // 0x04F8 (size: 0x8)
    class UTransformProxy* PointTransformProxy;                                       // 0x0578 (size: 0x8)
    class UCombinedTransformGizmo* PointTransformGizmo;                               // 0x0580 (size: 0x8)
...
class UGeometrySelectionManager : public UObject
{
    ...
    class UInteractiveToolsContext* ToolsContext;                                     // 0x0068 (size: 0x8)
    class UPreviewGeometry* PreviewGeometry;                                          // 0x0148 (size: 0x8)
    FMeshElementSelectionParams UnselectedParams;                                     // 0x02C8 (size: 0x48)
    FMeshElementSelectionParams HoverOverSelectedParams;                              // 0x0310 (size: 0x48)
    FMeshElementSelectionParams HoverOverUnselectedParams;                            // 0x0358 (size: 0x48)
    FMeshElementSelectionParams SelectedParams;                                       // 0x03A0 (size: 0x48)
...
class ULatticeControlPointsMechanic : public UInteractionMechanic
{
    ...
    class UTransformProxy* PointTransformProxy;                                       // 0x02C0 (size: 0x8)
    class UCombinedTransformGizmo* PointTransformGizmo;                               // 0x02C8 (size: 0x8)
    class URectangleMarqueeMechanic* MarqueeMechanic;                                 // 0x0318 (size: 0x8)

}; // Size: 0x4E0

class ULineSetComponent : public UMeshComponent
{
    class UMaterialInterface* LineMaterial;                                           // 0x0568 (size: 0x8)
...
class UMeshTopologySelectionMechanic : public UInteractionMechanic
{
    ...
    class UMouseHoverBehavior* HoverBehavior;                                         // 0x00D0 (size: 0x8)
    class USingleClickOrDragInputBehavior* ClickOrDragBehavior;                       // 0x00D8 (size: 0x8)
    class URectangleMarqueeMechanic* MarqueeMechanic;                                 // 0x00E0 (size: 0x8)
    EMarqueeSelectionUpdateType MarqueeSelectionUpdateType;                           // 0x00E8 (size: 0x4)
    class APreviewGeometryActor* PreviewGeometryActor;                                // 0x06A0 (size: 0x8)
    class UTriangleSetComponent* DrawnTriangleSetComponent;                           // 0x06A8 (size: 0x8)
    class UMaterialInterface* HighlightedFaceMaterial;                                // 0x0700 (size: 0x8)
...
{
    float LineDepthBias;                                                              // 0x0568 (size: 0x4)
    float LineDepthBiasSizeScale;                                                     // 0x056C (size: 0x4)
    float ThicknessScale;                                                             // 0x0570 (size: 0x4)
    bool bEnableWireframe;                                                            // 0x0574 (size: 0x1)
    FColor WireframeColor;                                                            // 0x0578 (size: 0x4)
    float WireframeThickness;                                                         // 0x057C (size: 0x4)
    bool bEnableBoundaryEdges;                                                        // 0x0580 (size: 0x1)
    FColor BoundaryEdgeColor;                                                         // 0x0584 (size: 0x4)
    float BoundaryEdgeThickness;                                                      // 0x0588 (size: 0x4)
    bool bEnableUVSeams;                                                              // 0x058C (size: 0x1)
    FColor UVSeamColor;                                                               // 0x0590 (size: 0x4)
    float UVSeamThickness;                                                            // 0x0594 (size: 0x4)
    bool bEnableNormalSeams;                                                          // 0x0598 (size: 0x1)
    FColor NormalSeamColor;                                                           // 0x059C (size: 0x4)
    float NormalSeamThickness;                                                        // 0x05A0 (size: 0x4)
    bool bEnableTangentSeams;                                                         // 0x05A4 (size: 0x1)
    FColor TangentSeamColor;                                                          // 0x05A8 (size: 0x4)
    float TangentSeamThickness;                                                       // 0x05AC (size: 0x4)
    bool bEnableColorSeams;                                                           // 0x05B0 (size: 0x1)
    FColor ColorSeamColor;                                                            // 0x05B4 (size: 0x4)
    float ColorSeamThickness;                                                         // 0x05B8 (size: 0x4)
    class UMaterialInterface* LineMaterial;                                           // 0x05C0 (size: 0x8)
    FBoxSphereBounds LocalBounds;                                                     // 0x05C8 (size: 0x38)
...
class UModelingObjectsCreationAPI : public UObject
{
    ...
    FCreateComponentResult CreateNewComponentOnActor(const FCreateComponentParams& CreateComponentParams);
...
{
    class UMaterialInterface* PointMaterial;                                          // 0x0568 (size: 0x8)
    FBoxSphereBounds Bounds;                                                          // 0x0570 (size: 0x38)
    bool bBoundsDirty;                                                                // 0x05A8 (size: 0x1)

    void SetPointMaterial(class UMaterialInterface* InPointMaterial);
    void Clear();
    int32 AddPoints(const TArray<FVector>& Positions, const FColor& InColor, const float InSize, const float InDepthBias);
}; // Size: 0x5F0
...
class UPreviewGeometry : public UObject
{
    ...
    TMap<FString, UTriangleSetComponent*> TriangleSets;                               // 0x0030 (size: 0x50)
    TMap<FString, ULineSetComponent*> LineSets;                                       // 0x0080 (size: 0x50)
    TMap<FString, UPointSetComponent*> PointSets;                                     // 0x00D0 (size: 0x50)
...
class URectangleMarqueeMechanic : public UInteractionMechanic
{
    ...
    double OnDragRectangleChangedDeferredThreshold;                                   // 0x0070 (size: 0x8)
    class UClickDragInputBehavior* ClickDragBehavior;                                 // 0x00C0 (size: 0x8)
...
{
    FBoxSphereBounds Bounds;                                                          // 0x0568 (size: 0x38)
    bool bBoundsDirty;                                                                // 0x05A0 (size: 0x1)

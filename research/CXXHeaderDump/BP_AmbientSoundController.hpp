...
class ABP_AmbientSoundController_C : public ABP_MasterObject_C
{
    ...
    class UUDS_PlayerOcclusion_C* UDS_PlayerOcclusion;                                // 0x02B8 (size: 0x8)
    class UAudioComponent* Audio;                                                     // 0x02C0 (size: 0x8)
    bool Day;                                                                         // 0x02C8 (size: 0x1)
    class USoundBase* DaySound;                                                       // 0x02D0 (size: 0x8)
    bool Raining;                                                                     // 0x02D8 (size: 0x1)
    bool Snowing;                                                                     // 0x02D9 (size: 0x1)
    class AUltra_Dynamic_Weather_C* UDW;                                              // 0x02E0 (size: 0x8)
    class AUltra_Dynamic_Sky_C* UDS;                                                  // 0x02E8 (size: 0x8)
    bool Runtime;                                                                     // 0x02F0 (size: 0x1)
    class USoundBase* NightSound;                                                     // 0x02F8 (size: 0x8)
    bool Foggy;                                                                       // 0x0300 (size: 0x1)
    double Target Volume Multiplier;                                                  // 0x0308 (size: 0x8)
    double Daytime Volume Multiplier;                                                 // 0x0310 (size: 0x8)
    double Nighttime Volume Multiplier;                                               // 0x0318 (size: 0x8)
    bool Dusty;                                                                       // 0x0320 (size: 0x1)
    bool No UDS or UDW;                                                               // 0x0321 (size: 0x1)
    double No Weather Volume Multiplier;                                              // 0x0328 (size: 0x8)
    double Rainy Volume Multiplier;                                                   // 0x0330 (size: 0x8)
    double Snowy Volume Multiplier;                                                   // 0x0338 (size: 0x8)
    double Dusty Volume Multiplier;                                                   // 0x0340 (size: 0x8)
    double Foggy Volume Multiplier;                                                   // 0x0348 (size: 0x8)

#ifndef UE4SS_SDK_MilitarySupplyCratesContainer_Widget_HPP
#define UE4SS_SDK_MilitarySupplyCratesContainer_Widget_HPP

class UMilitarySupplyCratesContainer_Widget_C : public UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x02C0 (size: 0x8)
    class UJSIContainer_C* MainContainer;                                             // 0x02C8 (size: 0x8)

#ifndef UE4SS_SDK_BP_JigComponent_HPP
#define UE4SS_SDK_BP_JigComponent_HPP

class UBP_JigComponent_C : public UActorComponent
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x00B8 (size: 0x8)
    TArray<FS_ReplicatedContainerInfo> MainJigContainers;                             // 0x00C0 (size: 0x10)
    TArray<UJSIContainer_C*> LocalJSIContainers;                                      // 0x00D0 (size: 0x10)
    FGameplayTag MPComponentType;                                                     // 0x00E0 (size: 0x8)
    TArray<UJSI_Slot_C*> PendingRequests;                                             // 0x00E8 (size: 0x10)
    TArray<FGuid> MainContainersIDs;                                                  // 0x00F8 (size: 0x10)
    TArray<FS_JigCompContentSettings> ContainersSettings;                             // 0x0108 (size: 0x10)
    double RefillContainerTimerInSeconds;                                             // 0x0118 (size: 0x8)
    TSubclassOf<class UUserWidget> InventoryWidgetClass;                              // 0x0120 (size: 0x8)
    class UUserWidget* InventoryWidgetRef;                                            // 0x0128 (size: 0x8)
    TArray<AActor*> PendingActors;                                                    // 0x0130 (size: 0x10)
    bool DoesContainerRefillLoot?;                                                    // 0x0140 (size: 0x1)
    bool IfPickup_CanLoot?;                                                           // 0x0141 (size: 0x1)
    bool AllowDroppingItems;                                                          // 0x0142 (size: 0x1)
    FContainerPickupsInfo PickupInfo;                                                 // 0x0148 (size: 0xD8)
    double VendorCurrentCurrencyAmount;                                               // 0x0220 (size: 0x8)
    FVector2D VendorMaxCurrencyAmount;                                                // 0x0228 (size: 0x10)
    class UJigsawItem_DataAsset_C* VendorAcceptedCurrencyID;                          // 0x0238 (size: 0x8)
    bool VendorReSellSoldItems?;                                                      // 0x0240 (size: 0x1)
    bool AllowSellingItemsToVendor?;                                                  // 0x0241 (size: 0x1)
    TArray<FS_JigCrafting> ItemsToCraft;                                              // 0x0248 (size: 0x10)
    TArray<int32> ExcludeMainContainerIndexesFromLoot;                                // 0x0258 (size: 0x10)
    FGuid MonitorContainerUID;                                                        // 0x0268 (size: 0x10)
    FGuid PendingVendorContainerUID;                                                  // 0x0278 (size: 0x10)
    int32 PendingVendorToIndex;                                                       // 0x0288 (size: 0x4)
    bool PendingVendorFinalRot;                                                       // 0x028C (size: 0x1)
    int32 ServerVendorRequestedBuyAmount;                                             // 0x0290 (size: 0x4)
    TArray<FS_InvWeight> InventoryWeight;                                             // 0x0298 (size: 0x10)
    TArray<int32> ExcludeMainContainerIndexesFromVendorCurrency;                      // 0x02A8 (size: 0x10)
    bool DebugContent?;                                                               // 0x02B8 (size: 0x1)
    bool Looted?;                                                                     // 0x02B9 (size: 0x1)
    FTimerHandle RefillTimerHandle;                                                   // 0x02C0 (size: 0x8)
    TArray<FContainerPickupsInfo> PendingCraftingItems;                               // 0x02C8 (size: 0x10)
    TArray<double> PendingCraftingTimers;                                             // 0x02D8 (size: 0x10)
    FTimerHandle CraftingTimerHandle;                                                 // 0x02E8 (size: 0x8)
    FBP_JigComponent_COnWeightUpdated OnWeightUpdated;                                // 0x02F0 (size: 0x10)
    void OnWeightUpdated();
    FBP_JigComponent_COnInventoryOpenClose OnInventoryOpenClose;                      // 0x0300 (size: 0x10)
    void OnInventoryOpenClose(bool Opened?);
    FBP_JigComponent_CClientSaveDataReceived ClientSaveDataReceived;                  // 0x0310 (size: 0x10)
    void ClientSaveDataReceived();
    FBP_JigComponent_COnRefillContainer OnRefillContainer;                            // 0x0320 (size: 0x10)
    ...
    void FindJigItemByDA_Array(TArray<UJigsawItem_DataAsset_C*>& DAArray, FGameplayTagContainer SearchOnlyInSlots, bool DeepSearch?, bool SearchInEquipTo?, int32 RequiredAmount, bool& Result, class UJSI_Slot_C*& Found);
    void RebuildInventoryData();
    void CheckVendorAmountOfMoney(double Price, class UBP_JigComponent_C* Comp, bool Selling?, bool& Enough?);
    void PickupInfoFromActor(class AActor* Target, int32 SlotIndex, bool Rotated, FContainerPickupsInfo& Result);
    void ServerFunc_HandleActorToCapacityContainer(class AActor* ActorRef, class UBP_JigComponent_C* ToComp, FGuid ToContainerUID, int32 ToIndex, bool Rotated, FGuid PendingUID, bool& Proceed?, bool& Fail?);
    ...
    void JigTryAddItemSomewhere(class UBP_JigComponent_C* LocalComp, class UJigsawItem_DataAsset_C* ItemId, int32 Count, bool& Added?, FGuid& UID);
    ...
    void HandleServerFuncRequestCraftDrop(class UBP_JigComponent_C* CompRef, int32 CraftIndex, TArray<FGuid>& ConsumeUIDs);
    ...
    bool IsEmpty?();
    void CheckIfItemsExist(TArray<UJigsawItem_DataAsset_C*>& Items, bool& Result);
    void UpdatePickupInfo(FContainerPickupsInfo PickupInfo);
    void GetSearchableContainers(TArray<UJSIContainer_C*>& Result);
    ...
    void ClientFunc_GetDesiredMoneyLocation(class UBP_JigComponent_C* VendorCom, class UJSI_Slot_C* DroppedItem, bool& Found, FGuid& ToContainerID, int32& ToIndex);
    ...
    void AddNewItemSomewhere(class UJigsawItem_DataAsset_C* ItemId, int32 Count, class UJigsawItem_DataAsset_C* ItemInside, int32 ItemInsideCount, bool DropIfFailedToAdd?, FName SpecificContainer, bool& Added, bool& Dropped?, FGuid& ItemUID, FGuid& AddedToUID);
    ...
    void HandleServerFuncRequestCraft(class UBP_JigComponent_C* CompRef, int32 CraftIndex, TArray<FGuid>& ConsumeUIDs, FGuid AddToContainer, int32 ToIndex, bool FinalRotation, FGuid TempUID, FGuid StackWith);
    void FindCraftingIngredient(class UUserWidget* OneCont, class UJigsawItem_DataAsset_C* ID, int32 Count, TArray<FGuid>& Exclude, TArray<UJSI_Slot_C*>& OutputPin, bool& Result);
    void CheckCraftingIngredients(FRepItemInfo RequiredItem, TArray<FGuid>& Exclude, TArray<UJSI_Slot_C*>& ItemFound Element);
    ...
    void HandleLocalRequestConsumeItem(FGuid ItemUID, int32 Amount, class UBP_JigComponent_C* LocalComp, FString CustomData, bool CallbackToPlayer?);
    void ServerFunc_HandleMoveToCapacityContainer(class UBP_JigComponent_C* FromComp, class UBP_JigComponent_C* ToComp, FGuid ItemUID, FGuid ToContainerUID, int32 ToIndex, bool& Proceed?, bool& Fail?);
    bool CheckCapacityContainer(FRepItemInfo ContainerInfo, FGuid ToContainerUID, int32& FreeSpace, TArray<UJigsawItem_DataAsset_C*>& AvailableIDs, int32& Index);
    ...
    void HandleServerDropRequest(FGuid ItemUID, int32 Count, class UBP_JigComponent_C* LocalComp);
    ...
    void ServerFunc_RequestStackItem(class UBP_JigComponent_C* FromCom, class UBP_JigComponent_C* ToComp, FGuid DroppedUID, FGuid ReceiverUID, int32 MaxStack, bool& Success);
    ...
    void ServerHandleSplitRequest(class UBP_JigComponent_C* FromComp, class UBP_JigComponent_C* ToComp, FGuid ItemUID, FGuid ToContainerUID, int32 ToIndex, int32 SplitAmount, bool Rotated?);
    ...
    void Handle Comp to Comp Move(class UBP_JigComponent_C* From, class UBP_JigComponent_C* To, FGuid ItemUID, bool FinalRotation, int32 ToIndex, FGuid ToContainer, int32 VendorAmount, FGuid VendorMoneyToUID, int32 VendorMoneyToIndex);
    ...
    void GetLocalComp(class UBP_JigComponent_C*& JigComp);
    void HandleSameContainerMoveToIndex(FGuid ItemUID, FGuid ToContainerUID, int32 ToIndex, bool Rotated?, class UBP_JigComponent_C* LocalComp, int32 InContainerIndex);
    ...
    void SERVER_RequestRemoveItem(class UBP_JigComponent_C* TargetComp, FGuid ItemUID, int32 Amount, bool CallbackToPlayer?);
    void MC_UpdateDurability(FGuid ItemUID, FVector2D NewDurab);
    void SERVER_RequestCraftItemDrop(class UBP_JigComponent_C* CompRef, int32 CraftIndex, const TArray<FGuid>& ConsumeUIDs);
    ...
    void SERVER_RequestSaveGame(class UBP_JigComponent_C* MpRef, const TArray<FGuid>& ActionbarUIDs);
    void SERVER_RequestDataFromSave(class UBP_JigComponent_C* JigMPCompRef);
    ...
    void SERVER_RequestCraftItem(class UBP_JigComponent_C* CompRef, int32 CraftIndex, const TArray<FGuid>& ConsumeUIDs, FGuid AddToContainer, int32 ToIndex, bool FinalRotation, FGuid TempUID, FGuid StackWith);
    ...
    void SERVER_RequestConsumeItem(class UBP_JigComponent_C* TargetComp, FGuid ItemUID, int32 Amount, FString CustomData);
    ...
    void SERVER_RequestDropItem(FGuid ItemUID, int32 Count, class UBP_JigComponent_C* CompTarget);
    ...
    void SERVER_RequestStackItem(class UBP_JigComponent_C* FromCom, class UBP_JigComponent_C* ToComp, FGuid DroppedUID, FGuid ReceiverUID, int32 MaxStack);
    ...
    void CLIENT_UpdateCount(class UBP_JigComponent_C* TargetComp, FGuid ItemUID, int32 NewCount, FGuid RemovedPending);
    ...
    void SERVER_RequestSplitItem(class UBP_JigComponent_C* FromComp, class UBP_JigComponent_C* ToComp, FGuid ItemUID, FGuid ToContainerUID, int32 ToIndex, int32 SplitAmount, bool Rotated?);
    void InitializeJigComponent();
    void CLIENT_AddNewItem(FContainerPickupsInfo ItemInfo, const TArray<FContainerPickupsInfo>& Content, class UBP_JigComponent_C* Comp, FGuid PendingUID);
    void CLIENT_ItemRemoved(FGuid UID, class UBP_JigComponent_C* Comp, bool SkipPendingRequests?);
    void MC_ItemRemoved(const FGuid& ItemUID);
    void SERVER_RequestMoveItemToAnotherComp(class UBP_JigComponent_C* From, class UBP_JigComponent_C* To, FGuid ItemUID, bool FinalRotation, int32 ToIndex, FGuid ToContainer, int32 VendorAmount, FGuid VendorMoneyToUID, int32 VendorMoneyToIndex);
    void MC_MoveItemToIndex(class UBP_JigComponent_C* TargetComp, FGuid ItemUID, FGuid ToContainerUID, int32 ToIndex, bool FinalRotation);
    void CLIENT_MoveToIndexFailed(const TArray<FGuid>& ItemUID, class UBP_JigComponent_C* JijgCompTarget);
    void SERVER_SameContainer_MoveToIndex(class UBP_JigComponent_C* JigMPCompRef, FGuid ItemUID, FGuid ToContainerUID, int32 ToIndex, bool Rotated?, int32 InContainerIndex);
    void CLIENT_ContainerDataResponse(const TArray<FGuid>& MainContainersUIDs, const TArray<FContainerPickupsInfo>& ContainerItems, class UBP_JigComponent_C* JigMPCompRef, const TArray<FGuid>& ActionbarUIDs);
    void SERVER_RequestData(class UBP_JigComponent_C* JigMPCompRef);
    ...
    void ExecuteUbergraph_BP_JigComponent(int32 EntryPoint);

...
class UBP_CustomNarrativeDefaultUI_C : public UUserWidget
{
    ...
    class UTextBlock* SmallNotificationText;                                          // 0x0350 (size: 0x8)
    class UTextBlock* QuestUpdatedText;                                               // 0x0358 (size: 0x8)
    class UTextBlock* QuestUpdatedSubtext;                                            // 0x0360 (size: 0x8)
    class UVerticalBox* PlayerReplyBox;                                               // 0x0368 (size: 0x8)
    class UTextBlock* NPCNameText;                                                    // 0x0370 (size: 0x8)
    class UTextBlock* MinorNotificationText;                                          // 0x0378 (size: 0x8)
    class UTextBlock* LargeNotificationText;                                          // 0x0380 (size: 0x8)
    class UVerticalBox* LargeNotificationBox;                                         // 0x0388 (size: 0x8)
    class UCanvasPanel* DialogueUI;                                                   // 0x0390 (size: 0x8)
    class UImage* DialogueImg;                                                        // 0x0398 (size: 0x8)
    class URichTextBlock* CurrentSpeaker;                                             // 0x03A0 (size: 0x8)
    class URichTextBlock* CurrentDialogueLine;                                        // 0x03A8 (size: 0x8)
    class UVerticalBox* BranchesBox;                                                  // 0x03B0 (size: 0x8)
    class UCanvasPanel* BaseCanvas;                                                   // 0x03B8 (size: 0x8)
    class UWidgetAnimation* FadeInTasks;                                              // 0x03C0 (size: 0x8)
    class UWidgetAnimation* FadeInNotification;                                       // 0x03C8 (size: 0x8)
    class UDialogueNode_Player* CurrentPlayerReply;                                   // 0x03D0 (size: 0x8)
    TArray<UDialogueNode_NPC*> NPCReplies;                                            // 0x03D8 (size: 0x10)
    TArray<UDialogueNode_Player*> PlayerReplies;                                      // 0x03E8 (size: 0x10)
    double SpacerMargin;                                                              // 0x03F8 (size: 0x8)
    bool LockDialogueUI?;                                                             // 0x0400 (size: 0x1)
    class UDialogueNode_NPC* CurrentNPCReply;                                         // 0x0408 (size: 0x8)
    FTimerHandle ClearNotificationHandle;                                             // 0x0410 (size: 0x8)
    double LargeNotificationDuration;                                                 // 0x0418 (size: 0x8)
    TArray<FText> Notifications;                                                      // 0x0420 (size: 0x10)
    double SmallNotificationDuration;                                                 // 0x0430 (size: 0x8)
    class USoundBase* SmallNotificationSound;                                         // 0x0438 (size: 0x8)
    class UObject* Journal;                                                           // 0x0440 (size: 0x8)
    TArray<FKey> SelectInputs;                                                        // 0x0448 (size: 0x10)
    TArray<FKey> DownInputs;                                                          // 0x0458 (size: 0x10)
    TArray<FKey> UpInputs;                                                            // 0x0468 (size: 0x10)
    TArray<FKey> EndDialogueInputs;                                                   // 0x0478 (size: 0x10)
    bool ShowPlayerName?;                                                             // 0x0488 (size: 0x1)
    TMap<UNarrativeTask*, UBP_CustomWaypoint_C*> Wayoints;                            // 0x0490 (size: 0x50)
    class UNarrativeComponent* NarrativeComponent;                                    // 0x04E0 (size: 0x8)
    TArray<UBP_CustomDialogueOption_C*> PlayerDialogueOptions;                        // 0x04E8 (size: 0x10)
    ...
    void On Dialogue Finished(class UDialogue* Dialogue, bool IsStartingNewDialogue?, EExitDialogueReason Reason);
    ...
    void On Dialogue Replies Available(class UDialogue* Dialogue, TArray<UDialogueNode_Player*>& PlayerReplies);

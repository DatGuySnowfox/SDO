...
class UVehicleFuelComponent_C : public UBaseComponent_C
{
    ...
    FTimerHandle FuelRestore_Timer;                                                   // 0x00D8 (size: 0x8)
    double CurrentFuel;                                                               // 0x00E0 (size: 0x8)
    double MaxFuel;                                                                   // 0x00E8 (size: 0x8)
    double WasteTime;                                                                 // 0x00F0 (size: 0x8)
    double WasteOfFuelPerTime;                                                        // 0x00F8 (size: 0x8)
    bool Empty;                                                                       // 0x0100 (size: 0x1)
    FVehicleFuelComponent_CFuelUpdate FuelUpdate;                                     // 0x0108 (size: 0x10)
    void FuelUpdate(double FuelInput);
    class ABP_VehicleMaster_C* Vehicle;                                               // 0x0118 (size: 0x8)

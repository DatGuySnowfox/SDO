...
class UBPT_GoToLocation_C : public UNarrativeTask
{
    ...
    FVector GoalLocation;                                                             // 0x0088 (size: 0x18)
    double DistanceTolerance;                                                         // 0x00A0 (size: 0x8)
    FText FriendlyLocationName;                                                       // 0x00A8 (size: 0x10)
    TSubclassOf<class AActor> GoalActorClass;                                         // 0x00B8 (size: 0x8)
    FName GoalActorTag;                                                               // 0x00C0 (size: 0x8)
    bool Invert?;                                                                     // 0x00C8 (size: 0x1)
    class AActor* GoalActor;                                                          // 0x00D0 (size: 0x8)
    class UBP_Narrative3Overlay_C* NarrativeUI;                                       // 0x00D8 (size: 0x8)

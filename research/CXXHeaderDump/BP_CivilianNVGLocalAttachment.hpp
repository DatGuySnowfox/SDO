...
class ABP_CivilianNVGLocalAttachment_C : public ABP_AMainLocalAttachment_C
{
    ...
    float NVGTL_TL_9DF085DC414A828FAE04DBA2A9257E5B;                                  // 0x02E8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> NVGTL__Direction_9DF085DC414A828FAE04DBA2A9257E5B; // 0x02EC (size: 0x1)

...
class AFlyingPlayerCamera_C : public ASpectatorPawn
{
    ...
    class UAIOInvokerComponent* AIOInvoker;                                           // 0x0360 (size: 0x8)
    class USpringArmComponent* SpringArm;                                             // 0x0368 (size: 0x8)
    FFlyingPlayerCamera_CMovingFreeCamera MovingFreeCamera;                           // 0x0370 (size: 0x10)
    void MovingFreeCamera();
    FFlyingPlayerCamera_CNotMovingFreeCamera NotMovingFreeCamera;                     // 0x0380 (size: 0x10)
    void NotMovingFreeCamera();
    double FocusLoc;                                                                  // 0x0390 (size: 0x8)
    class APawn* Pawn;                                                                // 0x0398 (size: 0x8)

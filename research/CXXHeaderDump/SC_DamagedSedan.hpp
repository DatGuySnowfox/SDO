#ifndef UE4SS_SDK_SC_DamagedSedan_HPP
#define UE4SS_SDK_SC_DamagedSedan_HPP

class USC_DamagedSedan_C : public UUserWidget
{
    FPointerToUberGraphFrame UberGraphFrame;                                          // 0x02C0 (size: 0x8)
    class UJSIContainer_C* JSIContainer_1;                                            // 0x02C8 (size: 0x8)
    class UJSI_Slot_C* CoyoteBackpack_Ref;                                            // 0x02D0 (size: 0x8)

...
class ABuildable_WoodenDoor_C : public ABuildable_MASTER_C
{
    ...
    float Timeline_OpenDoor_Alpha_6400FFBC444EDC99BED08E9A90CC7899;                   // 0x0458 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_OpenDoor__Direction_6400FFBC444EDC99BED08E9A90CC7899; // 0x045C (size: 0x1)

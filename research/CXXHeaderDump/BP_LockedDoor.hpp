...
class ABP_LockedDoor_C : public ABP_LockPickObject_C
{
    ...
    class UStaticMeshComponent* Door;                                                 // 0x02E0 (size: 0x8)
    class UArrowComponent* Arrow;                                                     // 0x02E8 (size: 0x8)
    float Timeline_OpenDoorAuto_Alpha_7388A7EA4CB01198880C048DDE54E33F;               // 0x02F0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_OpenDoorAuto__Direction_7388A7EA4CB01198880C048DDE54E33F; // 0x02F4 (size: 0x1)
    class UTimelineComponent* Timeline_OpenDoorAuto;                                  // 0x02F8 (size: 0x8)
    float Timeline_OpenDoor_Alpha_CA4B83EF45872B61E7779EAD32D6380C;                   // 0x0300 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_OpenDoor__Direction_CA4B83EF45872B61E7779EAD32D6380C; // 0x0304 (size: 0x1)
    class UTimelineComponent* Timeline_OpenDoor;                                      // 0x0308 (size: 0x8)
    bool IsHeld;                                                                      // 0x0310 (size: 0x1)
    class UStaticMesh* Mesh;                                                          // 0x0318 (size: 0x8)
    double Duration;                                                                  // 0x0320 (size: 0x8)
    class USoundBase* NoiseAudio;                                                     // 0x0328 (size: 0x8)
    bool Closed?;                                                                     // 0x0330 (size: 0x1)
    FText Action Name;                                                                // 0x0338 (size: 0x10)

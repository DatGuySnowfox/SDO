...
class APhotoModeFreeCamera_C : public ASpectatorPawn
{
    ...
    double FreeCameraMaximumDistance;                                                 // 0x0368 (size: 0x8)
    class ACharacter* PlayerPawn;                                                     // 0x0370 (size: 0x8)
    FPhotoModeFreeCamera_CMovingFreeCamera MovingFreeCamera;                          // 0x0378 (size: 0x10)
    void MovingFreeCamera();
    FPhotoModeFreeCamera_CNotMovingFreeCamera NotMovingFreeCamera;                    // 0x0388 (size: 0x10)
    void NotMovingFreeCamera();
    double CameraSensitivity;                                                         // 0x0398 (size: 0x8)
    double TimeDilation;                                                              // 0x03A0 (size: 0x8)
    double StartingFOV;                                                               // 0x03A8 (size: 0x8)
    FRotator StartingRotation;                                                        // 0x03B0 (size: 0x18)
    bool UseMaximumDistanceLimit;                                                     // 0x03C8 (size: 0x1)

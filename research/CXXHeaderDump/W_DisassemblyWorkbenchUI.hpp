...
class UW_DisassemblyWorkbenchUI_C : public UUserWidget
{
    ...
    TArray<UJSIContainer_C*> NonAdd;                                                  // 0x0378 (size: 0x10)
    ...
    void BndEvt__W_DisassemblyWorkbenchUI_Button_K2Node_ComponentBoundEvent_1_OnButtonClickedEvent__DelegateSignature();

...
class ABP_BarrierGate_C : public ABP_MasterDoor_C
{
    ...
    float Timeline_0_Alpha_46729FC84A35509CAD5069979017673E;                          // 0x02D0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_46729FC84A35509CAD5069979017673E; // 0x02D4 (size: 0x1)

...
class ABP_ResortLight_C : public ABP_MasterLight_C
{
    ...
    class UStaticMeshComponent* Light;                                                // 0x02C8 (size: 0x8)
    float Timeline_TurnOff_Intensity_55494F92401FAB9CA11D539A62884D93;                // 0x02D0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_TurnOff__Direction_55494F92401FAB9CA11D539A62884D93; // 0x02D4 (size: 0x1)
    class UTimelineComponent* Timeline_TurnOff;                                       // 0x02D8 (size: 0x8)
    float Timeline_TurnOn_Intensity_AC8A7F314EE014C9CF5B23B01E7564D6;                 // 0x02E0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_TurnOn__Direction_AC8A7F314EE014C9CF5B23B01E7564D6; // 0x02E4 (size: 0x1)

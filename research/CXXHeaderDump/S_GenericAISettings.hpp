...
struct FS_GenericAISettings
{
    ...
    TArray<USoundCue*> AudioReactions_41_C11CB89343680758598383ACBFDB9E50;            // 0x0110 (size: 0x10)
    TArray<UAnimMontage*> AnimReactions_40_229C1FB5485B00B5C0AC14B99350FB43;          // 0x0120 (size: 0x10)

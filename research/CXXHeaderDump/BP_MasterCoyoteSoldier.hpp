#ifndef UE4SS_SDK_BP_MasterCoyoteSoldier_HPP
#define UE4SS_SDK_BP_MasterCoyoteSoldier_HPP

class ABP_MasterCoyoteSoldier_C : public ABP_MasterAICharacter_C
{
    ...
    class UStaticMeshComponent* HeadwearMesh;                                         // 0x0850 (size: 0x8)
    class UStaticMeshComponent* MaskMesh;                                             // 0x0858 (size: 0x8)
    TEnumAsByte<Enum_AILootTables::Type> LootTable;                                   // 0x0860 (size: 0x1)
    FText Name;                                                                       // 0x0868 (size: 0x10)
    bool Boss?;                                                                       // 0x0878 (size: 0x1)
    TArray<TSubclassOf<class ABP_AIWeapon_Master_C>> RangedWeapon;                    // 0x0880 (size: 0x10)
    TArray<TSubclassOf<class ABP_AIWeapon_Master_C>> MeleeWeapon;                     // 0x0890 (size: 0x10)
    bool StartWithRangeWeaponEquipped?;                                               // 0x08A0 (size: 0x1)
    TArray<USkeletalMesh*> Meshes;                                                    // 0x08A8 (size: 0x10)
    TMap<UStaticMesh*, FTransform> HeadwearMeshes;                                    // 0x08B8 (size: 0x50)
    TMap<UStaticMesh*, FTransform> MaskMeshes;                                        // 0x0908 (size: 0x50)
    TMap<UStaticMesh*, FTransform> BackpackMeshes;                                    // 0x0958 (size: 0x50)
    bool SkipRandomMaterial?;                                                         // 0x09A8 (size: 0x1)
    FVector InteractingActorLoc;                                                      // 0x09B0 (size: 0x18)
    class AActor* CurrentActor;                                                       // 0x09C8 (size: 0x8)
    bool CanAddMarker?;                                                               // 0x09D0 (size: 0x1)
    class UWidgetComponent* Marker;                                                   // 0x09D8 (size: 0x8)
    FTimerHandle MarkerTimer;                                                         // 0x09E0 (size: 0x8)
    bool Is Burning?;                                                                 // 0x09E8 (size: 0x1)
    class UParticleSystemComponent* BurningEffect;                                    // 0x09F0 (size: 0x8)
    FTimerHandle BurningTimer;                                                        // 0x09F8 (size: 0x8)
    bool Looted;                                                                      // 0x0A00 (size: 0x1)
    ...
    void ExecuteUbergraph_BP_MasterCoyoteSoldier(int32 EntryPoint);
}; // Size: 0xA01

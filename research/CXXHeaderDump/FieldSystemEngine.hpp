...
class UBoxFalloff : public UFieldNodeFloat
{
    ...
    float MinRange;                                                                   // 0x00BC (size: 0x4)
    float MaxRange;                                                                   // 0x00C0 (size: 0x4)
    float Default;                                                                    // 0x00C4 (size: 0x4)
    FTransform Transform;                                                             // 0x00D0 (size: 0x60)
    TEnumAsByte<EFieldFalloffType> Falloff;                                           // 0x0130 (size: 0x1)
...
{
    class UFieldNodeBase* Culling;                                                    // 0x00B8 (size: 0x8)
    class UFieldNodeBase* Field;                                                      // 0x00C0 (size: 0x8)
    TEnumAsByte<EFieldCullingOperationType> Operation;                                // 0x00C8 (size: 0x1)
...
class UFieldSystemComponent : public UPrimitiveComponent
{
    ...
    TArray<TSoftObjectPtr<class AChaosSolverActor>> SupportedSolvers;                 // 0x0530 (size: 0x10)
...
{
    TEnumAsByte<EFieldFilterType> FilterType;                                         // 0x00B8 (size: 0x1)
    TEnumAsByte<EFieldObjectType> ObjectType;                                         // 0x00B9 (size: 0x1)
    TEnumAsByte<EFieldPositionType> PositionType;                                     // 0x00BA (size: 0x1)
...
{
    int32 Iterations;                                                                 // 0x00B8 (size: 0x4)
...
{
    TEnumAsByte<EFieldResolutionType> ResolutionType;                                 // 0x00B8 (size: 0x1)
...
{
    float MinRange;                                                                   // 0x00B8 (size: 0x4)
    float MaxRange;                                                                   // 0x00BC (size: 0x4)
...
{
    float Magnitude;                                                                  // 0x00B8 (size: 0x4)
    class UFieldNodeBase* RightField;                                                 // 0x00C0 (size: 0x8)
    class UFieldNodeBase* LeftField;                                                  // 0x00C8 (size: 0x8)
    TEnumAsByte<EFieldOperationType> Operation;                                       // 0x00D0 (size: 0x1)
...
class UPlaneFalloff : public UFieldNodeFloat
{
    ...
    float MaxRange;                                                                   // 0x00C0 (size: 0x4)
    float Default;                                                                    // 0x00C4 (size: 0x4)
    float Distance;                                                                   // 0x00C8 (size: 0x4)
    FVector Position;                                                                 // 0x00D0 (size: 0x18)
    FVector Normal;                                                                   // 0x00E8 (size: 0x18)
    TEnumAsByte<EFieldFalloffType> Falloff;                                           // 0x0100 (size: 0x1)
...
class URadialIntMask : public UFieldNodeInt
{
    ...
    int32 InteriorValue;                                                              // 0x00D8 (size: 0x4)
    int32 ExteriorValue;                                                              // 0x00DC (size: 0x4)
    TEnumAsByte<ESetMaskConditionType> SetMaskCondition;                              // 0x00E0 (size: 0x1)
...
{
    class UFieldNodeInt* IntField;                                                    // 0x00B8 (size: 0x8)
...
{
    class UFieldNodeFloat* FloatField;                                                // 0x00B8 (size: 0x8)
...
{
    int32 Magnitude;                                                                  // 0x00B8 (size: 0x4)
...
{
    float Magnitude;                                                                  // 0x00B8 (size: 0x4)
    FVector Direction;                                                                // 0x00C0 (size: 0x18)
...
class UWaveScalar : public UFieldNodeFloat
{
    float Magnitude;                                                                  // 0x00B8 (size: 0x4)
    FVector Position;                                                                 // 0x00C0 (size: 0x18)
    float Wavelength;                                                                 // 0x00D8 (size: 0x4)
    float Period;                                                                     // 0x00DC (size: 0x4)
    TEnumAsByte<EWaveFunctionType> Function;                                          // 0x00E0 (size: 0x1)
    TEnumAsByte<EFieldFalloffType> Falloff;                                           // 0x00E1 (size: 0x1)

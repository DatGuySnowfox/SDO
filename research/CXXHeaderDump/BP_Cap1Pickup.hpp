#ifndef UE4SS_SDK_BP_Cap1Pickup_HPP
#define UE4SS_SDK_BP_Cap1Pickup_HPP

class ABP_Cap1Pickup_C : public ABP_StaticMeshPickup_C
{
    ...
    void ExecuteUbergraph_BP_Cap1Pickup(int32 EntryPoint);
}; // Size: 0x328

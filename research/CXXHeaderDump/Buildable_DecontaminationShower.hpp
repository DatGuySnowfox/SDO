...
class ABuildable_DecontaminationShower_C : public ABuildable_MASTER_C
{
    ...
    class UStaticMeshComponent* Light2;                                               // 0x0448 (size: 0x8)
    class UStaticMeshComponent* Light;                                                // 0x0450 (size: 0x8)
    class UParticleSystemComponent* FX_Water2;                                        // 0x0458 (size: 0x8)
    class UParticleSystemComponent* FX_Water;                                         // 0x0460 (size: 0x8)
    class USceneComponent* Trace;                                                     // 0x0468 (size: 0x8)
    double Cooldown;                                                                  // 0x0470 (size: 0x8)
    bool CooldownRunning?;                                                            // 0x0478 (size: 0x1)

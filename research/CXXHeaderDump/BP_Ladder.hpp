...
class ABP_Ladder_C : public ABP_MasterObject_C
{
    ...
    class UArrowComponent* PlayerRotation;                                            // 0x02B8 (size: 0x8)
    class USceneComponent* PlayerPostition;                                           // 0x02C0 (size: 0x8)
    class UBoxComponent* LadderTopCollision;                                          // 0x02C8 (size: 0x8)
    class UAIOSubjectComponent* AIOSubject;                                           // 0x02D0 (size: 0x8)
    class UBoxComponent* LadderCollision;                                             // 0x02D8 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x02E0 (size: 0x8)
    bool Mesh?;                                                                       // 0x02E8 (size: 0x1)
    FVector MeshBottom;                                                               // 0x02F0 (size: 0x18)
    double PieceHeight;                                                               // 0x0308 (size: 0x8)
    double OffsetBox;                                                                 // 0x0310 (size: 0x8)
    class UStaticMeshComponent* StaticMeshComponents;                                 // 0x0318 (size: 0x8)
    bool CanClimb?;                                                                   // 0x0320 (size: 0x1)

#ifndef UE4SS_SDK_BP_BaseballHelmetPickup_HPP
#define UE4SS_SDK_BP_BaseballHelmetPickup_HPP

class ABP_BaseballHelmetPickup_C : public ABP_StaticMeshPickup_C
{
    ...
    void ExecuteUbergraph_BP_BaseballHelmetPickup(int32 EntryPoint);
}; // Size: 0x328

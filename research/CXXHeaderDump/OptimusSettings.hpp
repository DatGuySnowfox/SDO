...
class UOptimusSettings : public UDeveloperSettings
{
    ...
    TSoftObjectPtr<class UMeshDeformer> DefaultDeformer;                              // 0x0040 (size: 0x28)
    TSoftObjectPtr<class UMeshDeformer> DefaultRecomputeTangentDeformer;              // 0x0068 (size: 0x28)

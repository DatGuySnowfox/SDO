...
struct FUDS_Space_Planet
{
    ...
    TSoftObjectPtr<class UTexture2D> ColorTexture_30_2BBB70D24D2BDD9AD355609B4FF9B21B; // 0x0028 (size: 0x28)
    FLinearColor ColorTextureTint_123_F088C5B64DFD1D20EEC23CBC27966B9C;               // 0x0050 (size: 0x10)
    TSoftObjectPtr<class UTexture2D> NormalMap_33_A9266AE648B84654F7C9B9849CFA3E7C;   // 0x0060 (size: 0x28)
    ...
    TSoftObjectPtr<class UTexture2D> EmissiveTexture_66_5312AAA94E7A901D5F46D6AC848F943F; // 0x0140 (size: 0x28)
    ...
    TSoftObjectPtr<class UTexture2D> RingTexture_92_B962AC934EE0E4617A29BE9F710F32EF; // 0x01B0 (size: 0x28)
    ...
    TSoftObjectPtr<class UTexture2D> MeshDeformTexture_126_B7DC215A433430E4AD89459B331BC0CE; // 0x0200 (size: 0x28)
    double MeshDeformStrength_129_CBDEB487415F39784E41DBB95BE8F4B1;                   // 0x0228 (size: 0x8)
    double MeshDeformCenterLevel_135_D94322934BFA5C635C0D2BA54E37A086;                // 0x0230 (size: 0x8)
    FVector MeshDeformTextureOffset_132_F11E46C5458E2C4E5B3ABB8E3C2E6B45;             // 0x0238 (size: 0x18)

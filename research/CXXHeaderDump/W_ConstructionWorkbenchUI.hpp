...
class UW_ConstructionWorkbenchUI_C : public UUserWidget
{
    ...
    class UEquipmentSlotTitle_C* StandardTitle;                                       // 0x0358 (size: 0x8)
    class UEquipmentSlotTitle_C* ModularTitle;                                        // 0x0360 (size: 0x8)
    class UBorder* LoadingT;                                                          // 0x0368 (size: 0x8)
    class UJSIContainer_C* JSIContainer_1;                                            // 0x0370 (size: 0x8)
    class UJSIContainer_C* JSIContainer;                                              // 0x0378 (size: 0x8)
    class UEquipmentSlotTitle_C* EquipmentSlotTitle_1;                                // 0x0380 (size: 0x8)
    class UEquipmentSlotTitle_C* EquipmentSlotTitle;                                  // 0x0388 (size: 0x8)
    class UButton* Button_Increase;                                                   // 0x0390 (size: 0x8)
    class UButton* Button_Decrease;                                                   // 0x0398 (size: 0x8)
    class UButton* Button_81;                                                         // 0x03A0 (size: 0x8)
    TMap<UJSI_Slot_C*, int32> AddedItems;                                             // 0x03A8 (size: 0x50)
    class UJSI_Slot_C* CurrentFaded;                                                  // 0x03F8 (size: 0x8)
    class UBP_JigComponent_C* MPComponent;                                            // 0x0400 (size: 0x8)
    TArray<FGuid> RequestConsume;                                                     // 0x0408 (size: 0x10)
    int32 CraftIndex;                                                                 // 0x0418 (size: 0x4)
    class ABuildable_ConstructionBench_C* StationOwner;                               // 0x0420 (size: 0x8)
    class UBP_JigComponent_C* PlayerMPComp;                                           // 0x0428 (size: 0x8)
    int32 CountIndex;                                                                 // 0x0430 (size: 0x4)
    bool ItemCrafted?;                                                                // 0x0434 (size: 0x1)

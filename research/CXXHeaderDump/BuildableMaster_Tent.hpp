...
class ABuildableMaster_Tent_C : public ABuildable_MASTER_C
{
    ...
    FStruct_WorldActorInventory TentInventory;                                        // 0x0448 (size: 0x30)
    TArray<FS_ReplicatedContainerInfo> MainJigContainers;                             // 0x0478 (size: 0x10)
    TArray<FGuid> MainContainersIDs;                                                  // 0x0488 (size: 0x10)
    TArray<FS_InvWeight> Inventory Weight;                                            // 0x0498 (size: 0x10)

...
class ABP_FirearmPickup_C : public ABP_SkeletalMeshPickup_C
{
    ...
    class UBP_EquipmentPickupComponent_C* BP_EquipmentPickupComponent;                // 0x0398 (size: 0x8)
    class UBP_WeaponsPickupComponent_C* BP_WeaponsPickupComponent;                    // 0x03A0 (size: 0x8)
    float ResetRecoilTL_Reset_0A95F0FE40AECD2F428F87B705900F3B;                       // 0x03A8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> ResetRecoilTL__Direction_0A95F0FE40AECD2F428F87B705900F3B; // 0x03AC (size: 0x1)
    class UTimelineComponent* ResetRecoilTL;                                          // 0x03B0 (size: 0x8)
    float RecoilTL_Recoil_297C066B40C93F9CB632DC9EE7ECC8B0;                           // 0x03B8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> RecoilTL__Direction_297C066B40C93F9CB632DC9EE7ECC8B0; // 0x03BC (size: 0x1)
    class UTimelineComponent* RecoilTL;                                               // 0x03C0 (size: 0x8)
    class UPassiveSkillsComponent_C* PassiveSkillsComponent;                          // 0x03C8 (size: 0x8)
    bool FiringAutomatically?;                                                        // 0x03D0 (size: 0x1)
    class UJSIContainer_C* ChamberContainer;                                          // 0x03D8 (size: 0x8)
    class UJSI_Slot_C* CurrentMag;                                                    // 0x03E0 (size: 0x8)
    class ABP_AMainLocalAttachment_C* PendingMag;                                     // 0x03E8 (size: 0x8)
    float ShotDistance;                                                               // 0x03F0 (size: 0x4)
    bool HipFire?;                                                                    // 0x03F4 (size: 0x1)
    bool FireReady;                                                                   // 0x03F5 (size: 0x1)
    FGameplayTag PlayerActiveWeapon;                                                  // 0x03F8 (size: 0x8)
    class UActorComponent* GPlayerMPComp;                                             // 0x0400 (size: 0x8)
    float TempPitch;                                                                  // 0x0408 (size: 0x4)
    float TempYaw;                                                                    // 0x040C (size: 0x4)
    FBP_FirearmPickup_CFireWeapon FireWeapon;                                         // 0x0410 (size: 0x10)
    void FireWeapon();
    ...
    void GetSurfaceDensity(TEnumAsByte<EPhysicalSurface> surface, double& Density);
    ...
    void Local_StartShooting(class UBP_JigComponent_C* PlayerMPComp, FGameplayTag ActiveWeapon, bool HipFire?);
    void FireSurfaceHit(FVector ImpactPoint, class AActor* HitActor, FRotator Rotation, TEnumAsByte<EPhysicalSurface> surface);
    void FireTrace(double Spread, bool Hipfire);
    void FireBullet();
    ...
    void Event_FireRate();
    void Svr_WeaponShot();
    void SERVER_DamageEvent(bool Headshot, class AActor* DamagedActor, FVector ImpactPoint);

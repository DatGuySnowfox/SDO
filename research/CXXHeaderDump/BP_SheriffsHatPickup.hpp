#ifndef UE4SS_SDK_BP_SheriffsHatPickup_HPP
#define UE4SS_SDK_BP_SheriffsHatPickup_HPP

class ABP_SheriffsHatPickup_C : public ABP_StaticMeshPickup_C
{
    ...
    void ExecuteUbergraph_BP_SheriffsHatPickup(int32 EntryPoint);
}; // Size: 0x328

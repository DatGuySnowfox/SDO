...
class UProgressBarCircular_C : public UWB_Base_C
{
    ...
    class UWB_Container_Circular_C* WB_Container_Circular;                            // 0x0350 (size: 0x8)
    class USizeBox* SB_Content;                                                       // 0x0358 (size: 0x8)
    class URetainerBox* RB_BlendMask;                                                 // 0x0360 (size: 0x8)
    class UOverlay* OV_Effects_Foreground;                                            // 0x0368 (size: 0x8)
    class UOverlay* OV_Effects_Background;                                            // 0x0370 (size: 0x8)
    class UBorder* B_Content;                                                         // 0x0378 (size: 0x8)
    class UWidgetAnimation* Fade;                                                     // 0x0380 (size: 0x8)
    double Size;                                                                      // 0x0388 (size: 0x8)
    TEnumAsByte<EProgressMethod::Type> ProgressMethod;                                // 0x0390 (size: 0x1)
    double QueueDelay;                                                                // 0x0398 (size: 0x8)
    double CurrentPercent;                                                            // 0x03A0 (size: 0x8)
    double InterpTimeCurrent;                                                         // 0x03A8 (size: 0x8)
    FLinearColor FillColorCurrent;                                                    // 0x03B0 (size: 0x10)
    class UTexture2D* FillColorMask;                                                  // 0x03C0 (size: 0x8)
    bool UseGradient;                                                                 // 0x03C8 (size: 0x1)
    bool UseTargetPercent;                                                            // 0x03C9 (size: 0x1)
    double TargetPercent;                                                             // 0x03D0 (size: 0x8)
    double InterpTimeTarget;                                                          // 0x03D8 (size: 0x8)
    FLinearColor TargetFillColor_Positive;                                            // 0x03E0 (size: 0x10)
    FLinearColor TargetFillColor_Negative;                                            // 0x03F0 (size: 0x10)
    FLinearColor BackgroundColor;                                                     // 0x0400 (size: 0x10)
    class UTexture2D* BackgroundMask;                                                 // 0x0410 (size: 0x8)
    double DeltaTime;                                                                 // 0x0418 (size: 0x8)
    double InterpValue;                                                               // 0x0420 (size: 0x8)
    double NewPercent;                                                                // 0x0428 (size: 0x8)
    double OldPercent;                                                                // 0x0430 (size: 0x8)
    double InterpValueTarget;                                                         // 0x0438 (size: 0x8)
    double NewTargetPercent;                                                          // 0x0440 (size: 0x8)
    double OldTargetPercent;                                                          // 0x0448 (size: 0x8)
    bool CanSetTargetPercent;                                                         // 0x0450 (size: 0x1)
    bool CanSetPercent;                                                               // 0x0451 (size: 0x1)
    bool bIsDesignTime;                                                               // 0x0452 (size: 0x1)
    TEnumAsByte<EGradientTypes::Type> GradientType;                                   // 0x0453 (size: 0x1)
    double GradientColorVariation;                                                    // 0x0458 (size: 0x8)
    class UTexture2D* BlendMask;                                                      // 0x0460 (size: 0x8)
    double Thickness;                                                                 // 0x0468 (size: 0x8)
    double Density;                                                                   // 0x0470 (size: 0x8)
    double StepDensity;                                                               // 0x0478 (size: 0x8)
    bool bUseMarquee;                                                                 // 0x0480 (size: 0x1)
    FLinearColor MarqueeColor;                                                        // 0x0484 (size: 0x10)
    int32 Separation_Steps;                                                           // 0x0494 (size: 0x4)
    double Separation_Steps_Spacing;                                                  // 0x0498 (size: 0x8)
    bool bIsSeparated;                                                                // 0x04A0 (size: 0x1)
    bool Separation_AbsoluteFillMethod;                                               // 0x04A1 (size: 0x1)
    FVector2D LocalSize;                                                              // 0x04A8 (size: 0x10)
    TArray<FS_Effects> Effects;                                                       // 0x04B8 (size: 0x10)
    class UWB_Effect_C* CurrentEffectWidget;                                          // 0x04C8 (size: 0x8)
    FProgressBarCircular_COnPercentChanged OnPercentChanged;                          // 0x04D0 (size: 0x10)
    void OnPercentChanged(double Percent);
    double GradientOpacity;                                                           // 0x04E0 (size: 0x8)
    FLinearColor MarqueeColorBackground;                                              // 0x04E8 (size: 0x10)
    double MarqueeTime;                                                               // 0x04F8 (size: 0x8)
    TEnumAsByte<EMarqueeMask::Type> MarqueeMask;                                      // 0x0500 (size: 0x1)
    class UTexture2D* CustomMarqueeMask;                                              // 0x0508 (size: 0x8)
    FTimerHandle Timer;                                                               // 0x0510 (size: 0x8)
    TArray<double> Entries;                                                           // 0x0518 (size: 0x10)
    bool bIsProgressRunning;                                                          // 0x0528 (size: 0x1)
    bool PauseWithGamePause;                                                          // 0x0529 (size: 0x1)

...
{
    TSoftObjectPtr<class UNNEModelData> ModelData;                                    // 0x0030 (size: 0x28)
    TSoftObjectPtr<class UDataTable> InputMapping;                                    // 0x0058 (size: 0x28)
    TSoftObjectPtr<class UDataTable> OutputMapping;                                   // 0x0080 (size: 0x28)
...
{
    TSoftObjectPtr<class UNNEDenoiserAsset> DenoiserAsset;                            // 0x0038 (size: 0x28)
    int32 MaximumTileSizeOverride;                                                    // 0x0088 (size: 0x4)
    TEnumAsByte<EDenoiserRuntimeType> RuntimeType;                                    // 0x008C (size: 0x1)

...
class ABuildable_TurretMASTER_C : public ABuildable_MASTER_C
{
    ...
    class UWidgetComponent* Widget;                                                   // 0x0448 (size: 0x8)
    class UBP_BuildableTurretAIComponent_C* BP_BuildableTurretAIComponent;            // 0x0450 (size: 0x8)
    class USphereComponent* Weapon Muzzle;                                            // 0x0458 (size: 0x8)
    class UArrowComponent* Forward Direction;                                         // 0x0460 (size: 0x8)
    class UArrowComponent* FOV Arrow Right;                                           // 0x0468 (size: 0x8)
    class UArrowComponent* FOV Arrow Up;                                              // 0x0470 (size: 0x8)
    class UArrowComponent* FOV Arrow Down;                                            // 0x0478 (size: 0x8)
    class UArrowComponent* FOV Arrow Left;                                            // 0x0480 (size: 0x8)
    class UStaticMeshComponent* Turret;                                               // 0x0488 (size: 0x8)

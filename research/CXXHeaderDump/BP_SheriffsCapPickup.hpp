#ifndef UE4SS_SDK_BP_SheriffsCapPickup_HPP
#define UE4SS_SDK_BP_SheriffsCapPickup_HPP

class ABP_SheriffsCapPickup_C : public ABP_StaticMeshPickup_C
{
    ...
    void ExecuteUbergraph_BP_SheriffsCapPickup(int32 EntryPoint);
}; // Size: 0x328

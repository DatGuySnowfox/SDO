...
class AHUD_Game_C : public AHUD
{
    ...
    class UDaysSurvivedWidget_C* DaysSurvivedUI;                                      // 0x03A8 (size: 0x8)
    class UNotificationParentWidget_C* NotificationUI;                                // 0x03B0 (size: 0x8)
    class UZoneAreaWidget_C* AreaUI;                                                  // 0x03B8 (size: 0x8)
    class UTimeUI_C* TimeUI;                                                          // 0x03C0 (size: 0x8)
    bool TimeIsOpen?;                                                                 // 0x03C8 (size: 0x1)
    class UW_EnemyHealthBarOverlay_C* EnemyHealthBarUI;                               // 0x03D0 (size: 0x8)
    class UPauseScreen_C* PauseMenu;                                                  // 0x03D8 (size: 0x8)
    class UInteractionTimerUI_C* InteractTimerWidget;                                 // 0x03E0 (size: 0x8)
    class USafeZoneUI_C* SafeZoneUI;                                                  // 0x03E8 (size: 0x8)
    class UBP_InteractWidget_C* InteractWidget;                                       // 0x03F0 (size: 0x8)
    class UBP_LootContainerWidget_C* LootContainerWidget;                             // 0x03F8 (size: 0x8)
    class URadioTextUI_C* RadioTextUI;                                                // 0x0400 (size: 0x8)
    class UBuildableRenameObject_C* ChangeNameWidget;                                 // 0x0408 (size: 0x8)
    class USleepingUI_C* SleepUI;                                                     // 0x0410 (size: 0x8)
    class UPOIDiscoveredUI_C* POIDiscover;                                            // 0x0418 (size: 0x8)
    class UModularYesNoUI_C* YesNoUI;                                                 // 0x0420 (size: 0x8)
    ...
    void ShowLootContainerWidget(bool Show?, class AActor* Actor, FText Container, FText LootType, bool Marked?, bool Looted?, const TMap<FGameplayTag, FText> Options);
    void UpdateInteractOptions(const FGameplayTag OptionToUpdate, FText Text, bool ClearOptions?);
    void ShowInteractWidget(bool Visible?, FText Name, FText AdditionalText, const TMap<FGameplayTag, FText> Options, TMap<FName, FText> Stats, class UWidget*& Widget);

...
class ABP_RandomInfestationSpawnPoint_C : public ABP_MasterObject_C
{
    ...
    double RandomChance;                                                              // 0x02C0 (size: 0x8)
    class UStaticMesh* NormalMesh;                                                    // 0x02C8 (size: 0x8)
    class UStaticMesh* DestroyedMesh;                                                 // 0x02D0 (size: 0x8)
    FBP_RandomInfestationSpawnPoint_CSpawn Spawn;                                     // 0x02D8 (size: 0x10)
    void Spawn();
    TArray<FTransform> AISpawningTransforms;                                          // 0x02E8 (size: 0x10)

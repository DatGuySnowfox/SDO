...
class UUDW_Temperature_Manager_C : public UActorComponent
{
    ...
    FVector2D Temperature Range;                                                      // 0x00D0 (size: 0x10)
    double Update Period;                                                             // 0x00E0 (size: 0x8)
    bool For WOV;                                                                     // 0x00E8 (size: 0x1)
    class AVolume* Volume;                                                            // 0x00F0 (size: 0x8)
    double Last Temperature Update Time;                                              // 0x00F8 (size: 0x8)
    double Last Temperature;                                                          // 0x0100 (size: 0x8)
    double Target Temperature;                                                        // 0x0108 (size: 0x8)

...
class ABP_HangarDoor_C : public ABP_MasterDoor_C
{
    ...
    class UStaticMeshComponent* DoorR;                                                // 0x02E0 (size: 0x8)
    float Timeline_OpenDoor_DoorR_A2EFD5EF4597BEE29011F49ED5E69D4E;                   // 0x02E8 (size: 0x4)
    float Timeline_OpenDoor_DoorL_A2EFD5EF4597BEE29011F49ED5E69D4E;                   // 0x02EC (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_OpenDoor__Direction_A2EFD5EF4597BEE29011F49ED5E69D4E; // 0x02F0 (size: 0x1)
    class UTimelineComponent* Timeline_OpenDoor;                                      // 0x02F8 (size: 0x8)
    class UJigsawItem_DataAsset_C* Keycard;                                           // 0x0300 (size: 0x8)
    bool Open?;                                                                       // 0x0308 (size: 0x1)
    bool Outline?;                                                                    // 0x0309 (size: 0x1)
    bool XPGiven?;                                                                    // 0x030A (size: 0x1)

...
class UDebugMenu_C : public UUserWidget
{
    ...
    class UWidgetSwitcher* WidgetSwitcher;                                            // 0x0348 (size: 0x8)
    class UButton* ToughnessButton;                                                   // 0x0350 (size: 0x8)
    class UButton* ThiefButton;                                                       // 0x0358 (size: 0x8)
    class UButton* StrengthButton;                                                    // 0x0360 (size: 0x8)
    class USpinBox* SpinBox_719;                                                      // 0x0368 (size: 0x8)
    class UButton* SpawnCameraButton;                                                 // 0x0370 (size: 0x8)
    class UButton* SneakingButton;                                                    // 0x0378 (size: 0x8)
    class USlider* Slider_126;                                                        // 0x0380 (size: 0x8)
    class USettingRow_C* SettingRow_28;                                               // 0x0388 (size: 0x8)
    class USettingRow_C* SettingRow_27;                                               // 0x0390 (size: 0x8)
    class USettingRow_C* SettingRow_26;                                               // 0x0398 (size: 0x8)
    class USettingRow_C* SettingRow_25;                                               // 0x03A0 (size: 0x8)
    class USettingRow_C* SettingRow_24;                                               // 0x03A8 (size: 0x8)
    class USettingRow_C* SettingRow_23;                                               // 0x03B0 (size: 0x8)
    class USettingRow_C* SettingRow_22;                                               // 0x03B8 (size: 0x8)
    class USettingRow_C* SettingRow_21;                                               // 0x03C0 (size: 0x8)
    class USettingRow_C* SettingRow_20;                                               // 0x03C8 (size: 0x8)
    class USettingRow_C* SettingRow_19;                                               // 0x03D0 (size: 0x8)
    class USettingRow_C* SettingRow_18;                                               // 0x03D8 (size: 0x8)
    class USettingRow_C* SettingRow_17;                                               // 0x03E0 (size: 0x8)
    class USettingRow_C* SettingRow_16;                                               // 0x03E8 (size: 0x8)
    class USettingRow_C* SettingRow_15;                                               // 0x03F0 (size: 0x8)
    class USettingRow_C* SettingRow_14;                                               // 0x03F8 (size: 0x8)
    class USettingRow_C* SettingRow_13;                                               // 0x0400 (size: 0x8)
    class USettingRow_C* SettingRow_12;                                               // 0x0408 (size: 0x8)
    class USettingRow_C* SettingRow_10;                                               // 0x0410 (size: 0x8)
    class USettingRow_C* SettingRow_9;                                                // 0x0418 (size: 0x8)
    class USettingRow_C* SettingRow_8;                                                // 0x0420 (size: 0x8)
    class USettingRow_C* SettingRow_7;                                                // 0x0428 (size: 0x8)
    class USettingRow_C* SettingRow_6;                                                // 0x0430 (size: 0x8)
    class USettingRow_C* SettingRow_5;                                                // 0x0438 (size: 0x8)
    class USettingRow_C* SettingRow_4;                                                // 0x0440 (size: 0x8)
    class USettingRow_C* SettingRow_3;                                                // 0x0448 (size: 0x8)
    class USettingRow_C* SettingRow_2;                                                // 0x0450 (size: 0x8)
    class USettingRow_C* SettingRow_1;                                                // 0x0458 (size: 0x8)
    class USettingRow_C* SettingRow;                                                  // 0x0460 (size: 0x8)
    class UScrollBox* ScrollBox_Weapons;                                              // 0x0468 (size: 0x8)
    class UScrollBox* ScrollBox_Vehicle;                                              // 0x0470 (size: 0x8)
    class UScrollBox* ScrollBox_Other;                                                // 0x0478 (size: 0x8)
    class UScrollBox* ScrollBox_Equipment;                                            // 0x0480 (size: 0x8)
    class UScrollBox* ScrollBox_CraftingMaterials;                                    // 0x0488 (size: 0x8)
    class UScrollBox* ScrollBox_Consumable;                                           // 0x0490 (size: 0x8)
    class UScrollBox* ScrollBox_Buildables;                                           // 0x0498 (size: 0x8)
    class UScrollBox* ScrollBox_Attachments;                                          // 0x04A0 (size: 0x8)
    class UScrollBox* ScrollBox_All;                                                  // 0x04A8 (size: 0x8)
    class UButton* ScavengingButton;                                                  // 0x04B0 (size: 0x8)
    class UButton* ResetSkillTreeButton;                                              // 0x04B8 (size: 0x8)
    class UButton* ResetPassiveSkillsButton;                                          // 0x04C0 (size: 0x8)
    class UButton* ResetLevelButton;                                                  // 0x04C8 (size: 0x8)
    class UButton* ReloadingButton;                                                   // 0x04D0 (size: 0x8)
    class UButton* ReduceThirstButton;                                                // 0x04D8 (size: 0x8)
    class UButton* ReduceHungerButton;                                                // 0x04E0 (size: 0x8)
    class UButton* RebuildDataButton;                                                 // 0x04E8 (size: 0x8)
    class UButton* MarksmanshipButton;                                                // 0x04F0 (size: 0x8)
    class UButton* InfectionStateButton;                                              // 0x04F8 (size: 0x8)
    class UButton* GiveXPButton;                                                      // 0x0500 (size: 0x8)
    class UButton* FitnessButton;                                                     // 0x0508 (size: 0x8)
    class UButton* FishingButton;                                                     // 0x0510 (size: 0x8)
    class UButton* FirstAidButton;                                                    // 0x0518 (size: 0x8)
    class UEditableText* EditableText_Weapons;                                        // 0x0520 (size: 0x8)
    class UEditableText* EditableText_Other;                                          // 0x0528 (size: 0x8)
    class UEditableText* EditableText_Equipment;                                      // 0x0530 (size: 0x8)
    class UEditableText* EditableText_CraftingMaterials;                              // 0x0538 (size: 0x8)
    class UEditableText* EditableText_Consumables;                                    // 0x0540 (size: 0x8)
    class UEditableText* EditableText_Buildables;                                     // 0x0548 (size: 0x8)
    class UEditableText* EditableText_Attachments;                                    // 0x0550 (size: 0x8)
    class UEditableText* EditableText_All;                                            // 0x0558 (size: 0x8)
    class UEditableText* EditableText_357;                                            // 0x0560 (size: 0x8)
    class UEditableText* EditableDilationTxt;                                         // 0x0568 (size: 0x8)
    class UComboBoxString* DropDownWeather;                                           // 0x0570 (size: 0x8)
    class UButton* DamagePlayerButton;                                                // 0x0578 (size: 0x8)
    class UButton* Button_RightItems;                                                 // 0x0580 (size: 0x8)
    class UButton* Button_LeftItems;                                                  // 0x0588 (size: 0x8)
    float Amount;                                                                     // 0x0590 (size: 0x4)
    int32 ActiveTabIndex;                                                             // 0x0594 (size: 0x4)
    TArray<UJigsawItem_DataAsset_C*> AllItems;                                        // 0x0598 (size: 0x10)
    TArray<UJigsawItem_DataAsset_C*> Weapons;                                         // 0x05A8 (size: 0x10)
    TArray<UJigsawItem_DataAsset_C*> Attachments;                                     // 0x05B8 (size: 0x10)
    TArray<UJigsawItem_DataAsset_C*> Equipment;                                       // 0x05C8 (size: 0x10)
    TArray<UJigsawItem_DataAsset_C*> Consumables;                                     // 0x05D8 (size: 0x10)
    TArray<UJigsawItem_DataAsset_C*> CraftingMats;                                    // 0x05E8 (size: 0x10)
    TArray<UJigsawItem_DataAsset_C*> Other;                                           // 0x05F8 (size: 0x10)
    TArray<UJigsawItem_DataAsset_C*> Buildables;                                      // 0x0608 (size: 0x10)
    TArray<UJigsawItem_DataAsset_C*> HideTheseItems;                                  // 0x0618 (size: 0x10)
    ...
    void BndEvt__DebugMenu_RebuildDataButton_K2Node_ComponentBoundEvent_6_OnButtonClickedEvent__DelegateSignature();
    void BndEvt__DebugMenu_InfectionStateButton_K2Node_ComponentBoundEvent_7_OnButtonClickedEvent__DelegateSignature();

#ifndef UE4SS_SDK_AnimBP_Rabbit_HPP
#define UE4SS_SDK_AnimBP_Rabbit_HPP
...
class UAnimBP_Rabbit_C : public UAnimInstance
{
    ...
    class ABP_AnimalRabbit_C* RabbitRef;                                              // 0x0638 (size: 0x8)

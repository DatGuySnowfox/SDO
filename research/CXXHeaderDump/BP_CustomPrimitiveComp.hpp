...
class ABP_CustomPrimitiveComp_C : public AActor
{
    ...
    class USceneComponent* AttachmentComp;                                            // 0x02C0 (size: 0x8)
    class UJigsawItem_DataAsset_C* DA;                                                // 0x02C8 (size: 0x8)
    bool Use Leader Pose?;                                                            // 0x02D0 (size: 0x1)
    FGuid UID;                                                                        // 0x02D4 (size: 0x10)

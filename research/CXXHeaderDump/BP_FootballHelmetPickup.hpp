#ifndef UE4SS_SDK_BP_FootballHelmetPickup_HPP
#define UE4SS_SDK_BP_FootballHelmetPickup_HPP

class ABP_FootballHelmetPickup_C : public ABP_StaticMeshPickup_C
{
    ...
    void ExecuteUbergraph_BP_FootballHelmetPickup(int32 EntryPoint);
}; // Size: 0x328

...
{
    EAudioSpectrumAnalyzerType AnalyzerType;                                          // 0x0000 (size: 0x1)
    EFFTSize FFTAnalyzerFFTSize;                                                      // 0x0001 (size: 0x1)
    EConstantQFFTSizeEnum CQTAnalyzerFFTSize;                                         // 0x0002 (size: 0x1)
    EAudioSpectrogramFrequencyAxisPixelBucketMode PixelPlotMode;                      // 0x0003 (size: 0x1)
    EAudioSpectrogramFrequencyAxisScale FrequencyScale;                               // 0x0004 (size: 0x1)
    EAudioColorGradient ColorMap;                                                     // 0x0005 (size: 0x1)
    TEnumAsByte<EOrientation> Orientation;                                            // 0x0006 (size: 0x1)

}; // Size: 0x7

struct FSpectrumAnalyzerRackUnitSettings
{
    EAudioSpectrumAnalyzerBallistics Ballistics;                                      // 0x0000 (size: 0x1)
    EAudioSpectrumAnalyzerType AnalyzerType;                                          // 0x0001 (size: 0x1)
    EFFTSize FFTAnalyzerFFTSize;                                                      // 0x0002 (size: 0x1)
    EConstantQFFTSizeEnum CQTAnalyzerFFTSize;                                         // 0x0003 (size: 0x1)
    EAudioSpectrumPlotTilt TiltSpectrum;                                              // 0x0004 (size: 0x1)
    EAudioSpectrumPlotFrequencyAxisPixelBucketMode PixelPlotMode;                     // 0x0005 (size: 0x1)
    EAudioSpectrumPlotFrequencyAxisScale FrequencyScale;                              // 0x0006 (size: 0x1)
    bool bDisplayFrequencyAxisLabels;                                                 // 0x0007 (size: 0x1)
    bool bDisplaySoundLevelAxisLabels;                                                // 0x0008 (size: 0x1)

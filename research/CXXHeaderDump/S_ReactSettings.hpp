...
struct FS_ReactSettings
{
    ...
    TArray<UAnimMontage*> Animations_21_084E2E78404169BBDDC195966E7815D4;             // 0x0020 (size: 0x10)
    TArray<USoundCue*> Audio_24_146DA9FE474D0ECA6B72F4B597EFBCA7;                     // 0x0030 (size: 0x10)

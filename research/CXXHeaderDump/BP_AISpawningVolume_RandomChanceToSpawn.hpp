...
class ABP_AISpawningVolume_RandomChanceToSpawn_C : public ABP_MasterObject_C
{
    ...
    class USphereComponent* Radius;                                                   // 0x02B8 (size: 0x8)
    ...
    bool IgnoreNoSpawnArea?;                                                          // 0x02E9 (size: 0x1)
    bool SkipPlayerCheck?;                                                            // 0x02EA (size: 0x1)
    TArray<FS_AISpawner> Spawning AI;                                                 // 0x02F0 (size: 0x10)
    double InitialSpawnDelay;                                                         // 0x0300 (size: 0x8)
    double Spawn Time;                                                                // 0x0308 (size: 0x8)
    double Spawn Time Deviation;                                                      // 0x0310 (size: 0x8)
    double Overlap Size Check;                                                        // 0x0318 (size: 0x8)
    bool Random Rotations;                                                            // 0x0320 (size: 0x1)
    TArray<AActor*> Floors;                                                           // 0x0328 (size: 0x10)
    int32 Spawn Retries;                                                              // 0x0338 (size: 0x4)
    TArray<AActor*> Spawned AI;                                                       // 0x0340 (size: 0x10)
    bool Respawn AI;                                                                  // 0x0350 (size: 0x1)
    ...
    bool Override Starting Behaviour;                                                 // 0x038C (size: 0x1)
    TEnumAsByte<E_StartingAIBehaviours::Type> Override Behaviour;                     // 0x038D (size: 0x1)
    TArray<ABP_MasterWayPoint_C*> Way Points;                                         // 0x0390 (size: 0x10)
    TArray<FS_TriggerResponse> Trigger Activated Responses;                           // 0x03A0 (size: 0x10)
    TArray<FS_TriggerResponse> Trigger Deactivated Responses;                         // 0x03B0 (size: 0x10)
    FName StreamLevelPackageName;                                                     // 0x03C0 (size: 0x8)
    class AActor* AIBase;                                                             // 0x03C8 (size: 0x8)
    TArray<FName> UniqueLoot;                                                         // 0x03D0 (size: 0x10)
    double Chance;                                                                    // 0x03E0 (size: 0x8)
    TArray<FAIOSubjectHandle> SpawnedActorHandles;                                    // 0x03E8 (size: 0x10)
    FTimerHandle TimerHandle_CheckSpawnRadius;                                        // 0x03F8 (size: 0x8)
    double SpawnRadius;                                                               // 0x0400 (size: 0x8)

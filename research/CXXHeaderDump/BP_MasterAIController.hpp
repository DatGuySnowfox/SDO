...
class ABP_MasterAIController_C : public ADetourCrowdAIController
{
    ...
    class UBP_SmartAIComponent_C* Smart AI Component;                                 // 0x03D8 (size: 0x8)
    TArray<FS_ReactionTime> React Time Actors;                                        // 0x03E0 (size: 0x10)
    TArray<AActor*> Sight Actors;                                                     // 0x03F0 (size: 0x10)
    TArray<AActor*> Starting Perceved Actors;                                         // 0x0400 (size: 0x10)
    double Starting Sight Radius;                                                     // 0x0410 (size: 0x8)
    bool Respawn;                                                                     // 0x0418 (size: 0x1)

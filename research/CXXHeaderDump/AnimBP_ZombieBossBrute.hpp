#ifndef UE4SS_SDK_AnimBP_ZombieBossBrute_HPP
#define UE4SS_SDK_AnimBP_ZombieBossBrute_HPP
...
class UAnimBP_ZombieBossBrute_C : public UAnimInstance
{
    ...
    FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose_1;                            // 0x0390 (size: 0x28)
    FAnimNode_LayeredBoneBlend AnimGraphNode_LayeredBoneBlend;                        // 0x03B8 (size: 0xF0)
    FAnimNode_Slot AnimGraphNode_Slot_1;                                              // 0x04A8 (size: 0x48)
    FAnimNode_UseCachedPose AnimGraphNode_UseCachedPose;                              // 0x04F0 (size: 0x28)
    FAnimNode_Slot AnimGraphNode_Slot;                                                // 0x0518 (size: 0x48)
    FAnimNode_SaveCachedPose AnimGraphNode_SaveCachedPose;                            // 0x0560 (size: 0x80)
    FAnimNode_BlendSpacePlayer AnimGraphNode_BlendSpacePlayer;                        // 0x05E0 (size: 0x70)
    FAnimNode_StateResult AnimGraphNode_StateResult;                                  // 0x0650 (size: 0x20)
    FAnimNode_StateMachine AnimGraphNode_StateMachine;                                // 0x0670 (size: 0xC8)
    FVector K2Node_PropertyAccess_1;                                                  // 0x0738 (size: 0x18)
    bool K2Node_PropertyAccess;                                                       // 0x0750 (size: 0x1)
    bool Falling?;                                                                    // 0x0751 (size: 0x1)
    double Speed;                                                                     // 0x0758 (size: 0x8)
    bool Dead;                                                                        // 0x0760 (size: 0x1)
    class ABP_ZombieBoss_C* ZombieRef;                                                // 0x0768 (size: 0x8)

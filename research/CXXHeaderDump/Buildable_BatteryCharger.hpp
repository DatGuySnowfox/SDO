...
class ABuildable_BatteryCharger_C : public ABuildable_MASTER_C
{
    ...
    TArray<FGuid> BatteryUIDs;                                                        // 0x0448 (size: 0x10)
    TArray<FS_ReplicatedContainerInfo> MainJigContainers;                             // 0x0458 (size: 0x10)
    TArray<FGuid> MainUIDs;                                                           // 0x0468 (size: 0x10)
    TArray<FS_InvWeight> Weights;                                                     // 0x0478 (size: 0x10)

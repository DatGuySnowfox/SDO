...
class ABP_AISpawner_Master_C : public ABP_MasterObject_C
{
    ...
    class USphereComponent* SpawnRadius_DebugSphere;                                  // 0x02C0 (size: 0x8)
    class UBoxComponent* SpawningBox;                                                 // 0x02C8 (size: 0x8)
    TArray<FAIOPendingSpawnGroup> SpawnGroupsQueue;                                   // 0x02D0 (size: 0x10)
    TArray<FAIOPendingRespawnGroup> RespawnGroupsQueue;                               // 0x02E0 (size: 0x10)
    TArray<FAIOSubjectHandle> SpawnedActorsHandles;                                   // 0x02F0 (size: 0x10)
    TArray<AActor*> SpawnedActors;                                                    // 0x0300 (size: 0x10)
    FTimerHandle TimerHandle_CheckSpawnRadius;                                        // 0x0310 (size: 0x8)
    FTimerHandle TimeHandle_UpdateRespawningGroups;                                   // 0x0318 (size: 0x8)
    double SpawnRadius;                                                               // 0x0320 (size: 0x8)
    double Box Extent X;                                                              // 0x0328 (size: 0x8)
    double Box Extent Y;                                                              // 0x0330 (size: 0x8)
    double Box Extent Z;                                                              // 0x0338 (size: 0x8)
    int32 SpawnAmount;                                                                // 0x0340 (size: 0x4)
    bool RandomisedSpawnCount;                                                        // 0x0344 (size: 0x1)
    TEnumAsByte<Enum_SpawnType::Type> SpawnType;                                      // 0x0345 (size: 0x1)
    TSubclassOf<class AActor> SpawnedActorClass;                                      // 0x0348 (size: 0x8)
    double InitialSpawnDelay;                                                         // 0x0350 (size: 0x8)
    double SpawningInterval;                                                          // 0x0358 (size: 0x8)
    bool bIsSpawning;                                                                 // 0x0360 (size: 0x1)
    int32 TotalAliveActors;                                                           // 0x0364 (size: 0x4)
    int32 TotalSpawnedActors;                                                         // 0x0368 (size: 0x4)
    EAIOSelectSpawnPointsMethod SelectingSpawnPointsMethod;                           // 0x036C (size: 0x1)
    bool SkipNoSpawnAreaCheck?;                                                       // 0x036D (size: 0x1)
    bool SkipMeshes?;                                                                 // 0x036E (size: 0x1)
    TArray<AActor*> MeshesToSpawnOn;                                                  // 0x0370 (size: 0x10)
    int32 SpawnRetries;                                                               // 0x0380 (size: 0x4)
    float DontSpawnCloseToPlayerRange;                                                // 0x0384 (size: 0x4)
    EAIORespawnMethod RespawnMethod;                                                  // 0x0388 (size: 0x1)
    bool DisplayDebugInfo;                                                            // 0x0389 (size: 0x1)
    TEnumAsByte<ETraceTypeQuery> ProjectionChannel;                                   // 0x038A (size: 0x1)
    double ProjectionRadius;                                                          // 0x0390 (size: 0x8)
    double ProjectionZOffset;                                                         // 0x0398 (size: 0x8)
    TArray<FAIOSpawnPoint> SpawnPoints;                                               // 0x03A0 (size: 0x10)
    bool IsSpawningStopped;                                                           // 0x03B0 (size: 0x1)
    bool WasSpawningInitialized;                                                      // 0x03B1 (size: 0x1)
    int32 InvokersInsideRegion;                                                       // 0x03B4 (size: 0x4)
    int32 SpawningCapacity;                                                           // 0x03B8 (size: 0x4)
    int32 ActorsSpawnedThisFrame;                                                     // 0x03BC (size: 0x4)
    FBP_AISpawner_Master_COnActorSpawned OnActorSpawned;                              // 0x03C0 (size: 0x10)
    void OnActorSpawned(class AActor* SpawnedActor);
    TEnumAsByte<Enum_AIBehviour::Type> Starting Behaviour;                            // 0x03D0 (size: 0x1)
    FVector LocationToGoTo;                                                           // 0x03D8 (size: 0x18)
    class ABP_AIWaypoint_C* Waypoint;                                                 // 0x03F0 (size: 0x8)
    FString ArgumentForQuest;                                                         // 0x03F8 (size: 0x10)
    bool IsAtSettlementSpawn?;                                                        // 0x0408 (size: 0x1)
    FBP_AISpawner_Master_CSettlementSpawn SettlementSpawn;                            // 0x0410 (size: 0x10)
    void SettlementSpawn();
    bool SkipPlayerCheck?;                                                            // 0x0420 (size: 0x1)
    ...
    void GetCVarType(double& Amount);

...
class ABuildableMaster_Display_C : public ABuildable_MASTER_C
{
    ...
    FText ContainerName;                                                              // 0x0478 (size: 0x10)
    class USkeletalMeshComponent* SKMComp;                                            // 0x0488 (size: 0x8)
    class UStaticMeshComponent* SMComp;                                               // 0x0490 (size: 0x8)
    TArray<ABP_AMainLocalAttachment_C*> CurrentAttachments;                           // 0x0498 (size: 0x10)
    bool Displayed;                                                                   // 0x04A8 (size: 0x1)

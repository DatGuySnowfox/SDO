...
class ABP_AISpawnPoint_C : public AActor
{
    ...
    class UArrowComponent* Spawn Point Rotation;                                      // 0x02C8 (size: 0x8)
    class UBoxComponent* Box;                                                         // 0x02D0 (size: 0x8)
    class USceneComponent* Scene;                                                     // 0x02D8 (size: 0x8)
    bool Enable Spawn AI;                                                             // 0x02E0 (size: 0x1)
    TSubclassOf<class ABP_MasterAICharacter_C> Spawn AI;                              // 0x02E8 (size: 0x8)
    int32 Spawn AI Count;                                                             // 0x02F0 (size: 0x4)
    bool Change Default Behaviour;                                                    // 0x02F4 (size: 0x1)
    TEnumAsByte<E_StartingAIBehaviours::Type> Starting Behaviour;                     // 0x02F5 (size: 0x1)
    bool Random Rotation;                                                             // 0x02F6 (size: 0x1)
    double Spawn Time;                                                                // 0x02F8 (size: 0x8)
    double Spawn Time Deviation;                                                      // 0x0300 (size: 0x8)
    bool Respawn AI;                                                                  // 0x0308 (size: 0x1)
    double Respawn Time;                                                              // 0x0310 (size: 0x8)
    double Respawn Time Variation;                                                    // 0x0318 (size: 0x8)
    TArray<AActor*> Spawned AI;                                                       // 0x0320 (size: 0x10)
    bool Show Rotation;                                                               // 0x0330 (size: 0x1)
    bool Use Player Proximity Activation;                                             // 0x0331 (size: 0x1)
    double Player Activation Range;                                                   // 0x0338 (size: 0x8)
    bool Show Deactivation Proximity;                                                 // 0x0340 (size: 0x1)
    bool Show Activation Proximity;                                                   // 0x0341 (size: 0x1)
    bool Use Player Proximity Deactivation;                                           // 0x0342 (size: 0x1)
    double Player Deactivation Range;                                                 // 0x0348 (size: 0x8)
    bool Player In Area;                                                              // 0x0350 (size: 0x1)
    int32 Current AI Spawned;                                                         // 0x0354 (size: 0x4)
    TArray<FS_AIRespawn> AI Respawning Timers;                                        // 0x0358 (size: 0x10)
    double AI Spawn Hight;                                                            // 0x0368 (size: 0x8)
    class AActor* AIBase;                                                             // 0x0370 (size: 0x8)
    TArray<FName> Spawned AI Tags;                                                    // 0x0378 (size: 0x10)

...
struct FLiveLinkCameraFrameData : public FLiveLinkTransformFrameData
{
    ...
    float FilmBackWidth;                                                              // 0x0118 (size: 0x4)
    float FilmBackHeight;                                                             // 0x011C (size: 0x4)
...
struct FLiveLinkCameraStaticData : public FLiveLinkTransformStaticData
{
    ...
    bool bIsDynamicFilmbackSupported;                                                 // 0x0027 (size: 0x1)
...
{
    TArray<FTransform3f> Transforms;                                                  // 0x00A0 (size: 0x10)
...
{
    FLiveLinkLocatorStaticData StaticData;                                            // 0x0008 (size: 0x28)
    FLiveLinkLocatorFrameData FrameData;                                              // 0x0030 (size: 0xB0)

}; // Size: 0xE0

struct FLiveLinkLocatorFrameData : public FLiveLinkBaseFrameData
{
    TArray<FVector> Locators;                                                         // 0x00A0 (size: 0x10)

}; // Size: 0xB0

struct FLiveLinkLocatorStaticData : public FLiveLinkBaseStaticData
{
    TArray<FName> LocatorNames;                                                       // 0x0010 (size: 0x10)
    bool bUnlabelledData;                                                             // 0x0020 (size: 0x1)
...
{
    TMap<FName, FName> BoneNameMap;                                                   // 0x0028 (size: 0x50)
...
class ULiveLinkSubjectSettings : public UObject
{
    ...
    bool bRebroadcastSubject;                                                         // 0x0068 (size: 0x1)
    FName OriginalSourceName;                                                         // 0x006C (size: 0x8)
    FLiveLinkSubjectKey Key;                                                          // 0x0074 (size: 0x18)
    bool bAllowModifyingRebroadcast;                                                  // 0x0098 (size: 0x1)

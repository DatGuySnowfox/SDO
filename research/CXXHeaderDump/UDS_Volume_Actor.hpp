...
class AUDS_Volume_Actor_C : public AActor
{
    ...
    TEnumAsByte<UDS_OcclusionShape::Type> Collision Shape;                            // 0x02A8 (size: 0x1)
    FVector Box Extent;                                                               // 0x02B0 (size: 0x18)
    double Sphere Radius;                                                             // 0x02C8 (size: 0x8)
    float Capsule Half Height;                                                        // 0x02D0 (size: 0x4)
    double Blend Radius;                                                              // 0x02D8 (size: 0x8)
    class UPrimitiveComponent* Collision Component;                                   // 0x02E0 (size: 0x8)
    TEnumAsByte<ECollisionChannel> Collision Object Type;                             // 0x02E8 (size: 0x1)

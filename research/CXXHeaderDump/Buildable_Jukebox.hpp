...
class ABuildable_Jukebox_C : public ABuildable_MASTER_C
{
    ...
    class UMediaSoundComponent* MediaSound;                                           // 0x0448 (size: 0x8)
    class URadioComponent_C* RadioComponent;                                          // 0x0450 (size: 0x8)
    class UMaterialInstanceDynamic* MaterialInstance;                                 // 0x0458 (size: 0x8)

#ifndef UE4SS_SDK_BP_Beanie1Pickup_HPP
#define UE4SS_SDK_BP_Beanie1Pickup_HPP

class ABP_Beanie1Pickup_C : public ABP_StaticMeshPickup_C
{
    ...
    void ExecuteUbergraph_BP_Beanie1Pickup(int32 EntryPoint);
}; // Size: 0x328

...
class ABP_ItemInspector_C : public AActor
{
    ...
    class USpotLightComponent* SpotLight2;                                            // 0x02B8 (size: 0x8)
    class USpotLightComponent* SpotLight1;                                            // 0x02C0 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x02C8 (size: 0x8)
    class USpringArmComponent* SpringArm;                                             // 0x02D0 (size: 0x8)
    class USceneComponent* Root;                                                      // 0x02D8 (size: 0x8)
    class USceneComponent* Main;                                                      // 0x02E0 (size: 0x8)
    class USpotLightComponent* SpotLight;                                             // 0x02E8 (size: 0x8)
    class USceneCaptureComponent2D* SceneCaptureComponent2D;                          // 0x02F0 (size: 0x8)
    double InitialFOV;                                                                // 0x02F8 (size: 0x8)
    class UJSI_Slot_C* ItemToInspect;                                                 // 0x0300 (size: 0x8)
    double MaxZoomInFOV;                                                              // 0x0308 (size: 0x8)
    double MaxZoomOutFOV;                                                             // 0x0310 (size: 0x8)
    class UTextureRenderTarget2D* RenderT;                                            // 0x0318 (size: 0x8)
    TArray<ABP_AMainLocalAttachment_C*> CurrentAttachments;                           // 0x0320 (size: 0x10)
    FRotator NewVar;                                                                  // 0x0330 (size: 0x18)

...
class ABuildable_ConstructionLight_C : public ABuildable_MASTER_C
{
    ...
    class UStaticMeshComponent* Plane1;                                               // 0x0448 (size: 0x8)
    class UStaticMeshComponent* Plane;                                                // 0x0450 (size: 0x8)
    class USpotLightComponent* SpotLight1;                                            // 0x0458 (size: 0x8)
    class USpotLightComponent* SpotLight;                                             // 0x0460 (size: 0x8)
    class UAudioComponent* Audio;                                                     // 0x0468 (size: 0x8)
    bool LightOn;                                                                     // 0x0470 (size: 0x1)

#ifndef UE4SS_SDK_BP_MasterBandit_HPP
#define UE4SS_SDK_BP_MasterBandit_HPP
...
class ABP_MasterBandit_C : public ABP_MasterAICharacter_C
{
    ...
    TArray<UStaticMesh*> HairMeshes;                                                  // 0x08B8 (size: 0x10)
    TArray<UStaticMesh*> BeardMeshes;                                                 // 0x08C8 (size: 0x10)
    TMap<UStaticMesh*, FTransform> BackpackMeshes;                                    // 0x08D8 (size: 0x50)
    bool SkipRandomMaterial?;                                                         // 0x0928 (size: 0x1)
    FVector InteractingActorLoc;                                                      // 0x0930 (size: 0x18)
    class AActor* CurrentActor;                                                       // 0x0948 (size: 0x8)
    bool CanAddMarker?;                                                               // 0x0950 (size: 0x1)
    class UWidgetComponent* Marker;                                                   // 0x0958 (size: 0x8)
    FTimerHandle MarkerTimer;                                                         // 0x0960 (size: 0x8)
    bool Is Burning?;                                                                 // 0x0968 (size: 0x1)
    class UParticleSystemComponent* BurningEffect;                                    // 0x0970 (size: 0x8)
    FTimerHandle BurningTimer;                                                        // 0x0978 (size: 0x8)

...
class ABP_WaterWell_C : public ABP_MasterObject_C
{
    ...
    class UActor_Weather_Status_C* Actor_Weather_Status;                              // 0x02B8 (size: 0x8)
    ...
    FTimerHandle WellTimer;                                                           // 0x02D8 (size: 0x8)
    double CurrentWater;                                                              // 0x02E0 (size: 0x8)
    double MaxWater;                                                                  // 0x02E8 (size: 0x8)
    class AActor* CurrentActor;                                                       // 0x02F0 (size: 0x8)
    class UWidget* InteractWidget;                                                    // 0x02F8 (size: 0x8)

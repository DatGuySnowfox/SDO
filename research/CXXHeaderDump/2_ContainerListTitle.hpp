...
class U2_ContainerListTitle_C : public UUserWidget
{
    ...
    FGuid UID;                                                                        // 0x0360 (size: 0x10)
    class UJigsawItem_DataAsset_C* ItemInfo;                                          // 0x0370 (size: 0x8)
    F2_ContainerListTitle_CClicked Clicked;                                           // 0x0378 (size: 0x10)
    void Clicked();
    class U3_TooltipContainerItemsUI_C* Tooltip;                                      // 0x0388 (size: 0x8)

...
class ABuildable_WoodenDoor2_C : public ABuildable_MASTER_C
{
    ...
    float Timeline_OpenDoor_Alpha_338471374D1910D3506CC1B51ECDD906;                   // 0x0458 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_OpenDoor__Direction_338471374D1910D3506CC1B51ECDD906; // 0x045C (size: 0x1)

...
struct FGroomDataflowSettings
{
    ...
    FString DataflowTerminal;                                                         // 0x0008 (size: 0x10)
    TArray<USkeletalMesh*> SkeletalMeshes;                                            // 0x0018 (size: 0x10)
    TArray<int32> MeshLODs;                                                           // 0x0028 (size: 0x10)

}; // Size: 0x48

struct FGroomHairGroupPreview
{
    int32 GroupIndex;                                                                 // 0x0000 (size: 0x4)
    FName GroupName;                                                                  // 0x0004 (size: 0x8)
    int32 GroupID;                                                                    // 0x000C (size: 0x4)
    int32 CurveCount;                                                                 // 0x0010 (size: 0x4)
    int32 GuideCount;                                                                 // 0x0014 (size: 0x4)
    uint32 Attributes;                                                                // 0x0018 (size: 0x4)
    uint32 AttributeFlags;                                                            // 0x001C (size: 0x4)
    uint32 Flags;                                                                     // 0x0020 (size: 0x4)
    FHairGroupsInterpolation InterpolationSettings;                                   // 0x0024 (size: 0x28)
...
struct FHairGroupCardsTextures
{
    ...
    TArray<UTexture2D*> Textures;                                                     // 0x0008 (size: 0x10)
...
struct FHairGroupInfo
{
    ...
    int32 NumCurves;                                                                  // 0x0010 (size: 0x4)
    int32 NumGuides;                                                                  // 0x0014 (size: 0x4)
    int32 NumCurveVertices;                                                           // 0x0018 (size: 0x4)
    int32 NumGuideVertices;                                                           // 0x001C (size: 0x4)
    float MaxCurveLength;                                                             // 0x0020 (size: 0x4)
...
{
    float AutoLODBias;                                                                // 0x0000 (size: 0x4)
    TArray<FHairLODSettings> LODs;                                                    // 0x0008 (size: 0x10)
...
{
    bool bEnableDeformation;                                                          // 0x0000 (size: 0x1)
    bool EnableSimulation;                                                            // 0x0001 (size: 0x1)
    EGroomNiagaraSolvers NiagaraSolver;                                               // 0x0002 (size: 0x1)
    TSoftObjectPtr<class UNiagaraSystem> CustomSystem;                                // 0x0008 (size: 0x28)
...
{
    class UGroomBindingAsset* BindingAsset;                                           // 0x00C0 (size: 0x8)

}; // Size: 0xC8

class UGroomAsset : public UObject
{
    EGroomLODMode LODMode;                                                            // 0x0050 (size: 0x1)
    float AutoLODBias;                                                                // 0x0054 (size: 0x4)
    FGroomDataflowSettings DataflowSettings;                                          // 0x0058 (size: 0x48)
    TArray<FHairGroupInfoWithVisibility> HairGroupsInfo;                              // 0x00A0 (size: 0x10)
    TArray<FHairGroupsRendering> HairGroupsRendering;                                 // 0x00B0 (size: 0x10)
    TArray<FHairGroupsPhysics> HairGroupsPhysics;                                     // 0x00C0 (size: 0x10)
    TArray<FHairGroupsInterpolation> HairGroupsInterpolation;                         // 0x00D0 (size: 0x10)
    TArray<FHairGroupsLOD> HairGroupsLOD;                                             // 0x00E0 (size: 0x10)
    TArray<FHairGroupsCardsSourceDescription> HairGroupsCards;                        // 0x00F0 (size: 0x10)
    TArray<FHairGroupsMeshesSourceDescription> HairGroupsMeshes;                      // 0x0100 (size: 0x10)
    TArray<FHairGroupsMaterial> HairGroupsMaterials;                                  // 0x0110 (size: 0x10)
    bool EnableGlobalInterpolation;                                                   // 0x0120 (size: 0x1)
    bool EnableSimulationCache;                                                       // 0x0121 (size: 0x1)
    EGroomInterpolationType HairInterpolationType;                                    // 0x0122 (size: 0x1)
    class USkeletalMesh* RiggedSkeletalMesh;                                          // 0x0128 (size: 0x8)
    TArray<int32> DeformedGroupSections;                                              // 0x0130 (size: 0x10)
    FPerPlatformInt MinLOD;                                                           // 0x0140 (size: 0x4)
    FPerPlatformBool DisableBelowMinLodStripping;                                     // 0x0144 (size: 0x1)
    TArray<float> EffectiveLODBias;                                                   // 0x0148 (size: 0x10)
    TArray<UAssetUserData*> AssetUserData;                                            // 0x0178 (size: 0x10)
...
class UGroomBindingAsset : public UObject
{
    ...
    int32 SourceMeshRequestedLOD;                                                     // 0x0048 (size: 0x4)
    int32 SourceMeshUsedLOD;                                                          // 0x004C (size: 0x4)
    class USkeletalMesh* TargetSkeletalMesh;                                          // 0x0050 (size: 0x8)
    int32 TargetMeshRequestedMinLOD;                                                  // 0x0058 (size: 0x4)
    int32 TargetMeshUsedMinLOD;                                                       // 0x005C (size: 0x4)
    class UGeometryCache* SourceGeometryCache;                                        // 0x0060 (size: 0x8)
    class UGeometryCache* TargetGeometryCache;                                        // 0x0068 (size: 0x8)
    int32 NumInterpolationPoints;                                                     // 0x0070 (size: 0x4)
    int32 MatchingSection;                                                            // 0x0074 (size: 0x4)
    FName TargetBindingAttribute;                                                     // 0x0078 (size: 0x8)
    TArray<FGoomBindingGroupInfo> GroupInfos;                                         // 0x0080 (size: 0x10)
    ...
    void SetTargetBindingAttribute(FName InAttributeName);
    ...
    int32 GetTargetMeshUsedMinLOD();
    int32 GetTargetMeshRequestedMinLOD();
    class UGeometryCache* GetTargetGeometryCache();
    FName GetTargetBindingAttribute();
    class USkeletalMesh* GetSourceSkeletalMesh();
    int32 GetSourceMeshUsedLOD();
    int32 GetSourceMeshRequestedLOD();
    ...
    void Build(FBuildCompletionDelegate CompletionDelegate);
}; // Size: 0xF0

class UGroomBindingAssetList : public UObject
{
    TArray<UGroomBindingAsset*> Bindings;                                             // 0x0028 (size: 0x10)
...
{
    TArray<UAssetUserData*> AssetUserData;                                            // 0x0048 (size: 0x10)
    FGroomCacheInfo GroomCacheInfo;                                                   // 0x0058 (size: 0x28)
...
{
    class UGroomAsset* GroomAsset;                                                    // 0x0578 (size: 0x8)
    class UGroomCache* GroomCache;                                                    // 0x0580 (size: 0x8)
    TArray<UNiagaraComponent*> NiagaraComponents;                                     // 0x0588 (size: 0x10)
    class USkeletalMesh* SourceSkeletalMesh;                                          // 0x0598 (size: 0x8)
    class UGroomBindingAsset* BindingAsset;                                           // 0x05A0 (size: 0x8)
    class UPhysicsAsset* PhysicsAsset;                                                // 0x05A8 (size: 0x8)
    FHairSimulationSettings SimulationSettings;                                       // 0x05C0 (size: 0x90)
    class UMeshDeformer* MeshDeformer;                                                // 0x0650 (size: 0x8)
    class UMeshDeformerInstance* MeshDeformerInstance;                                // 0x0658 (size: 0x8)
    class UMeshDeformerInstanceSettings* MeshDeformerInstanceSettings;                // 0x0660 (size: 0x8)
    class UMaterialInterface* Strands_DebugMaterial;                                  // 0x0668 (size: 0x8)
    class UMaterialInterface* Strands_DefaultMaterial;                                // 0x0670 (size: 0x8)
    class UMaterialInterface* Cards_DefaultMaterial;                                  // 0x0678 (size: 0x8)
    class UMaterialInterface* Meshes_DefaultMaterial;                                 // 0x0680 (size: 0x8)
    class UNiagaraSystem* AngularSpringsSystem;                                       // 0x0688 (size: 0x8)
    class UNiagaraSystem* CosseratRodsSystem;                                         // 0x0690 (size: 0x8)
    FString AttachmentName;                                                           // 0x0698 (size: 0x10)
    TArray<FHairGroupDesc> GroomGroupsDesc;                                           // 0x0730 (size: 0x10)
    bool bUseCards;                                                                   // 0x0740 (size: 0x1)
    bool bRunning;                                                                    // 0x0741 (size: 0x1)
    bool bLooping;                                                                    // 0x0742 (size: 0x1)
    bool bManualTick;                                                                 // 0x0743 (size: 0x1)
    float ElapsedTime;                                                                // 0x0744 (size: 0x4)
...
class UGroomCreateBindingOptions : public UObject
{
    ...
    FName TargetBindingAttribute;                                                     // 0x0060 (size: 0x8)
...
class UGroomCreateStrandsTexturesOptions : public UObject
{
    ...
    TArray<UTexture2D*> GeneratedTextures;                                            // 0x0078 (size: 0x10)

}; // Size: 0x88

class UGroomHairGroupsMapping : public UObject
{
    TArray<FName> OldGroupNames;                                                      // 0x0028 (size: 0x10)
    TArray<FName> NewGroupNames;                                                      // 0x0038 (size: 0x10)
    TArray<int32> OldToNewGroupIndexMapping;                                          // 0x0048 (size: 0x10)
    TArray<int32> NewToOldGroupIndexMapping;                                          // 0x0058 (size: 0x10)
...
{
    FMovieSceneGroomCacheParams Params;                                               // 0x0108 (size: 0x20)

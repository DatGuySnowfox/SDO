#ifndef UE4SS_SDK_BTTask_MoveToSpecificLoc_HPP
#define UE4SS_SDK_BTTask_MoveToSpecificLoc_HPP

class UBTTask_MoveToSpecificLoc_C : public UBTTask_BlueprintBase
{
    ...
    void ExecuteUbergraph_BTTask_MoveToSpecificLoc(int32 EntryPoint);
}; // Size: 0xD8

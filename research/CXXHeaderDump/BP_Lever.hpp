...
class ABP_Lever_C : public ABP_MasterObject_C
{
    ...
    class UStaticMeshComponent* Lever;                                                // 0x02C0 (size: 0x8)
    class UStaticMeshComponent* base;                                                 // 0x02C8 (size: 0x8)
    float LeverMovement_Lever_09701F514E1A38F04DC8CAA9C9C1EC14;                       // 0x02D0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> LeverMovement__Direction_09701F514E1A38F04DC8CAA9C9C1EC14; // 0x02D4 (size: 0x1)
    class UTimelineComponent* LeverMovement;                                          // 0x02D8 (size: 0x8)
    TArray<AActor*> Actors;                                                           // 0x02E0 (size: 0x10)
    bool PoweredOn;                                                                   // 0x02F0 (size: 0x1)
    bool LeverToggled?;                                                               // 0x02F1 (size: 0x1)

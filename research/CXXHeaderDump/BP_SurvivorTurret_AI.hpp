...
class ABP_SurvivorTurret_AI_C : public ABP_MasterTurret_C
{
    ...
    float Turret_Rotate_Animation_Rotate_Alpha_B8049F6848C826A27A9CD39B7C60D803;      // 0x0340 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Turret_Rotate_Animation__Direction_B8049F6848C826A27A9CD39B7C60D803; // 0x0344 (size: 0x1)
    class UTimelineComponent* Turret Rotate Animation;                                // 0x0348 (size: 0x8)

...
class ABP_Infestation_C : public ABP_MasterObject_C
{
    ...
    class UNiagaraComponent* NS_InfestationDust;                                      // 0x02B8 (size: 0x8)
    class UPostProcessComponent* PostProcess;                                         // 0x02C0 (size: 0x8)
    class USphereComponent* Sphere;                                                   // 0x02C8 (size: 0x8)
    class UBP_JigComponent_C* BP_JigMultiplayer;                                      // 0x02D0 (size: 0x8)
    class UDamageComponent_C* DamageComponent;                                        // 0x02D8 (size: 0x8)
    class UStaticMeshComponent* ARMOR;                                                // 0x02E0 (size: 0x8)
    class USceneComponent* ExplosionLoc;                                              // 0x02E8 (size: 0x8)
    class UAIOSubjectComponent* AIOSubject;                                           // 0x02F0 (size: 0x8)
    class UParticleSystemComponent* Flies;                                            // 0x02F8 (size: 0x8)
    class UPointLightComponent* PurpleLight;                                          // 0x0300 (size: 0x8)
    class UPointLightComponent* RedLight;                                             // 0x0308 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x0310 (size: 0x8)
    class UStaticMesh* NormalMesh;                                                    // 0x0318 (size: 0x8)
    class UStaticMesh* DestroyedMesh;                                                 // 0x0320 (size: 0x8)
    bool PrimaryInfestation?;                                                         // 0x0328 (size: 0x1)
    class ABP_Marker_C* MarkerRef;                                                    // 0x0330 (size: 0x8)
    bool IsDestroyed?;                                                                // 0x0338 (size: 0x1)
    class AActor* CurrentActor;                                                       // 0x0340 (size: 0x8)
    FVector InteractingActorLoc;                                                      // 0x0348 (size: 0x18)
    FText Name;                                                                       // 0x0360 (size: 0x10)
    bool ShowMarker?;                                                                 // 0x0370 (size: 0x1)
    float PostProcessRadius;                                                          // 0x0374 (size: 0x4)
    TEnumAsByte<Enum_ContainerLootTables::Type> LootTable;                            // 0x0378 (size: 0x1)
    TArray<FName> UniqueLootSets;                                                     // 0x0380 (size: 0x10)
    TArray<FTransform> AISpawningTransforms;                                          // 0x0390 (size: 0x10)
    double SpawnZOffset;                                                              // 0x03A0 (size: 0x8)
    FStruct_WaveInfo WavesOfEnemies;                                                  // 0x03A8 (size: 0x10)
    int32 CurrentWave;                                                                // 0x03B8 (size: 0x4)
    TArray<ABP_Infestation_C*> SecondaryInfestations;                                 // 0x03C0 (size: 0x10)
    FBP_Infestation_CInfestationDestroyed InfestationDestroyed;                       // 0x03D0 (size: 0x10)
    void InfestationDestroyed(class AActor* Causer, bool CalledFromGameLoad?);
    bool CanDamagePrimary?;                                                           // 0x03E0 (size: 0x1)
    TArray<FTransform> DecorationTransforms;                                          // 0x03E8 (size: 0x10)
    TArray<UStaticMesh*> DecorationMeshes;                                            // 0x03F8 (size: 0x10)
    TArray<ABP_InfestationSpline_C*> Splines;                                         // 0x0408 (size: 0x10)
    bool ForceLock?;                                                                  // 0x0418 (size: 0x1)
    bool RandomInfestation?;                                                          // 0x0419 (size: 0x1)
    TArray<FS_ReplicatedContainerInfo> MainJigContainers;                             // 0x0420 (size: 0x10)
    TArray<FGuid> MainUIDs;                                                           // 0x0430 (size: 0x10)
    TArray<FS_InvWeight> Weights;                                                     // 0x0440 (size: 0x10)

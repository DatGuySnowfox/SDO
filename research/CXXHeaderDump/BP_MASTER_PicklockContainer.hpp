...
class ABP_MASTER_PicklockContainer_C : public ABP_LockPickObject_C
{
    ...
    class AActor* CurrentActor;                                                       // 0x0308 (size: 0x8)
    TEnumAsByte<Enum_ContainerLootTables::Type> LootTable;                            // 0x0310 (size: 0x1)
    FText ContainerName;                                                              // 0x0318 (size: 0x10)
    FBP_MASTER_PicklockContainer_COpenedObject OpenedObject;                          // 0x0328 (size: 0x10)
    void OpenedObject();
    FTimerHandle OutlineTimer;                                                        // 0x0338 (size: 0x8)
    bool PlayerClose?;                                                                // 0x0340 (size: 0x1)
    bool ContainerLooted;                                                             // 0x0341 (size: 0x1)
    double DurationToHold;                                                            // 0x0348 (size: 0x8)
    double ChanceToBreakPicklock;                                                     // 0x0350 (size: 0x8)
    double DefaultChanceToBreakPicklock;                                              // 0x0358 (size: 0x8)
    double RefillTimer;                                                               // 0x0360 (size: 0x8)
    class UWidgetComponent* W_MagnifierUI;                                            // 0x0368 (size: 0x8)

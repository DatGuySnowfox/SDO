...
class ABuildable_WaterWell_C : public ABuildable_MASTER_C
{
    ...
    class UActor_Weather_Status_C* Actor_Weather_Status;                              // 0x0448 (size: 0x8)
    class USceneComponent* TraceLocation;                                             // 0x0450 (size: 0x8)
    FTimerHandle WellTimer;                                                           // 0x0458 (size: 0x8)
    double CurrentWater;                                                              // 0x0460 (size: 0x8)
    double MaxWater;                                                                  // 0x0468 (size: 0x8)
    class AUltra_Dynamic_Weather_C* UDW;                                              // 0x0470 (size: 0x8)
    bool OnLandscape?;                                                                // 0x0478 (size: 0x1)
    class UWidget* InteractWidget;                                                    // 0x0480 (size: 0x8)

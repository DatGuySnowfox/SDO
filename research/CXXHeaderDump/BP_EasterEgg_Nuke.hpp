#ifndef UE4SS_SDK_BP_EasterEgg_Nuke_HPP
#define UE4SS_SDK_BP_EasterEgg_Nuke_HPP

class ABP_EasterEgg_Nuke_C : public ABP_MasterObject_C
{
    ...
    class USphereComponent* ExplosionSphere;                                          // 0x02D0 (size: 0x8)

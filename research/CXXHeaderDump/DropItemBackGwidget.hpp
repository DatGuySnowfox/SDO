...
class UDropItemBackGwidget_C : public UUserWidget
{
    ...
    class UBackgroundBlur* BackgroundBlur_32;                                         // 0x0348 (size: 0x8)
    FDropItemBackGwidget_CItemDropRequest ItemDropRequest;                            // 0x0350 (size: 0x10)
    void ItemDropRequest(class UJSI_Slot_C* ItemRef, int32 Count, class UJSIContainer_C* Container);
    class UDropItemAmountSelector_C* AmountSelector;                                  // 0x0360 (size: 0x8)
    double BlurValue;                                                                 // 0x0368 (size: 0x8)

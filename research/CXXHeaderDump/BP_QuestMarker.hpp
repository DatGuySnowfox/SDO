...
class ABP_QuestMarker_C : public ABP_MasterQuestObject_C
{
    ...
    class UTexture2D* Marker Texture;                                                 // 0x02D8 (size: 0x8)
    FLinearColor Color;                                                               // 0x02E0 (size: 0x10)
    FString Text;                                                                     // 0x02F0 (size: 0x10)
    class ABP_CompassMarker_C* CompassMarker;                                         // 0x0300 (size: 0x8)
    bool Underground?;                                                                // 0x0308 (size: 0x1)
    class UW_QuestMarker_C* Marker;                                                   // 0x0310 (size: 0x8)

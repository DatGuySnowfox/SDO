...
class ABP_ContainerDoors_C : public ABP_MasterDoor_C
{
    ...
    float Timeline_0_Alpha_2457EB1142ACAAA5D0C6C58CFC935FFE;                          // 0x02C0 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> Timeline_0__Direction_2457EB1142ACAAA5D0C6C58CFC935FFE; // 0x02C4 (size: 0x1)

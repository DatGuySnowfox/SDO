...
{
    TSoftObjectPtr<class UVariantSet> VariantSet;                                     // 0x0000 (size: 0x28)
    TSoftObjectPtr<class UVariant> Variant;                                           // 0x0028 (size: 0x28)
...
class ALevelVariantSetsActor : public AActor
{
    ...
    TMap<UClass*, ULevelVariantSetsFunctionDirector*> DirectorInstances;              // 0x02C8 (size: 0x50)
...
class ULevelVariantSets : public UObject
{
    ...
    TArray<UVariantSet*> VariantSets;                                                 // 0x0030 (size: 0x10)
...
class UPropertyValue : public UObject
{
    ...
    TMap<FString, FString> PropertySetterParameterDefaults;                           // 0x00D0 (size: 0x50)
...
class UVariant : public UObject
{
    ...
    TArray<UVariantObjectBinding*> ObjectBindings;                                    // 0x0058 (size: 0x10)
    ...
    TArray<UVariant*> GetDependents(class ULevelVariantSets* LevelVariantSets, bool bOnlyEnabledDependencies);
...
class UVariantObjectBinding : public UObject
{
    ...
    TArray<UPropertyValue*> CapturedProperties;                                       // 0x0070 (size: 0x10)
...
class UVariantSet : public UObject
{
    ...
    TArray<UVariant*> Variants;                                                       // 0x0050 (size: 0x10)

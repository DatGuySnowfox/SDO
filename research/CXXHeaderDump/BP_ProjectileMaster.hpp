...
class ABP_ProjectileMaster_C : public AActor
{
    ...
    class UProjectileMovementComponent* ProjectileMovement;                           // 0x02B0 (size: 0x8)
    class ABP_FirearmPickup_C* WeaponOwner;                                           // 0x02B8 (size: 0x8)
    double MinDmg;                                                                    // 0x02C0 (size: 0x8)
    double MaxDmg;                                                                    // 0x02C8 (size: 0x8)

...
class UVehicleHealthComponent_C : public UBaseComponent_C
{
    ...
    double CurrentHealth;                                                             // 0x00D8 (size: 0x8)
    double MaxHealth;                                                                 // 0x00E0 (size: 0x8)
    FVehicleHealthComponent_CFuelUpdate FuelUpdate;                                   // 0x00E8 (size: 0x10)
    void FuelUpdate(double FuelInput);
    class ABP_VehicleMaster_C* Vehicle;                                               // 0x00F8 (size: 0x8)

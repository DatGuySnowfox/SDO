...
class ABP_EasterEgg_GlowingEyes_C : public ABP_MasterObject_C
{
    ...
    class UStaticMeshComponent* SM_Prop_DeadBody_Hanging_Male_02;                     // 0x02C8 (size: 0x8)
    class UStaticMeshComponent* StaticMesh;                                           // 0x02D0 (size: 0x8)
    float HoverTL_Hover_E47516984B76AFD9C32EA091E99F7074;                             // 0x02D8 (size: 0x4)
    TEnumAsByte<ETimelineDirection::Type> HoverTL__Direction_E47516984B76AFD9C32EA091E99F7074; // 0x02DC (size: 0x1)
    class UTimelineComponent* HoverTL;                                                // 0x02E0 (size: 0x8)
    bool IsNight?;                                                                    // 0x02E8 (size: 0x1)

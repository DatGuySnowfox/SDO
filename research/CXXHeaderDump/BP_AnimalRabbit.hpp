...
class ABP_AnimalRabbit_C : public ABP_Animal_C
{
    ...
    double Health;                                                                    // 0x06C0 (size: 0x8)
    bool IsDead?;                                                                     // 0x06C8 (size: 0x1)
    class AActor* CurrentActor;                                                       // 0x06D0 (size: 0x8)
    FText AIName;                                                                     // 0x06D8 (size: 0x18)
    FVector InteractingActorLoc;                                                      // 0x06F0 (size: 0x18)
    bool XpPopUpEnabled?;                                                             // 0x0708 (size: 0x1)
    bool CanAddMarker?;                                                               // 0x0709 (size: 0x1)
    class UWidgetComponent* Marker;                                                   // 0x0710 (size: 0x8)
    FTimerHandle MarkerTimer;                                                         // 0x0718 (size: 0x8)
    bool Is Burning?;                                                                 // 0x0720 (size: 0x1)
    class UParticleSystemComponent* BurningEffect;                                    // 0x0728 (size: 0x8)
    FTimerHandle BurningTimer;                                                        // 0x0730 (size: 0x8)
    bool Looted;                                                                      // 0x0738 (size: 0x1)

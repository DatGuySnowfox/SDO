...
struct FLandscapeLayer
{
    ...
    TMap<ULandscapeLayerInfoObject*, bool> WeightmapLayerAllocationBlend;             // 0x0040 (size: 0x50)
...
class ALandscapeBlueprintBrushBase : public AActor
{
    ...
    bool bUsePowerOfTwoRenderTarget;                                                  // 0x02C0 (size: 0x1)
...
class ALandscapeProxy : public APartitionActor
{
    ...
    float LOD0ScreenSize;                                                             // 0x0300 (size: 0x4)
    uint32 LODGroupKey;                                                               // 0x0304 (size: 0x4)
    float LOD0DistributionSetting;                                                    // 0x0308 (size: 0x4)
    float LODDistributionSetting;                                                     // 0x030C (size: 0x4)
    FPerQualityLevelFloat ScalableLOD0ScreenSize;                                     // 0x0310 (size: 0x68)
    FPerQualityLevelFloat ScalableLOD0DistributionSetting;                            // 0x0378 (size: 0x68)
    FPerQualityLevelFloat ScalableLODDistributionSetting;                             // 0x03E0 (size: 0x68)
    bool bUseScalableLODSettings;                                                     // 0x0448 (size: 0x1)
    float LODBlendRange;                                                              // 0x044C (size: 0x4)
    int32 StaticLightingLOD;                                                          // 0x0450 (size: 0x4)
    class UPhysicalMaterial* DefaultPhysMaterial;                                     // 0x0458 (size: 0x8)
    float StreamingDistanceMultiplier;                                                // 0x0460 (size: 0x4)
    class UMaterialInterface* LandscapeMaterial;                                      // 0x0468 (size: 0x8)
    class UMaterialInterface* LandscapeHoleMaterial;                                  // 0x0470 (size: 0x8)
    TArray<URuntimeVirtualTexture*> RuntimeVirtualTextures;                           // 0x0478 (size: 0x10)
    bool bSetCreateRuntimeVirtualTextureVolumes;                                      // 0x0488 (size: 0x1)
    bool bVirtualTextureRenderWithQuad;                                               // 0x0489 (size: 0x1)
    bool bVirtualTextureRenderWithQuadHQ;                                             // 0x048A (size: 0x1)
    int32 VirtualTextureNumLods;                                                      // 0x048C (size: 0x4)
    int32 VirtualTextureLodBias;                                                      // 0x0490 (size: 0x4)
    ERuntimeVirtualTextureMainPassType VirtualTextureRenderPassType;                  // 0x0494 (size: 0x1)
    float NegativeZBoundsExtension;                                                   // 0x0498 (size: 0x4)
    float PositiveZBoundsExtension;                                                   // 0x049C (size: 0x4)
    TArray<ULandscapeComponent*> LandscapeComponents;                                 // 0x04A0 (size: 0x10)
    TArray<ULandscapeHeightfieldCollisionComponent*> CollisionComponents;             // 0x04B0 (size: 0x10)
    TArray<UHierarchicalInstancedStaticMeshComponent*> FoliageComponents;             // 0x04C0 (size: 0x10)
    class ULandscapeNaniteComponent* NaniteComponent;                                 // 0x04D0 (size: 0x8)
    TArray<ULandscapeNaniteComponent*> NaniteComponents;                              // 0x04D8 (size: 0x10)
    float GrassTypesMaxDiscardDistance;                                               // 0x054C (size: 0x4)
    float StaticLightingResolution;                                                   // 0x0560 (size: 0x4)
    uint8 CastShadow;                                                                 // 0x0564 (size: 0x1)
    uint8 bCastDynamicShadow;                                                         // 0x0564 (size: 0x1)
    uint8 bCastStaticShadow;                                                          // 0x0564 (size: 0x1)
    EShadowCacheInvalidationBehavior ShadowCacheInvalidationBehavior;                 // 0x0565 (size: 0x1)
    uint8 bCastContactShadow;                                                         // 0x0566 (size: 0x1)
    uint8 bCastFarShadow;                                                             // 0x0568 (size: 0x1)
    uint8 bCastHiddenShadow;                                                          // 0x056C (size: 0x1)
    uint8 bCastShadowAsTwoSided;                                                      // 0x0570 (size: 0x1)
    uint8 bAffectDistanceFieldLighting;                                               // 0x0574 (size: 0x1)
    uint8 bAffectDynamicIndirectLighting;                                             // 0x0574 (size: 0x1)
    uint8 bAffectIndirectLightingWhileHidden;                                         // 0x0574 (size: 0x1)
    FLightingChannels LightingChannels;                                               // 0x0575 (size: 0x1)
    uint8 bUseMaterialPositionOffsetInStaticLighting;                                 // 0x0578 (size: 0x1)
    float NonNaniteVirtualShadowMapConstantDepthBias;                                 // 0x057C (size: 0x4)
    float NonNaniteVirtualShadowMapInvalidationHeightErrorThreshold;                  // 0x0580 (size: 0x4)
    float NonNaniteVirtualShadowMapInvalidationScreenSizeLimit;                       // 0x0584 (size: 0x4)
    uint8 bHoldout;                                                                   // 0x0588 (size: 0x1)
    uint8 bRenderCustomDepth;                                                         // 0x058C (size: 0x1)
    ERendererStencilMask CustomDepthStencilWriteMask;                                 // 0x0590 (size: 0x1)
    int32 CustomDepthStencilValue;                                                    // 0x0594 (size: 0x4)
    float LDMaxDrawDistance;                                                          // 0x0598 (size: 0x4)
    FLightmassPrimitiveSettings LightmassSettings;                                    // 0x059C (size: 0x18)
    int32 CollisionMipLevel;                                                          // 0x05B4 (size: 0x4)
    int32 SimpleCollisionMipLevel;                                                    // 0x05B8 (size: 0x4)
    FBodyInstance BodyInstance;                                                       // 0x05C0 (size: 0x180)
    uint8 bGenerateOverlapEvents;                                                     // 0x0740 (size: 0x1)
    uint8 bBakeMaterialPositionOffsetIntoCollision;                                   // 0x0740 (size: 0x1)
    class ULandscapeSubsystem* RegisteredToSubsystem;                                 // 0x0748 (size: 0x8)
    int32 ComponentSizeQuads;                                                         // 0x0750 (size: 0x4)
    int32 SubsectionSizeQuads;                                                        // 0x0754 (size: 0x4)
    int32 NumSubsections;                                                             // 0x0758 (size: 0x4)
    uint8 bUsedForNavigation;                                                         // 0x075C (size: 0x1)
    uint8 bFillCollisionUnderLandscapeForNavmesh;                                     // 0x075C (size: 0x1)
    ENavDataGatheringMode NavigationGeometryGatheringMode;                            // 0x0760 (size: 0x1)
    bool bUseDynamicMaterialInstance;                                                 // 0x0761 (size: 0x1)
    bool bUseLandscapeForCullingInvisibleHLODVertices;                                // 0x0762 (size: 0x1)
    bool bHasLayersContent;                                                           // 0x0763 (size: 0x1)
    bool bUseCompressedHeightmapStorage;                                              // 0x0766 (size: 0x1)
    bool bStripPhysicsWhenCookedClient;                                               // 0x0767 (size: 0x1)
    bool bStripPhysicsWhenCookedServer;                                               // 0x0768 (size: 0x1)
    bool bStripGrassWhenCookedClient;                                                 // 0x0769 (size: 0x1)
    bool bStripGrassWhenCookedServer;                                                 // 0x076A (size: 0x1)
    TMap<FName, FLandscapeTargetLayerSettings> TargetLayers;                          // 0x0770 (size: 0x50)
...
{
    TArray<UStaticMeshComponent*> StaticMeshComponents;                               // 0x02A8 (size: 0x10)

}; // Size: 0x2B8

class ALandscapeStreamingProxy : public ALandscapeProxy
{
    TSoftObjectPtr<class ALandscape> LandscapeActorRef;                               // 0x07C0 (size: 0x28)
    TSet<FName> OverriddenSharedProperties;                                           // 0x07E8 (size: 0x50)
...
{
    float VirtualTextureMainPassMaxDrawDistance;                                      // 0x0610 (size: 0x4)
...
class ULandscapeComponent : public UPrimitiveComponent
{
    ...
    TArray<UMaterialInstanceConstant*> MaterialInstances;                             // 0x0548 (size: 0x10)
    TArray<UMaterialInstanceDynamic*> MaterialInstancesDynamic;                       // 0x0558 (size: 0x10)
    ...
    TArray<UTexture2D*> WeightmapTextures;                                            // 0x0640 (size: 0x10)
    TArray<FLandscapePerLODMaterialOverride> PerLODOverrideMaterials;                 // 0x0650 (size: 0x10)
    TArray<ULandscapeGrassType*> GrassTypes;                                          // 0x0660 (size: 0x10)
    ...
    class ULandscapeHeightmapTextureEdgeFixup* RegisteredEdgeFixup;                   // 0x06C0 (size: 0x8)
    TArray<UMaterialInterface*> MobileMaterialInterfaces;                             // 0x06D0 (size: 0x10)
    TArray<UTexture2D*> MobileWeightmapTextures;                                      // 0x06E0 (size: 0x10)
    class UTexture2DArray* MobileWeightmapTextureArray;                               // 0x06F0 (size: 0x8)
    TArray<FWeightmapLayerAllocationInfo> MobileWeightmapLayerAllocations;            // 0x06F8 (size: 0x10)
...
{
    TArray<ULandscapeScratchRenderTarget*> ScratchRenderTargets;                      // 0x0030 (size: 0x10)
...
{
    TArray<ULandscapeLayerInfoObject*> ComponentLayerInfos;                           // 0x0520 (size: 0x10)
    ...
    TArray<UPhysicalMaterial*> CookedPhysicalMaterials;                               // 0x05B8 (size: 0x10)
...
class ULandscapeInfo : public UObject
{
    ...
    TArray<TWeakObjectPtr<class ALandscapeStreamingProxy>> StreamingProxies;          // 0x00F0 (size: 0x10)
...
{
    TArray<FLandscapeMaterialTextureStreamingInfo> TextureStreamingInfo;              // 0x02F8 (size: 0x10)
    uint8 bIsLayerThumbnail;                                                          // 0x0308 (size: 0x1)
    uint8 bDisableTessellation;                                                       // 0x0308 (size: 0x1)
    uint8 bMobile;                                                                    // 0x0308 (size: 0x1)
    uint8 bEditorToolUsage;                                                           // 0x0308 (size: 0x1)
...
{
    FGuid LandscapeGuid;                                                              // 0x0610 (size: 0x10)
    TArray<FIntPoint> ProxyComponentBases;                                            // 0x0620 (size: 0x10)
    TArray<FVector> ProxyComponentCentersObjectSpace;                                 // 0x0630 (size: 0x10)
    FVector ComponentXVectorObjectSpace;                                              // 0x0640 (size: 0x18)
    FVector ComponentYVectorObjectSpace;                                              // 0x0658 (size: 0x18)
    int32 ComponentResolution;                                                        // 0x0670 (size: 0x4)
    int8 ProxyLOD;                                                                    // 0x0674 (size: 0x1)
    uint32 LODGroupKey;                                                               // 0x0678 (size: 0x4)

}; // Size: 0x680

class ULandscapeNaniteComponent : public UStaticMeshComponent
{
    FGuid ProxyContentId;                                                             // 0x0610 (size: 0x10)
    bool bEnabled;                                                                    // 0x0620 (size: 0x1)
    TArray<ULandscapeComponent*> SourceLandscapeComponents;                           // 0x0628 (size: 0x10)
...
class ULandscapeSettings : public UDeveloperSettings
{
    ...
    TSoftObjectPtr<class UMaterialInterface> DefaultLandscapeMaterial;                // 0x0058 (size: 0x28)
    TSoftObjectPtr<class ULandscapeLayerInfoObject> DefaultLayerInfoObject;           // 0x0080 (size: 0x28)
    float BrushSizeUIMax;                                                             // 0x00A8 (size: 0x4)
    float BrushSizeClampMax;                                                          // 0x00AC (size: 0x4)
    int32 HLODMaxTextureSize;                                                         // 0x00B0 (size: 0x4)
    bool bShouldUpdateEditLayersDuringInteractiveChanges;                             // 0x00B4 (size: 0x1)
    bool bRestrictiveMode;                                                            // 0x00B5 (size: 0x1)
    float SplineIconWorldZOffset;                                                     // 0x00B8 (size: 0x4)
    float SplineIconScale;                                                            // 0x00BC (size: 0x4)
    bool bDisplayTargetLayerThumbnails;                                               // 0x00C0 (size: 0x1)
    bool bDisableTemporalAntiAliasingInLandscapeMode;                                 // 0x00C1 (size: 0x1)
...
{
    TArray<ULandscapeSplineControlPoint*> ControlPoints;                              // 0x0520 (size: 0x10)
    TArray<ULandscapeSplineSegment*> Segments;                                        // 0x0530 (size: 0x10)
    TArray<UMeshComponent*> CookedForeignMeshComponents;                              // 0x0540 (size: 0x10)
...
{
    TSet<ALandscapeStreamingProxy*> StreamingProxiesNeedingReregister;                // 0x0090 (size: 0x50)
    TArray<ALandscape*> LandscapeActors;                                              // 0x00E8 (size: 0x10)
    TArray<ALandscapeProxy*> Proxies;                                                 // 0x00F8 (size: 0x10)

}; // Size: 0x128

class ULandscapeTextureHash : public UAssetUserData
{
    FGuid TextureHashGUID;                                                            // 0x0028 (size: 0x10)
    FGuid LastSourceID;                                                               // 0x0038 (size: 0x10)
    ELandscapeTextureType TextureType;                                                // 0x0048 (size: 0x1)
    ELandscapeTextureUsage TextureUsage;                                              // 0x0049 (size: 0x1)

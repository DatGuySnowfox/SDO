#ifndef UE4SS_SDK_BP_BikersHelmetPickup_HPP
#define UE4SS_SDK_BP_BikersHelmetPickup_HPP

class ABP_BikersHelmetPickup_C : public ABP_StaticMeshPickup_C
{
    ...
    void ExecuteUbergraph_BP_BikersHelmetPickup(int32 EntryPoint);
}; // Size: 0x328

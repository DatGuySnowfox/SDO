...
class URadioComponent_C : public UActorComponent
{
    ...
    class UMediaSoundComponent* MediaSound;                                           // 0x00C8 (size: 0x8)
    TArray<FString> Found Files;                                                      // 0x00D0 (size: 0x10)
    FString CurrentSong;                                                              // 0x00E0 (size: 0x10)
    bool TurnedOn?;                                                                   // 0x00F0 (size: 0x1)
    FString PreviousSong;                                                             // 0x00F8 (size: 0x10)
    double PlayRate;                                                                  // 0x0108 (size: 0x8)
    bool Paused?;                                                                     // 0x0110 (size: 0x1)
    FRadioComponent_CTurnedOn TurnedOn;                                               // 0x0118 (size: 0x10)
    void TurnedOn();
    FRadioComponent_CTurnedOff TurnedOff;                                             // 0x0128 (size: 0x10)
    void TurnedOff();
    class URadioUI_C* RadioUI;                                                        // 0x0138 (size: 0x8)
    FString Object Name;                                                              // 0x0140 (size: 0x10)

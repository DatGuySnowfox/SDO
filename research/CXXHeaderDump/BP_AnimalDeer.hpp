...
class ABP_AnimalDeer_C : public ABP_Animal_C
{
    ...
    class UAudioComponent* Deer_Noises;                                               // 0x0680 (size: 0x8)
    class UBP_JigComponent_C* BP_JigMultiplayer;                                      // 0x0688 (size: 0x8)
    class UNavigationInvokerComponent* NavigationInvoker;                             // 0x0690 (size: 0x8)
    class UStaticMeshComponent* Antlers;                                              // 0x0698 (size: 0x8)
    double Health;                                                                    // 0x06A0 (size: 0x8)
    bool IsDead?;                                                                     // 0x06A8 (size: 0x1)
    class AActor* CurrentActor;                                                       // 0x06B0 (size: 0x8)
    FText AIName;                                                                     // 0x06B8 (size: 0x10)
    FVector InteractingActorLoc;                                                      // 0x06C8 (size: 0x18)
    class UWidgetComponent* Marker;                                                   // 0x06E0 (size: 0x8)
    bool CanAddMarker?;                                                               // 0x06E8 (size: 0x1)
    FTimerHandle MarkerTimer;                                                         // 0x06F0 (size: 0x8)
    bool Is Burning?;                                                                 // 0x06F8 (size: 0x1)
    class UParticleSystemComponent* BurningEffect;                                    // 0x0700 (size: 0x8)
    FTimerHandle BurningTimer;                                                        // 0x0708 (size: 0x8)
    bool Looted;                                                                      // 0x0710 (size: 0x1)

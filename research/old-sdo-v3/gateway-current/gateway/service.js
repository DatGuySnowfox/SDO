...
import { encodeFrame, encodeJoinRequest, encodeString, decodeString, FrameDecoder, issueJoinTicket, MessageType, PROTOCOL_VERSION, ProtocolError, stableNumericId, validateJoinTicket } from "../shared-protocol/index.js";
...
export class GatewayService {
    ...
    broadcast(frame) {
        ...
        for (const connection of this.connections.values()) {
            if (connection.role === 'client' && connection.joined && !connection.socket.destroyed) {
